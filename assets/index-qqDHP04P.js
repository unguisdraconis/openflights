(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const l of o)if(l.type==="childList")for(const u of l.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&r(u)}).observe(document,{childList:!0,subtree:!0});function t(o){const l={};return o.integrity&&(l.integrity=o.integrity),o.referrerPolicy&&(l.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?l.credentials="include":o.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function r(o){if(o.ep)return;o.ep=!0;const l=t(o);fetch(o.href,l)}})();function wS(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}var Dh={exports:{}},da={},Nh={exports:{}},ht={};var $g;function TS(){if($g)return ht;$g=1;var n=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),l=Symbol.for("react.provider"),u=Symbol.for("react.context"),c=Symbol.for("react.forward_ref"),h=Symbol.for("react.suspense"),d=Symbol.for("react.memo"),p=Symbol.for("react.lazy"),_=Symbol.iterator;function g(O){return O===null||typeof O!="object"?null:(O=_&&O[_]||O["@@iterator"],typeof O=="function"?O:null)}var S={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,M={};function v(O,re,ge){this.props=O,this.context=re,this.refs=M,this.updater=ge||S}v.prototype.isReactComponent={},v.prototype.setState=function(O,re){if(typeof O!="object"&&typeof O!="function"&&O!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,O,re,"setState")},v.prototype.forceUpdate=function(O){this.updater.enqueueForceUpdate(this,O,"forceUpdate")};function x(){}x.prototype=v.prototype;function T(O,re,ge){this.props=O,this.context=re,this.refs=M,this.updater=ge||S}var A=T.prototype=new x;A.constructor=T,E(A,v.prototype),A.isPureReactComponent=!0;var R=Array.isArray,z=Object.prototype.hasOwnProperty,D={current:null},I={key:!0,ref:!0,__self:!0,__source:!0};function X(O,re,ge){var $,fe={},ye=null,Se=null;if(re!=null)for($ in re.ref!==void 0&&(Se=re.ref),re.key!==void 0&&(ye=""+re.key),re)z.call(re,$)&&!I.hasOwnProperty($)&&(fe[$]=re[$]);var Re=arguments.length-2;if(Re===1)fe.children=ge;else if(1<Re){for(var De=Array(Re),Ne=0;Ne<Re;Ne++)De[Ne]=arguments[Ne+2];fe.children=De}if(O&&O.defaultProps)for($ in Re=O.defaultProps,Re)fe[$]===void 0&&(fe[$]=Re[$]);return{$$typeof:n,type:O,key:ye,ref:Se,props:fe,_owner:D.current}}function L(O,re){return{$$typeof:n,type:O.type,key:re,ref:O.ref,props:O.props,_owner:O._owner}}function C(O){return typeof O=="object"&&O!==null&&O.$$typeof===n}function U(O){var re={"=":"=0",":":"=2"};return"$"+O.replace(/[=:]/g,function(ge){return re[ge]})}var W=/\/+/g;function V(O,re){return typeof O=="object"&&O!==null&&O.key!=null?U(""+O.key):re.toString(36)}function Z(O,re,ge,$,fe){var ye=typeof O;(ye==="undefined"||ye==="boolean")&&(O=null);var Se=!1;if(O===null)Se=!0;else switch(ye){case"string":case"number":Se=!0;break;case"object":switch(O.$$typeof){case n:case e:Se=!0}}if(Se)return Se=O,fe=fe(Se),O=$===""?"."+V(Se,0):$,R(fe)?(ge="",O!=null&&(ge=O.replace(W,"$&/")+"/"),Z(fe,re,ge,"",function(Ne){return Ne})):fe!=null&&(C(fe)&&(fe=L(fe,ge+(!fe.key||Se&&Se.key===fe.key?"":(""+fe.key).replace(W,"$&/")+"/")+O)),re.push(fe)),1;if(Se=0,$=$===""?".":$+":",R(O))for(var Re=0;Re<O.length;Re++){ye=O[Re];var De=$+V(ye,Re);Se+=Z(ye,re,ge,De,fe)}else if(De=g(O),typeof De=="function")for(O=De.call(O),Re=0;!(ye=O.next()).done;)ye=ye.value,De=$+V(ye,Re++),Se+=Z(ye,re,ge,De,fe);else if(ye==="object")throw re=String(O),Error("Objects are not valid as a React child (found: "+(re==="[object Object]"?"object with keys {"+Object.keys(O).join(", ")+"}":re)+"). If you meant to render a collection of children, use an array instead.");return Se}function te(O,re,ge){if(O==null)return O;var $=[],fe=0;return Z(O,$,"","",function(ye){return re.call(ge,ye,fe++)}),$}function ee(O){if(O._status===-1){var re=O._result;re=re(),re.then(function(ge){(O._status===0||O._status===-1)&&(O._status=1,O._result=ge)},function(ge){(O._status===0||O._status===-1)&&(O._status=2,O._result=ge)}),O._status===-1&&(O._status=0,O._result=re)}if(O._status===1)return O._result.default;throw O._result}var le={current:null},H={transition:null},ce={ReactCurrentDispatcher:le,ReactCurrentBatchConfig:H,ReactCurrentOwner:D};function ne(){throw Error("act(...) is not supported in production builds of React.")}return ht.Children={map:te,forEach:function(O,re,ge){te(O,function(){re.apply(this,arguments)},ge)},count:function(O){var re=0;return te(O,function(){re++}),re},toArray:function(O){return te(O,function(re){return re})||[]},only:function(O){if(!C(O))throw Error("React.Children.only expected to receive a single React element child.");return O}},ht.Component=v,ht.Fragment=t,ht.Profiler=o,ht.PureComponent=T,ht.StrictMode=r,ht.Suspense=h,ht.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=ce,ht.act=ne,ht.cloneElement=function(O,re,ge){if(O==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+O+".");var $=E({},O.props),fe=O.key,ye=O.ref,Se=O._owner;if(re!=null){if(re.ref!==void 0&&(ye=re.ref,Se=D.current),re.key!==void 0&&(fe=""+re.key),O.type&&O.type.defaultProps)var Re=O.type.defaultProps;for(De in re)z.call(re,De)&&!I.hasOwnProperty(De)&&($[De]=re[De]===void 0&&Re!==void 0?Re[De]:re[De])}var De=arguments.length-2;if(De===1)$.children=ge;else if(1<De){Re=Array(De);for(var Ne=0;Ne<De;Ne++)Re[Ne]=arguments[Ne+2];$.children=Re}return{$$typeof:n,type:O.type,key:fe,ref:ye,props:$,_owner:Se}},ht.createContext=function(O){return O={$$typeof:u,_currentValue:O,_currentValue2:O,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},O.Provider={$$typeof:l,_context:O},O.Consumer=O},ht.createElement=X,ht.createFactory=function(O){var re=X.bind(null,O);return re.type=O,re},ht.createRef=function(){return{current:null}},ht.forwardRef=function(O){return{$$typeof:c,render:O}},ht.isValidElement=C,ht.lazy=function(O){return{$$typeof:p,_payload:{_status:-1,_result:O},_init:ee}},ht.memo=function(O,re){return{$$typeof:d,type:O,compare:re===void 0?null:re}},ht.startTransition=function(O){var re=H.transition;H.transition={};try{O()}finally{H.transition=re}},ht.unstable_act=ne,ht.useCallback=function(O,re){return le.current.useCallback(O,re)},ht.useContext=function(O){return le.current.useContext(O)},ht.useDebugValue=function(){},ht.useDeferredValue=function(O){return le.current.useDeferredValue(O)},ht.useEffect=function(O,re){return le.current.useEffect(O,re)},ht.useId=function(){return le.current.useId()},ht.useImperativeHandle=function(O,re,ge){return le.current.useImperativeHandle(O,re,ge)},ht.useInsertionEffect=function(O,re){return le.current.useInsertionEffect(O,re)},ht.useLayoutEffect=function(O,re){return le.current.useLayoutEffect(O,re)},ht.useMemo=function(O,re){return le.current.useMemo(O,re)},ht.useReducer=function(O,re,ge){return le.current.useReducer(O,re,ge)},ht.useRef=function(O){return le.current.useRef(O)},ht.useState=function(O){return le.current.useState(O)},ht.useSyncExternalStore=function(O,re,ge){return le.current.useSyncExternalStore(O,re,ge)},ht.useTransition=function(){return le.current.useTransition()},ht.version="18.3.1",ht}var qg;function kd(){return qg||(qg=1,Nh.exports=TS()),Nh.exports}var Kg;function AS(){if(Kg)return da;Kg=1;var n=kd(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),r=Object.prototype.hasOwnProperty,o=n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function u(c,h,d){var p,_={},g=null,S=null;d!==void 0&&(g=""+d),h.key!==void 0&&(g=""+h.key),h.ref!==void 0&&(S=h.ref);for(p in h)r.call(h,p)&&!l.hasOwnProperty(p)&&(_[p]=h[p]);if(c&&c.defaultProps)for(p in h=c.defaultProps,h)_[p]===void 0&&(_[p]=h[p]);return{$$typeof:e,type:c,key:g,ref:S,props:_,_owner:o.current}}return da.Fragment=t,da.jsx=u,da.jsxs=u,da}var Zg;function CS(){return Zg||(Zg=1,Dh.exports=AS()),Dh.exports}var se=CS(),At=kd();const RS=wS(At);var ru={},Ih={exports:{}},In={},Uh={exports:{}},Fh={};var Qg;function bS(){return Qg||(Qg=1,(function(n){function e(H,ce){var ne=H.length;H.push(ce);e:for(;0<ne;){var O=ne-1>>>1,re=H[O];if(0<o(re,ce))H[O]=ce,H[ne]=re,ne=O;else break e}}function t(H){return H.length===0?null:H[0]}function r(H){if(H.length===0)return null;var ce=H[0],ne=H.pop();if(ne!==ce){H[0]=ne;e:for(var O=0,re=H.length,ge=re>>>1;O<ge;){var $=2*(O+1)-1,fe=H[$],ye=$+1,Se=H[ye];if(0>o(fe,ne))ye<re&&0>o(Se,fe)?(H[O]=Se,H[ye]=ne,O=ye):(H[O]=fe,H[$]=ne,O=$);else if(ye<re&&0>o(Se,ne))H[O]=Se,H[ye]=ne,O=ye;else break e}}return ce}function o(H,ce){var ne=H.sortIndex-ce.sortIndex;return ne!==0?ne:H.id-ce.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;n.unstable_now=function(){return l.now()}}else{var u=Date,c=u.now();n.unstable_now=function(){return u.now()-c}}var h=[],d=[],p=1,_=null,g=3,S=!1,E=!1,M=!1,v=typeof setTimeout=="function"?setTimeout:null,x=typeof clearTimeout=="function"?clearTimeout:null,T=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function A(H){for(var ce=t(d);ce!==null;){if(ce.callback===null)r(d);else if(ce.startTime<=H)r(d),ce.sortIndex=ce.expirationTime,e(h,ce);else break;ce=t(d)}}function R(H){if(M=!1,A(H),!E)if(t(h)!==null)E=!0,ee(z);else{var ce=t(d);ce!==null&&le(R,ce.startTime-H)}}function z(H,ce){E=!1,M&&(M=!1,x(X),X=-1),S=!0;var ne=g;try{for(A(ce),_=t(h);_!==null&&(!(_.expirationTime>ce)||H&&!U());){var O=_.callback;if(typeof O=="function"){_.callback=null,g=_.priorityLevel;var re=O(_.expirationTime<=ce);ce=n.unstable_now(),typeof re=="function"?_.callback=re:_===t(h)&&r(h),A(ce)}else r(h);_=t(h)}if(_!==null)var ge=!0;else{var $=t(d);$!==null&&le(R,$.startTime-ce),ge=!1}return ge}finally{_=null,g=ne,S=!1}}var D=!1,I=null,X=-1,L=5,C=-1;function U(){return!(n.unstable_now()-C<L)}function W(){if(I!==null){var H=n.unstable_now();C=H;var ce=!0;try{ce=I(!0,H)}finally{ce?V():(D=!1,I=null)}}else D=!1}var V;if(typeof T=="function")V=function(){T(W)};else if(typeof MessageChannel<"u"){var Z=new MessageChannel,te=Z.port2;Z.port1.onmessage=W,V=function(){te.postMessage(null)}}else V=function(){v(W,0)};function ee(H){I=H,D||(D=!0,V())}function le(H,ce){X=v(function(){H(n.unstable_now())},ce)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(H){H.callback=null},n.unstable_continueExecution=function(){E||S||(E=!0,ee(z))},n.unstable_forceFrameRate=function(H){0>H||125<H?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):L=0<H?Math.floor(1e3/H):5},n.unstable_getCurrentPriorityLevel=function(){return g},n.unstable_getFirstCallbackNode=function(){return t(h)},n.unstable_next=function(H){switch(g){case 1:case 2:case 3:var ce=3;break;default:ce=g}var ne=g;g=ce;try{return H()}finally{g=ne}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(H,ce){switch(H){case 1:case 2:case 3:case 4:case 5:break;default:H=3}var ne=g;g=H;try{return ce()}finally{g=ne}},n.unstable_scheduleCallback=function(H,ce,ne){var O=n.unstable_now();switch(typeof ne=="object"&&ne!==null?(ne=ne.delay,ne=typeof ne=="number"&&0<ne?O+ne:O):ne=O,H){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=ne+re,H={id:p++,callback:ce,priorityLevel:H,startTime:ne,expirationTime:re,sortIndex:-1},ne>O?(H.sortIndex=ne,e(d,H),t(h)===null&&H===t(d)&&(M?(x(X),X=-1):M=!0,le(R,ne-O))):(H.sortIndex=re,e(h,H),E||S||(E=!0,ee(z))),H},n.unstable_shouldYield=U,n.unstable_wrapCallback=function(H){var ce=g;return function(){var ne=g;g=ce;try{return H.apply(this,arguments)}finally{g=ne}}}})(Fh)),Fh}var Jg;function PS(){return Jg||(Jg=1,Uh.exports=bS()),Uh.exports}var e_;function LS(){if(e_)return In;e_=1;var n=kd(),e=PS();function t(i){for(var s="https://reactjs.org/docs/error-decoder.html?invariant="+i,a=1;a<arguments.length;a++)s+="&args[]="+encodeURIComponent(arguments[a]);return"Minified React error #"+i+"; visit "+s+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var r=new Set,o={};function l(i,s){u(i,s),u(i+"Capture",s)}function u(i,s){for(o[i]=s,i=0;i<s.length;i++)r.add(s[i])}var c=!(typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"),h=Object.prototype.hasOwnProperty,d=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,p={},_={};function g(i){return h.call(_,i)?!0:h.call(p,i)?!1:d.test(i)?_[i]=!0:(p[i]=!0,!1)}function S(i,s,a,f){if(a!==null&&a.type===0)return!1;switch(typeof s){case"function":case"symbol":return!0;case"boolean":return f?!1:a!==null?!a.acceptsBooleans:(i=i.toLowerCase().slice(0,5),i!=="data-"&&i!=="aria-");default:return!1}}function E(i,s,a,f){if(s===null||typeof s>"u"||S(i,s,a,f))return!0;if(f)return!1;if(a!==null)switch(a.type){case 3:return!s;case 4:return s===!1;case 5:return isNaN(s);case 6:return isNaN(s)||1>s}return!1}function M(i,s,a,f,m,y,w){this.acceptsBooleans=s===2||s===3||s===4,this.attributeName=f,this.attributeNamespace=m,this.mustUseProperty=a,this.propertyName=i,this.type=s,this.sanitizeURL=y,this.removeEmptyString=w}var v={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(i){v[i]=new M(i,0,!1,i,null,!1,!1)}),[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(i){var s=i[0];v[s]=new M(s,1,!1,i[1],null,!1,!1)}),["contentEditable","draggable","spellCheck","value"].forEach(function(i){v[i]=new M(i,2,!1,i.toLowerCase(),null,!1,!1)}),["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(i){v[i]=new M(i,2,!1,i,null,!1,!1)}),"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(i){v[i]=new M(i,3,!1,i.toLowerCase(),null,!1,!1)}),["checked","multiple","muted","selected"].forEach(function(i){v[i]=new M(i,3,!0,i,null,!1,!1)}),["capture","download"].forEach(function(i){v[i]=new M(i,4,!1,i,null,!1,!1)}),["cols","rows","size","span"].forEach(function(i){v[i]=new M(i,6,!1,i,null,!1,!1)}),["rowSpan","start"].forEach(function(i){v[i]=new M(i,5,!1,i.toLowerCase(),null,!1,!1)});var x=/[\-:]([a-z])/g;function T(i){return i[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(i){var s=i.replace(x,T);v[s]=new M(s,1,!1,i,null,!1,!1)}),"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(i){var s=i.replace(x,T);v[s]=new M(s,1,!1,i,"http://www.w3.org/1999/xlink",!1,!1)}),["xml:base","xml:lang","xml:space"].forEach(function(i){var s=i.replace(x,T);v[s]=new M(s,1,!1,i,"http://www.w3.org/XML/1998/namespace",!1,!1)}),["tabIndex","crossOrigin"].forEach(function(i){v[i]=new M(i,1,!1,i.toLowerCase(),null,!1,!1)}),v.xlinkHref=new M("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1),["src","href","action","formAction"].forEach(function(i){v[i]=new M(i,1,!1,i.toLowerCase(),null,!0,!0)});function A(i,s,a,f){var m=v.hasOwnProperty(s)?v[s]:null;(m!==null?m.type!==0:f||!(2<s.length)||s[0]!=="o"&&s[0]!=="O"||s[1]!=="n"&&s[1]!=="N")&&(E(s,a,m,f)&&(a=null),f||m===null?g(s)&&(a===null?i.removeAttribute(s):i.setAttribute(s,""+a)):m.mustUseProperty?i[m.propertyName]=a===null?m.type===3?!1:"":a:(s=m.attributeName,f=m.attributeNamespace,a===null?i.removeAttribute(s):(m=m.type,a=m===3||m===4&&a===!0?"":""+a,f?i.setAttributeNS(f,s,a):i.setAttribute(s,a))))}var R=n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,z=Symbol.for("react.element"),D=Symbol.for("react.portal"),I=Symbol.for("react.fragment"),X=Symbol.for("react.strict_mode"),L=Symbol.for("react.profiler"),C=Symbol.for("react.provider"),U=Symbol.for("react.context"),W=Symbol.for("react.forward_ref"),V=Symbol.for("react.suspense"),Z=Symbol.for("react.suspense_list"),te=Symbol.for("react.memo"),ee=Symbol.for("react.lazy"),le=Symbol.for("react.offscreen"),H=Symbol.iterator;function ce(i){return i===null||typeof i!="object"?null:(i=H&&i[H]||i["@@iterator"],typeof i=="function"?i:null)}var ne=Object.assign,O;function re(i){if(O===void 0)try{throw Error()}catch(a){var s=a.stack.trim().match(/\n( *(at )?)/);O=s&&s[1]||""}return`
...
`)+`
`+x);const A=T+v+u,R=T+x+c,z=F_(o,o.VERTEX_SHADER,A),D=F_(o,o.FRAGMENT_SHADER,R);o.attachShader(M,z),o.attachShader(M,D),t.index0AttributeName!==void 0?o.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&o.bindAttribLocation(M,0,"position"),o.linkProgram(M);function I(U){if(n.debug.checkShaderErrors){const W=o.getProgramInfoLog(M).trim(),V=o.getShaderInfoLog(z).trim(),Z=o.getShaderInfoLog(D).trim();let te=!0,ee=!0;if(o.getProgramParameter(M,o.LINK_STATUS)===!1)if(te=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(o,M,z,D);else{const le=O_(o,z,"vertex"),H=O_(o,D,"fragment");console.error("THREE.WebGLProgram: Shader Error "+o.getError()+" - VALIDATE_STATUS "+o.getProgramParameter(M,o.VALIDATE_STATUS)+`
...
Program Info Log: `+W+`
`+le+`
`+H)}else W!==""?console.warn("THREE.WebGLProgram: Program Info Log:",W):(V===""||Z==="")&&(ee=!1);ee&&(U.diagnostics={runnable:te,programLog:W,vertexShader:{log:V,prefix:v},fragmentShader:{log:Z,prefix:x}})}o.deleteShader(z),o.deleteShader(D),X=new ku(o,M),L=fT(o,M)}let X;this.getUniforms=function(){return X===void 0&&I(this),X};let L;this.getAttributes=function(){return L===void 0&&I(this),L};let C=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return C===!1&&(C=o.getProgramParameter(M,nT)),C},this.destroy=function(){r.releaseStatesOfProgram(this),o.deleteProgram(M),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=iT++,this.cacheKey=e,this.usedTimes=1,this.program=M,this.vertexShader=z,this.fragmentShader=D,this}let ET=0;class wT{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,r=e.fragmentShader,o=this._getShaderStage(t),l=this._getShaderStage(r),u=this._getShaderCacheForMaterial(e);return u.has(o)===!1&&(u.add(o),o.usedTimes++),u.has(l)===!1&&(u.add(l),l.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const r of t)r.usedTimes--,r.usedTimes===0&&this.shaderCache.delete(r.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let r=t.get(e);return r===void 0&&(r=new Set,t.set(e,r)),r}_getShaderStage(e){const t=this.shaderCache;let r=t.get(e);return r===void 0&&(r=new TT(e),t.set(e,r)),r}}class TT{constructor(e){this.id=ET++,this.code=e,this.usedTimes=0}}function AT(n,e,t,r,o,l,u){const c=new tp,h=new wT,d=new Set,p=[],_=o.logarithmicDepthBuffer,g=o.vertexTextures;let S=o.precision;const E={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function M(L){return d.add(L),L===0?"uv":`uv${L}`}function v(L,C,U,W,V){const Z=W.fog,te=V.geometry,ee=L.isMeshStandardMaterial?W.environment:null,le=(L.isMeshStandardMaterial?t:e).get(L.envMap||ee),H=le&&le.mapping===ja?le.image.height:null,ce=E[L.type];L.precision!==null&&(S=o.getMaxPrecision(L.precision),S!==L.precision&&console.warn("THREE.WebGLProgram.getParameters:",L.precision,"not supported, using",S,"instead."));const ne=te.morphAttributes.position||te.morphAttributes.normal||te.morphAttributes.color,O=ne!==void 0?ne.length:0;let re=0;te.morphAttributes.position!==void 0&&(re=1),te.morphAttributes.normal!==void 0&&(re=2),te.morphAttributes.color!==void 0&&(re=3);let ge,$,fe,ye;if(ce){const vt=Si[ce];ge=vt.vertexShader,$=vt.fragmentShader}else ge=L.vertexShader,$=L.fragmentShader,h.update(L),fe=h.getVertexShaderID(L),ye=h.getFragmentShaderID(L);const Se=n.getRenderTarget(),Re=V.isInstancedMesh===!0,De=V.isBatchedMesh===!0,Ne=!!L.map,ft=!!L.matcap,k=!!le,_t=!!L.aoMap,dt=!!L.lightMap,Mt=!!L.bumpMap,Ye=!!L.normalMap,Ut=!!L.displacementMap,tt=!!L.emissiveMap,rt=!!L.metalnessMap,F=!!L.roughnessMap,b=L.anisotropy>0,ue=L.clearcoat>0,pe=L.dispersion>0,ve=L.iridescence>0,me=L.sheen>0,$e=L.transmission>0,Pe=b&&!!L.anisotropyMap,Oe=ue&&!!L.clearcoatMap,ot=ue&&!!L.clearcoatNormalMap,Ee=ue&&!!L.clearcoatRoughnessMap,Ie=ve&&!!L.iridescenceMap,pt=ve&&!!L.iridescenceThicknessMap,et=me&&!!L.sheenColorMap,ke=me&&!!L.sheenRoughnessMap,st=!!L.specularMap,at=!!L.specularColorMap,Rt=!!L.specularIntensityMap,j=$e&&!!L.transmissionMap,Te=$e&&!!L.thicknessMap,he=!!L.gradientMap,de=!!L.alphaMap,Ce=L.alphaTest>0,Ze=!!L.alphaHash,mt=!!L.extensions;let zt=ar;L.toneMapped&&(Se===null||Se.isXRRenderTarget===!0)&&(zt=n.toneMapping);const Xt={shaderID:ce,shaderType:L.type,shaderName:L.name,vertexShader:ge,fragmentShader:$,defines:L.defines,customVertexShaderID:fe,customFragmentShaderID:ye,isRawShaderMaterial:L.isRawShaderMaterial===!0,glslVersion:L.glslVersion,precision:S,batching:De,batchingColor:De&&V._colorsTexture!==null,instancing:Re,instancingColor:Re&&V.instanceColor!==null,instancingMorph:Re&&V.morphTexture!==null,supportsVertexTextures:g,outputColorSpace:Se===null?n.outputColorSpace:Se.isXRRenderTarget===!0?Se.texture.colorSpace:fr,alphaToCoverage:!!L.alphaToCoverage,map:Ne,matcap:ft,envMap:k,envMapMode:k&&le.mapping,envMapCubeUVHeight:H,aoMap:_t,lightMap:dt,bumpMap:Mt,normalMap:Ye,displacementMap:g&&Ut,emissiveMap:tt,normalMapObjectSpace:Ye&&L.normalMapType===Rv,normalMapTangentSpace:Ye&&L.normalMapType===Vc,metalnessMap:rt,roughnessMap:F,anisotropy:b,anisotropyMap:Pe,clearcoat:ue,clearcoatMap:Oe,clearcoatNormalMap:ot,clearcoatRoughnessMap:Ee,dispersion:pe,iridescence:ve,iridescenceMap:Ie,iridescenceThicknessMap:pt,sheen:me,sheenColorMap:et,sheenRoughnessMap:ke,specularMap:st,specularColorMap:at,specularIntensityMap:Rt,transmission:$e,transmissionMap:j,thicknessMap:Te,gradientMap:he,opaque:L.transparent===!1&&L.blending===Wr&&L.alphaToCoverage===!1,alphaMap:de,alphaTest:Ce,alphaHash:Ze,combine:L.combine,mapUv:Ne&&M(L.map.channel),aoMapUv:_t&&M(L.aoMap.channel),lightMapUv:dt&&M(L.lightMap.channel),bumpMapUv:Mt&&M(L.bumpMap.channel),normalMapUv:Ye&&M(L.normalMap.channel),displacementMapUv:Ut&&M(L.displacementMap.channel),emissiveMapUv:tt&&M(L.emissiveMap.channel),metalnessMapUv:rt&&M(L.metalnessMap.channel),roughnessMapUv:F&&M(L.roughnessMap.channel),anisotropyMapUv:Pe&&M(L.anisotropyMap.channel),clearcoatMapUv:Oe&&M(L.clearcoatMap.channel),clearcoatNormalMapUv:ot&&M(L.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Ee&&M(L.clearcoatRoughnessMap.channel),iridescenceMapUv:Ie&&M(L.iridescenceMap.channel),iridescenceThicknessMapUv:pt&&M(L.iridescenceThicknessMap.channel),sheenColorMapUv:et&&M(L.sheenColorMap.channel),sheenRoughnessMapUv:ke&&M(L.sheenRoughnessMap.channel),specularMapUv:st&&M(L.specularMap.channel),specularColorMapUv:at&&M(L.specularColorMap.channel),specularIntensityMapUv:Rt&&M(L.specularIntensityMap.channel),transmissionMapUv:j&&M(L.transmissionMap.channel),thicknessMapUv:Te&&M(L.thicknessMap.channel),alphaMapUv:de&&M(L.alphaMap.channel),vertexTangents:!!te.attributes.tangent&&(Ye||b),vertexColors:L.vertexColors,vertexAlphas:L.vertexColors===!0&&!!te.attributes.color&&te.attributes.color.itemSize===4,pointsUvs:V.isPoints===!0&&!!te.attributes.uv&&(Ne||de),fog:!!Z,useFog:L.fog===!0,fogExp2:!!Z&&Z.isFogExp2,flatShading:L.flatShading===!0,sizeAttenuation:L.sizeAttenuation===!0,logarithmicDepthBuffer:_,skinning:V.isSkinnedMesh===!0,morphTargets:te.morphAttributes.position!==void 0,morphNormals:te.morphAttributes.normal!==void 0,morphColors:te.morphAttributes.color!==void 0,morphTargetsCount:O,morphTextureStride:re,numDirLights:C.directional.length,numPointLights:C.point.length,numSpotLights:C.spot.length,numSpotLightMaps:C.spotLightMap.length,numRectAreaLights:C.rectArea.length,numHemiLights:C.hemi.length,numDirLightShadows:C.directionalShadowMap.length,numPointLightShadows:C.pointShadowMap.length,numSpotLightShadows:C.spotShadowMap.length,numSpotLightShadowsWithMaps:C.numSpotLightShadowsWithMaps,numLightProbes:C.numLightProbes,numClippingPlanes:u.numPlanes,numClipIntersection:u.numIntersection,dithering:L.dithering,shadowMapEnabled:n.shadowMap.enabled&&U.length>0,shadowMapType:n.shadowMap.type,toneMapping:zt,decodeVideoTexture:Ne&&L.map.isVideoTexture===!0&&Et.getTransfer(L.map.colorSpace)===Lt,premultipliedAlpha:L.premultipliedAlpha,doubleSided:L.side===Ni,flipSided:L.side===xn,useDepthPacking:L.depthPacking>=0,depthPacking:L.depthPacking||0,index0AttributeName:L.index0AttributeName,extensionClipCullDistance:mt&&L.extensions.clipCullDistance===!0&&r.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(mt&&L.extensions.multiDraw===!0||De)&&r.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:r.has("KHR_parallel_shader_compile"),customProgramCacheKey:L.customProgramCacheKey()};return Xt.vertexUv1s=d.has(1),Xt.vertexUv2s=d.has(2),Xt.vertexUv3s=d.has(3),d.clear(),Xt}function x(L){const C=[];if(L.shaderID?C.push(L.shaderID):(C.push(L.customVertexShaderID),C.push(L.customFragmentShaderID)),L.defines!==void 0)for(const U in L.defines)C.push(U),C.push(L.defines[U]);return L.isRawShaderMaterial===!1&&(T(C,L),A(C,L),C.push(n.outputColorSpace)),C.push(L.customProgramCacheKey),C.join()}function T(L,C){L.push(C.precision),L.push(C.outputColorSpace),L.push(C.envMapMode),L.push(C.envMapCubeUVHeight),L.push(C.mapUv),L.push(C.alphaMapUv),L.push(C.lightMapUv),L.push(C.aoMapUv),L.push(C.bumpMapUv),L.push(C.normalMapUv),L.push(C.displacementMapUv),L.push(C.emissiveMapUv),L.push(C.metalnessMapUv),L.push(C.roughnessMapUv),L.push(C.anisotropyMapUv),L.push(C.clearcoatMapUv),L.push(C.clearcoatNormalMapUv),L.push(C.clearcoatRoughnessMapUv),L.push(C.iridescenceMapUv),L.push(C.iridescenceThicknessMapUv),L.push(C.sheenColorMapUv),L.push(C.sheenRoughnessMapUv),L.push(C.specularMapUv),L.push(C.specularColorMapUv),L.push(C.specularIntensityMapUv),L.push(C.transmissionMapUv),L.push(C.thicknessMapUv),L.push(C.combine),L.push(C.fogExp2),L.push(C.sizeAttenuation),L.push(C.morphTargetsCount),L.push(C.morphAttributeCount),L.push(C.numDirLights),L.push(C.numPointLights),L.push(C.numSpotLights),L.push(C.numSpotLightMaps),L.push(C.numHemiLights),L.push(C.numRectAreaLights),L.push(C.numDirLightShadows),L.push(C.numPointLightShadows),L.push(C.numSpotLightShadows),L.push(C.numSpotLightShadowsWithMaps),L.push(C.numLightProbes),L.push(C.shadowMapType),L.push(C.toneMapping),L.push(C.numClippingPlanes),L.push(C.numClipIntersection),L.push(C.depthPacking)}function A(L,C){c.disableAll(),C.supportsVertexTextures&&c.enable(0),C.instancing&&c.enable(1),C.instancingColor&&c.enable(2),C.instancingMorph&&c.enable(3),C.matcap&&c.enable(4),C.envMap&&c.enable(5),C.normalMapObjectSpace&&c.enable(6),C.normalMapTangentSpace&&c.enable(7),C.clearcoat&&c.enable(8),C.iridescence&&c.enable(9),C.alphaTest&&c.enable(10),C.vertexColors&&c.enable(11),C.vertexAlphas&&c.enable(12),C.vertexUv1s&&c.enable(13),C.vertexUv2s&&c.enable(14),C.vertexUv3s&&c.enable(15),C.vertexTangents&&c.enable(16),C.anisotropy&&c.enable(17),C.alphaHash&&c.enable(18),C.batching&&c.enable(19),C.dispersion&&c.enable(20),C.batchingColor&&c.enable(21),L.push(c.mask),c.disableAll(),C.fog&&c.enable(0),C.useFog&&c.enable(1),C.flatShading&&c.enable(2),C.logarithmicDepthBuffer&&c.enable(3),C.skinning&&c.enable(4),C.morphTargets&&c.enable(5),C.morphNormals&&c.enable(6),C.morphColors&&c.enable(7),C.premultipliedAlpha&&c.enable(8),C.shadowMapEnabled&&c.enable(9),C.doubleSided&&c.enable(10),C.flipSided&&c.enable(11),C.useDepthPacking&&c.enable(12),C.dithering&&c.enable(13),C.transmission&&c.enable(14),C.sheen&&c.enable(15),C.opaque&&c.enable(16),C.pointsUvs&&c.enable(17),C.decodeVideoTexture&&c.enable(18),C.alphaToCoverage&&c.enable(19),L.push(c.mask)}function R(L){const C=E[L.type];let U;if(C){const W=Si[C];U=Gv.clone(W.uniforms)}else U=L.uniforms;return U}function z(L,C){let U;for(let W=0,V=p.length;W<V;W++){const Z=p[W];if(Z.cacheKey===C){U=Z,++U.usedTimes;break}}return U===void 0&&(U=new MT(n,C,L,l),p.push(U)),U}function D(L){if(--L.usedTimes===0){const C=p.indexOf(L);p[C]=p[p.length-1],p.pop(),L.destroy()}}function I(L){h.remove(L)}function X(){h.dispose()}return{getParameters:v,getProgramCacheKey:x,getUniforms:R,acquireProgram:z,releaseProgram:D,releaseShaderCache:I,programs:p,dispose:X}}function CT(){let n=new WeakMap;function e(u){return n.has(u)}function t(u){let c=n.get(u);return c===void 0&&(c={},n.set(u,c)),c}function r(u){n.delete(u)}function o(u,c,h){n.get(u)[c]=h}function l(){n=new WeakMap}return{has:e,get:t,remove:r,update:o,dispose:l}}function RT(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.z!==e.z?n.z-e.z:n.id-e.id}function V_(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function G_(){const n=[];let e=0;const t=[],r=[],o=[];function l(){e=0,t.length=0,r.length=0,o.length=0}function u(_,g,S,E,M,v){let x=n[e];return x===void 0?(x={id:_.id,object:_,geometry:g,material:S,groupOrder:E,renderOrder:_.renderOrder,z:M,group:v},n[e]=x):(x.id=_.id,x.object=_,x.geometry=g,x.material=S,x.groupOrder=E,x.renderOrder=_.renderOrder,x.z=M,x.group=v),e++,x}function c(_,g,S,E,M,v){const x=u(_,g,S,E,M,v);S.transmission>0?r.push(x):S.transparent===!0?o.push(x):t.push(x)}function h(_,g,S,E,M,v){const x=u(_,g,S,E,M,v);S.transmission>0?r.unshift(x):S.transparent===!0?o.unshift(x):t.unshift(x)}function d(_,g){t.length>1&&t.sort(_||RT),r.length>1&&r.sort(g||V_),o.length>1&&o.sort(g||V_)}function p(){for(let _=e,g=n.length;_<g;_++){const S=n[_];if(S.id===null)break;S.id=null,S.object=null,S.geometry=null,S.material=null,S.group=null}}return{opaque:t,transmissive:r,transparent:o,init:l,push:c,unshift:h,finish:p,sort:d}}function bT(){let n=new WeakMap;function e(r,o){const l=n.get(r);let u;return l===void 0?(u=new G_,n.set(r,[u])):o>=l.length?(u=new G_,l.push(u)):u=l[o],u}function t(){n=new WeakMap}return{get:e,dispose:t}}function PT(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new q,color:new Ge};break;case"SpotLight":t={position:new q,direction:new q,color:new Ge,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new q,color:new Ge,distance:0,decay:0};break;case"HemisphereLight":t={direction:new q,skyColor:new Ge,groundColor:new Ge};break;case"RectAreaLight":t={color:new Ge,position:new q,halfWidth:new q,halfHeight:new q};break}return n[e.id]=t,t}}}function LT(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new it};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new it};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new it,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}let DT=0;function NT(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function IT(n){const e=new PT,t=LT(),r={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let d=0;d<9;d++)r.probe.push(new q);const o=new q,l=new kt,u=new kt;function c(d){let p=0,_=0,g=0;for(let L=0;L<9;L++)r.probe[L].set(0,0,0);let S=0,E=0,M=0,v=0,x=0,T=0,A=0,R=0,z=0,D=0,I=0;d.sort(NT);for(let L=0,C=d.length;L<C;L++){const U=d[L],W=U.color,V=U.intensity,Z=U.distance,te=U.shadow&&U.shadow.map?U.shadow.map.texture:null;if(U.isAmbientLight)p+=W.r*V,_+=W.g*V,g+=W.b*V;else if(U.isLightProbe){for(let ee=0;ee<9;ee++)r.probe[ee].addScaledVector(U.sh.coefficients[ee],V);I++}else if(U.isDirectionalLight){const ee=e.get(U);if(ee.color.copy(U.color).multiplyScalar(U.intensity),U.castShadow){const le=U.shadow,H=t.get(U);H.shadowIntensity=le.intensity,H.shadowBias=le.bias,H.shadowNormalBias=le.normalBias,H.shadowRadius=le.radius,H.shadowMapSize=le.mapSize,r.directionalShadow[S]=H,r.directionalShadowMap[S]=te,r.directionalShadowMatrix[S]=U.shadow.matrix,T++}r.directional[S]=ee,S++}else if(U.isSpotLight){const ee=e.get(U);ee.position.setFromMatrixPosition(U.matrixWorld),ee.color.copy(W).multiplyScalar(V),ee.distance=Z,ee.coneCos=Math.cos(U.angle),ee.penumbraCos=Math.cos(U.angle*(1-U.penumbra)),ee.decay=U.decay,r.spot[M]=ee;const le=U.shadow;if(U.map&&(r.spotLightMap[z]=U.map,z++,le.updateMatrices(U),U.castShadow&&D++),r.spotLightMatrix[M]=le.matrix,U.castShadow){const H=t.get(U);H.shadowIntensity=le.intensity,H.shadowBias=le.bias,H.shadowNormalBias=le.normalBias,H.shadowRadius=le.radius,H.shadowMapSize=le.mapSize,r.spotShadow[M]=H,r.spotShadowMap[M]=te,R++}M++}else if(U.isRectAreaLight){const ee=e.get(U);ee.color.copy(W).multiplyScalar(V),ee.halfWidth.set(U.width*.5,0,0),ee.halfHeight.set(0,U.height*.5,0),r.rectArea[v]=ee,v++}else if(U.isPointLight){const ee=e.get(U);if(ee.color.copy(U.color).multiplyScalar(U.intensity),ee.distance=U.distance,ee.decay=U.decay,U.castShadow){const le=U.shadow,H=t.get(U);H.shadowIntensity=le.intensity,H.shadowBias=le.bias,H.shadowNormalBias=le.normalBias,H.shadowRadius=le.radius,H.shadowMapSize=le.mapSize,H.shadowCameraNear=le.camera.near,H.shadowCameraFar=le.camera.far,r.pointShadow[E]=H,r.pointShadowMap[E]=te,r.pointShadowMatrix[E]=U.shadow.matrix,A++}r.point[E]=ee,E++}else if(U.isHemisphereLight){const ee=e.get(U);ee.skyColor.copy(U.color).multiplyScalar(V),ee.groundColor.copy(U.groundColor).multiplyScalar(V),r.hemi[x]=ee,x++}}v>0&&(n.has("OES_texture_float_linear")===!0?(r.rectAreaLTC1=Le.LTC_FLOAT_1,r.rectAreaLTC2=Le.LTC_FLOAT_2):(r.rectAreaLTC1=Le.LTC_HALF_1,r.rectAreaLTC2=Le.LTC_HALF_2)),r.ambient[0]=p,r.ambient[1]=_,r.ambient[2]=g;const X=r.hash;(X.directionalLength!==S||X.pointLength!==E||X.spotLength!==M||X.rectAreaLength!==v||X.hemiLength!==x||X.numDirectionalShadows!==T||X.numPointShadows!==A||X.numSpotShadows!==R||X.numSpotMaps!==z||X.numLightProbes!==I)&&(r.directional.length=S,r.spot.length=M,r.rectArea.length=v,r.point.length=E,r.hemi.length=x,r.directionalShadow.length=T,r.directionalShadowMap.length=T,r.pointShadow.length=A,r.pointShadowMap.length=A,r.spotShadow.length=R,r.spotShadowMap.length=R,r.directionalShadowMatrix.length=T,r.pointShadowMatrix.length=A,r.spotLightMatrix.length=R+z-D,r.spotLightMap.length=z,r.numSpotLightShadowsWithMaps=D,r.numLightProbes=I,X.directionalLength=S,X.pointLength=E,X.spotLength=M,X.rectAreaLength=v,X.hemiLength=x,X.numDirectionalShadows=T,X.numPointShadows=A,X.numSpotShadows=R,X.numSpotMaps=z,X.numLightProbes=I,r.version=DT++)}function h(d,p){let _=0,g=0,S=0,E=0,M=0;const v=p.matrixWorldInverse;for(let x=0,T=d.length;x<T;x++){const A=d[x];if(A.isDirectionalLight){const R=r.directional[_];R.direction.setFromMatrixPosition(A.matrixWorld),o.setFromMatrixPosition(A.target.matrixWorld),R.direction.sub(o),R.direction.transformDirection(v),_++}else if(A.isSpotLight){const R=r.spot[S];R.position.setFromMatrixPosition(A.matrixWorld),R.position.applyMatrix4(v),R.direction.setFromMatrixPosition(A.matrixWorld),o.setFromMatrixPosition(A.target.matrixWorld),R.direction.sub(o),R.direction.transformDirection(v),S++}else if(A.isRectAreaLight){const R=r.rectArea[E];R.position.setFromMatrixPosition(A.matrixWorld),R.position.applyMatrix4(v),u.identity(),l.copy(A.matrixWorld),l.premultiply(v),u.extractRotation(l),R.halfWidth.set(A.width*.5,0,0),R.halfHeight.set(0,A.height*.5,0),R.halfWidth.applyMatrix4(u),R.halfHeight.applyMatrix4(u),E++}else if(A.isPointLight){const R=r.point[g];R.position.setFromMatrixPosition(A.matrixWorld),R.position.applyMatrix4(v),g++}else if(A.isHemisphereLight){const R=r.hemi[M];R.direction.setFromMatrixPosition(A.matrixWorld),R.direction.transformDirection(v),M++}}}return{setup:c,setupView:h,state:r}}function W_(n){const e=new IT(n),t=[],r=[];function o(p){d.camera=p,t.length=0,r.length=0}function l(p){t.push(p)}function u(p){r.push(p)}function c(){e.setup(t)}function h(p){e.setupView(t,p)}const d={lightsArray:t,shadowsArray:r,camera:null,lights:e,transmissionRenderTarget:{}};return{init:o,state:d,setupLights:c,setupLightsView:h,pushLight:l,pushShadow:u}}function UT(n){let e=new WeakMap;function t(o,l=0){const u=e.get(o);let c;return u===void 0?(c=new W_(n),e.set(o,[c])):l>=u.length?(c=new W_(n),u.push(c)):c=u[l],c}function r(){e=new WeakMap}return{get:t,dispose:r}}class Zv extends hr{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=Av,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class Qv extends hr{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const FT=`void main() {
	gl_Position = vec4( position, 1.0 );
...
void main() {
  ...
  #include <colorspace_fragment>
      ...
      #include <colorspace_fragment>
    }`}),h=new Zn(new Ss(1.045,48,32),c);t.add(h);const d=new cn,p=new Float32Array(900*3);for(let T=0;T<900;T++){const A=7+Math.random()*8,R=Math.random()*2-1,z=Math.random()*Math.PI*2,D=Math.sqrt(1-R*R);p[T*3]=A*D*Math.cos(z),p[T*3+1]=A*R,p[T*3+2]=A*D*Math.sin(z)}d.setAttribute("position",new Wt(p,3));const _=new fp(d,new cp({color:8231863,size:.012,transparent:!0,opacity:.42,depthWrite:!1}));n.add(_);let g=null,S=null,E=!1,M=null;const v=(T,A)=>{g||E||!T.terrain||(E=!0,new cx().load("/openflights/geo/terrain-4096.png",R=>{E=!1,R.colorSpace=Ei,R.wrapS=Fa,R.wrapT=ir,R.minFilter=rr,R.magFilter=Kn,R.generateMipmaps=!0,R.anisotropy=8,S=R,g=pP(T.terrain,R,{x:R.image.width,y:R.image.height}),M&&M.terrain&&(o.material=g),A?.()},void 0,()=>{E=!1}))};return{globeGroup:t,globe:o,grid:u,atmosphere:h,starsObj:_,starsGeo:d,applyTheme:(T,A)=>{M=T,T.terrain?g?o.material=g:v(T,A):o.material=r,l.color.set(T.grid.color),l.opacity=T.grid.opacity,c.uniforms.uColor.value.copy(T.atmosphere.color),c.uniforms.uStrength.value=T.atmosphere.strength,_.visible=T.stars},dispose(){S?.dispose(),g?.dispose(),r.dispose()}}}function gP(n,e,t,r,o,l){const u=new Float32Array(e.nodes.length*3),c=new Float32Array(e.nodes.length*3),h=new Float32Array(e.nodes.length),d=new Float32Array(e.nodes.length),p=new Float32Array(e.nodes.length),_=new Float32Array(e.nodes.length);for(let C=0;C<p.length;C++)p[C]=C;u.set(t.geo),e.nodes.forEach((C,U)=>{h[U]=4.2+Math.min(8,Math.sqrt(C.degree)*.72),d[U]=.88});const g=new cn;g.setAttribute("position",new Wt(u,3)),g.setAttribute("color",new Wt(c,3)),g.setAttribute("aSize",new Wt(h,1)),g.setAttribute("aAlpha",new Wt(d,1)),g.setAttribute("aIndex",new Wt(p,1)),g.setAttribute("aPickable",new Wt(_,1));const S=new Jn({transparent:!0,depthWrite:!1,vertexColors:!0,uniforms:{uPixelRatio:{value:r.getPixelRatio()}},vertexShader:"attribute float aSize;attribute float aAlpha;varying vec3 vColor;varying float vAlpha;void main(){vColor=color;vAlpha=aAlpha;vec4 mv=modelViewMatrix*vec4(position,1.);gl_PointSize=clamp(aSize*(260.0/-mv.z),2.0,18.0);gl_Position=projectionMatrix*mv;}",fragmentShader:`varying vec3 vColor;varying float vAlpha;void main(){float d=length(gl_PointCoord-.5);float a=smoothstep(.5,.25,d)*vAlpha;if(a<.015)discard;gl_FragColor=vec4(vColor,a);
      #include <colorspace_fragment>
    }`}),E=new fp(g,S);n.add(E);const M=e.nodes.reduce((C,U)=>U.degree>C.degree?U:C,e.nodes[0]),v=new Ss(1,24,16),x=new sx({roughness:.32,metalness:.2}),T=new Zn(v,x);T.visible=!1,n.add(T);let A=0,R=3.55;const z=(C,U,W,V)=>{if(!W){T.visible=!1;return}const{color:Z,pixelSize:te}=I0(W,U,V);t.read(C.view,W.index,T.position),X=W.index,x.color.copy(Z),x.emissive.copy(Z).multiplyScalar(.32),A=te,R=C.view==="globe"?3.55:4.2,T.scale.setScalar(U0(A,o,l(),R)),T.visible=!0};let D=e.nodes.map((C,U)=>U),I=t.geo,X=-1;const L=(C,U,W,V)=>{D=[];const Z=t.table(C.view);Z!==I&&(u.set(Z),g.attributes.position.needsUpdate=!0,I=Z),e.nodes.forEach((te,ee)=>{const le=!C.country||te.country===C.country,H=te.degree>=C.minDegree,ce=le&&H,{color:ne,pixelSize:O,isSelected:re,connected:ge}=I0(te,U,V);let $=re?1:ce?.9:ge?.75:JT;const fe=te===W;fe&&($=0),c[ee*3]=ne.r,c[ee*3+1]=ne.g,c[ee*3+2]=ne.b,d[ee]=$,h[ee]=O;const ye=re||ge||ce||fe;_[ee]=ye?1:0,ye&&D.push(ee)}),g.attributes.color.needsUpdate=!0,g.attributes.aAlpha.needsUpdate=!0,g.attributes.aSize.needsUpdate=!0,g.attributes.aPickable.needsUpdate=!0};return{points:E,topHubNode:M,geometry:g,material:S,heroMesh:T,get heroIndex(){return T.visible?X:-1},positions:u,get visibleIndices(){return D},update(C,U,W,V){L(C,U,W,V),z(C,U,W,V)},resize(){T.visible&&T.scale.setScalar(U0(A,o,l(),R))},dispose(){g.dispose(),S.dispose(),v.dispose(),x.dispose()}}}function _P(n,e,t){let r=null;const o=new q,l=new q,u=(h,d)=>{t.read(h,d.source.index,o),t.read(h,d.target.index,l)};return{get object(){return r},update:(h,d,p)=>{r&&(n.remove(r),r.geometry.dispose(),r.material.dispose());const _=Math.ceil(e.links.length*h.density/100),g=[];for(const T of e.links){if(g.length>=_)break;h.scope==="international"&&!T.international||h.scope==="domestic"&&T.international||h.country&&T.source.country!==h.country&&T.target.country!==h.country||T.source.degree<h.minDegree||T.target.degree<h.minDegree||g.push(T)}let S=0;for(const T of g)S+=h.view==="globe"?(u("globe",T),o.angleTo(l)>1.25?11:7):1;const E=new Float32Array(S*2*3),M=new Float32Array(S*2*3);let v=0;for(const T of g){const R=d&&(T.source===d||T.target===d)?p.route.selected:T.international?p.route.intl:p.route.domestic;if(h.view==="globe"){u("globe",T);const z=o.angleTo(l),D=z>1.25?11:7,I=.025+Math.min(.34,z*.18);let X=N0(o,l,0,I);for(let L=1;L<=D;L++){const C=N0(o,l,L/D,I);E.set(X.toArray(),v),M.set(R.toArray(),v),v+=3,E.set(C.toArray(),v),M.set(R.toArray(),v),v+=3,X=C}}else u("topology",T),E.set(o.toArray(),v),M.set(R.toArray(),v),v+=3,E.set(l.toArray(),v),M.set(R.toArray(),v),v+=3}const x=new cn;x.setAttribute("position",new Wt(E,3)),x.setAttribute("color",new Wt(M,3)),r=new $c(x,new Ka({vertexColors:!0,transparent:!0,opacity:h.view==="globe"?p.routeOpacity.globe:p.routeOpacity.topology,depthWrite:!1,blending:p.routeBlending})),r.renderOrder=1,n.add(r)},dispose(){r&&(n.remove(r),r.geometry.dispose(),r.material.dispose(),r=null)}}}const vP=8,xP=["attribute float aSize;","attribute float aIndex;","attribute float aPickable;","varying vec3 vId;","void main() {","  if (aPickable < 0.5) {","    gl_Position = vec4(2.0, 2.0, 2.0, 1.0);","    gl_PointSize = 0.0;","    return;","  }","  float id = aIndex + 1.0;","  vId = vec3(","    floor(id / 65536.0),","    floor(mod(id, 65536.0) / 256.0),","    mod(id, 256.0)","  ) / 255.0;","  vec4 mv = modelViewMatrix * vec4(position, 1.0);","  gl_PointSize = clamp(aSize * (260.0 / -mv.z), 2.0, 18.0);","  gl_Position = projectionMatrix * mv;","}"].join(`
`),yP=["varying vec3 vId;","void main() {","  if (length(gl_PointCoord - 0.5) > 0.5) discard;","  gl_FragColor = vec4(vId, 1.0);","}"].join(`
`),k0=n=>new n.ShaderMaterial({uniforms:{uId:{value:new n.Vector3}},vertexShader:"void main(){gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0);}",fragmentShader:"uniform vec3 uId;void main(){gl_FragColor=vec4(uId,1.0);}"}),SP=(n,e)=>e.set(Math.floor(n/65536)/255,Math.floor(n/256)%256/255,n%256/255);function MP({renderer:n,scene:e,camera:t,data:r,sprites:o,world:l,routes:u,selectedRef:c,onHover:h,onSelect:d,onClear:p}){let _=0,g=null,S=!1,E=0,M=null,v=null;const x=new Jn({vertexShader:xP,fragmentShader:yP,transparent:!1,depthTest:!0,depthWrite:!0}),T=k0(t0),A=k0(t0),R=U=>{const W=Math.max(1,Math.round(vP*2*U)+1);W===E&&M||(M?.dispose(),E=W,M=new ur(E,E,{minFilter:An,magFilter:An,depthBuffer:!0}),M.texture.colorSpace=Ei,M.texture.generateMipmaps=!1,v=new Uint8Array(E*E*4))},z=(U,W)=>{const V=n.domElement,Z=V.getBoundingClientRect();if(U<Z.left||W<Z.top||U>Z.right||W>Z.bottom)return null;const te=n.getPixelRatio();R(te);const ee=Math.round(Z.width*te),le=Math.round(Z.height*te),H=(U-Z.left)*te,ce=(W-Z.top)*te,ne=o.heroIndex,O=[],re=Ne=>{Ne&&(O.push([Ne,"visible",Ne.visible]),Ne.visible=!1)},ge=(Ne,ft)=>{O.push([Ne,"material",Ne.material]),Ne.material=ft};re(l.starsObj),re(l.grid),re(l.atmosphere),re(u.object),ge(l.globe,T),ge(o.points,x),ne>=0?(SP(ne+1,A.uniforms.uId.value),ge(o.heroMesh,A)):re(o.heroMesh);const $=n.getRenderTarget(),fe=n.getClearColor(new Ge),ye=n.getClearAlpha();t.setViewOffset(ee,le,Math.round(H)-(E>>1),Math.round(ce)-(E>>1),E,E),n.setRenderTarget(M),n.setClearColor(0,1),n.clear(),n.render(e,t),n.readRenderTargetPixels(M,0,0,E,E,v),t.clearViewOffset(),n.setRenderTarget($),n.setClearColor(fe,ye);for(let Ne=O.length-1;Ne>=0;Ne--){const[ft,k,_t]=O[Ne];ft[k]=_t}const Se=E>>1;let Re=null,De=1/0;for(let Ne=0;Ne<E;Ne++)for(let ft=0;ft<E;ft++){const k=((E-1-Ne)*E+ft)*4,_t=v[k]<<16|v[k+1]<<8|v[k+2];if(!_t)continue;const dt=(ft-Se)*(ft-Se)+(Ne-Se)*(Ne-Se);dt<De&&(De=dt,Re=_t-1)}return Re!==null&&Re<r.nodes.length?Re:null},D=U=>{_||(_=requestAnimationFrame(()=>{if(_=0,c.current)return;const W=z(U.clientX,U.clientY);n.domElement.style.cursor=W===null?"grab":"pointer",h(W===null?null:r.nodes[W],W===null?null:{x:U.clientX,y:U.clientY})}))},I=U=>{g={x:U.clientX,y:U.clientY},S=!1},X=U=>{if(!g)return;const W=U.clientX-g.x,V=U.clientY-g.y;if(S=W*W+V*V>36,g=null,S)return;const Z=z(U.clientX,U.clientY);Z===null?p():d(r.nodes[Z],{x:U.clientX,y:U.clientY})},L=()=>{_&&(cancelAnimationFrame(_),_=0),c.current||h(null,null)},C=n.domElement;return C.addEventListener("pointermove",D,{passive:!0}),C.addEventListener("pointerdown",I),C.addEventListener("pointerup",X),C.addEventListener("pointerleave",L),{pickAt:z,dispose(){_&&cancelAnimationFrame(_),C.removeEventListener("pointermove",D),C.removeEventListener("pointerdown",I),C.removeEventListener("pointerup",X),C.removeEventListener("pointerleave",L),M?.dispose(),x.dispose(),T.dispose(),A.dispose()}}}const z0=1.0025,EP=4,wP=2.6;function TP(n){const{scale:e,translate:t}=n.transform;return n.arcs.map(r=>{let o=0,l=0;return r.map(([u,c])=>(o+=u,l+=c,[o*e[0]+t[0],l*e[1]+t[1]]))})}function AP(n,e){const t=n.objects.countries||n.objects.land,r=[],o=l=>{const u=[];for(const c of l){const h=c<0?e[~c].slice().reverse():e[c];u.length?u.push(...h.slice(1)):u.push(...h)}return u};for(const l of t.geometries){const u=l.type==="Polygon"?[l.arcs]:l.type==="MultiPolygon"?l.arcs:[];for(const c of u)for(const h of c)r.push(o(h))}return r}function CP(n){const e=[],t=new q,r=new q;for(const l of n)for(let u=0;u<l.length-1;u++){const[c,h]=l[u],[d,p]=l[u+1];if(Math.abs(d-c)>180)continue;const _=Math.max(Math.abs(d-c),Math.abs(p-h)),g=Math.max(1,Math.ceil(_/EP));t.copy(Od(h,c,z0));for(let S=1;S<=g;S++){const E=S/g;r.copy(Od(h+(p-h)*E,c+(d-c)*E,z0)),e.push(t.x,t.y,t.z,r.x,r.y,r.z),t.copy(r)}}const o=new cn;return o.setAttribute("position",new Wt(new Float32Array(e),3)),o}function RP(n){const e=new Ka({color:2830392,transparent:!0,opacity:.5,depthWrite:!1}),t=new $c(new cn,e);t.visible=!1,t.renderOrder=0,n.add(t);const r={"110m":null,"50m":null},o={};let l=!1,u=null;const c=d=>{!r[d]||u===d||(t.geometry=r[d],u=d)},h=(d,p)=>{r[d]||o[d]||(o[d]=!0,fetch(`/openflights/geo/countries-${d}.json`).then(_=>_.ok?_.json():Promise.reject(new Error(_.status))).then(_=>{const g=TP(_);r[d]=CP(AP(_,g)),o[d]=!1,l&&(d!=="110m"||!r["50m"])&&(c(d),p?.())}).catch(()=>{o[d]=!1}))};return{object:t,setTheme(d,p){l=!!d.borders,t.visible=l,l&&(e.color.set(d.borders.color),e.opacity=d.borders.opacity,r["110m"]?c(r["50m"]?"50m":"110m"):h("110m",p))},updateDetail(d,p){l&&(d<=wP?r["50m"]?c("50m"):h("50m",p):r["110m"]&&c("110m"))},dispose(){e.dispose();for(const d of Object.keys(r))r[d]?.dispose();n.remove(t)}}}const ai={orange:"#e69f00",sky:"#56b4e9",green:"#009e73",blue:"#0072b2",vermillion:"#d55e00",purple:"#cc79a7"},_n=n=>new Ge(n),B0={dark:{fog:724242,fogDensity:.055,node:{hub:_n("#e69f00"),mid:_n("#56b4e9"),low:_n("#f3f4f6")},nodeSelected:_n(ai.orange),nodeConnected:_n(ai.purple),route:{intl:_n(ai.sky),domestic:_n(ai.green),selected:_n(ai.orange)},routeBlending:Gu,routeOpacity:{globe:.29,topology:.2},globe:{color:1055270,emissive:462874,specular:2704476,shininess:22},grid:{color:3493992,opacity:.13},atmosphere:{color:new Ge("#389eeb"),strength:.26},stars:!0,terrain:!1,borders:null,lights:{hemiSky:10145778,hemiGround:659488,hemi:1.15,sun:1.4}},light:{fog:15659508,fogDensity:.03,node:{hub:_n(ai.vermillion),mid:_n(ai.blue),low:_n("#1c1f26")},nodeSelected:_n(ai.vermillion),nodeConnected:_n(ai.purple),route:{intl:_n(ai.blue),domestic:_n(ai.green),selected:_n(ai.vermillion)},routeBlending:Wr,routeOpacity:{globe:.26,topology:.22},globe:{color:14673644,emissive:0,specular:2241348,shininess:4},grid:{color:4937059,opacity:.12},atmosphere:{color:new Ge("#5c8cb8"),strength:.16},stars:!1,terrain:{ocean:new Ge("#a9d3ee"),oceanDeep:new Ge("#7fbde4"),shore:new Ge("#cfe8f7"),land:[{at:0,color:new Ge("#5fae8d")},{at:.18,color:new Ge("#9ac68a")},{at:.38,color:new Ge("#f0e442")},{at:.58,color:new Ge("#e69f00")},{at:.78,color:new Ge("#d55e00")},{at:1,color:new Ge("#f4f1ec")}],relief:.55},borders:{color:2830392,opacity:.5,coastOpacity:.75},lights:{hemiSky:16777215,hemiGround:13227230,hemi:1.35,sun:.85}}},H0=n=>B0[n]||B0.dark;function bP({data:n,positions:e,options:t,selected:r,onHover:o,onSelect:l,onClear:u,focusRequest:c,topologyVersion:h}){const d=At.useRef(),p=At.useRef(),_=At.useRef(r);return _.current=r,At.useEffect(()=>{const g=d.current;if(!g||!n)return;let S=!1,E=0,M=performance.now(),v=[],x="globe",T=H0(t.theme);const A=new nx;A.fog=new Yc(T.fog,T.fogDensity);const R=new qn(42,1,.01,100);R.position.set(0,.3,3.55);const z=new tx({antialias:!0,alpha:!0,powerPreference:"high-performance"});z.setPixelRatio(Math.min(devicePixelRatio,1.75)),z.setSize(g.clientWidth,g.clientHeight,!1),z.outputColorSpace=li,z.domElement.tabIndex=0,z.domElement.setAttribute("role","img"),z.domElement.setAttribute("aria-label",`Interactive 3D flight network with ${sr.format(n.nodes.length)} airports and ${sr.format(n.links.length)} connections`),g.appendChild(z.domElement);const D=new J2(R,z.domElement);D.enableDamping=!0,D.dampingFactor=.065,D.enablePan=!1,D.minDistance=1.55,D.maxDistance=8,D.autoRotateSpeed=.32;const I=new fx(10145778,659488,1.15);A.add(I);const X=new hx(16777215,1.4);X.position.set(3,2,4),A.add(X);const L=()=>g.clientHeight||800,C=mP(A),U=RP(A),W=gP(A,n,e,z,R,L),V=_P(A,n,e),Z=MP({renderer:z,scene:A,camera:R,data:n,sprites:W,world:C,routes:V,selectedRef:_,onHover:o,onSelect:l,onClear:u}),te=(ge=x)=>{D.target.set(0,0,0),R.position.set(0,.3,ge==="globe"?3.55:4.2),D.update()},ee=ge=>{const $=e.read(x,ge.index,new q);if(x==="globe"){const fe=$.clone().normalize().multiplyScalar(2.35),ye=R.position.clone(),Se=D.target.clone(),Re=performance.now(),De=n0?1:650,Ne=ft=>{const k=Math.min(1,(ft-Re)/De),_t=1-Math.pow(1-k,3);R.position.lerpVectors(ye,fe,_t),D.target.lerpVectors(Se,$.clone().multiplyScalar(.18),_t),D.update(),k<1&&requestAnimationFrame(Ne)};requestAnimationFrame(Ne)}else D.target.copy($),R.position.set($.x,$.y,$.z+2.4),D.update()},le=()=>{A.fog.color.set(T.fog),A.fog.density=T.fogDensity,I.color.set(T.lights.hemiSky),I.groundColor.set(T.lights.hemiGround),I.intensity=T.lights.hemi,X.intensity=T.lights.sun,C.applyTheme(T),U.setTheme(T),U.object.visible=!!T.borders&&x==="globe"},H=(ge,$)=>{x=ge.view,T=H0(ge.theme),le(),D.autoRotate=ge.autoRotate&&!n0&&ge.view==="globe";const fe=$||W.topHubNode;W.update(ge,$,fe,T),V.update(ge,$,T),C.globeGroup.visible=ge.view==="globe",D.enablePan=ge.view==="topology",D.minDistance=ge.view==="globe"?1.55:1.2,D.maxDistance=ge.view==="globe"?8:10};p.current={update:H,focusNode:ee,resetCamera:te},H(t,r);const ce=()=>{const ge=g.clientWidth,$=g.clientHeight;!ge||!$||(R.aspect=ge/$,R.updateProjectionMatrix(),z.setSize(ge,$,!1),W.resize())},ne=new ResizeObserver(ce);ne.observe(g),ce();const O=ge=>{if(S)return;const $=ge-M;M=ge,v.push($),v.length>90&&v.shift(),v.length===90&&z.getPixelRatio()>1&&gA(v)>24&&(z.setPixelRatio(1),W.material.uniforms.uPixelRatio.value=1,ce(),v=[]),D.update(),U.updateDetail(R.position.length()),z.render(A,R),E=requestAnimationFrame(O)};E=requestAnimationFrame(O);const re=ge=>{ge.key.toLowerCase()==="r"&&document.activeElement?.tagName!=="INPUT"&&te()};return window.addEventListener("keydown",re),()=>{S=!0,cancelAnimationFrame(E),ne.disconnect(),window.removeEventListener("keydown",re),Z.dispose(),U.dispose(),C.dispose(),D.dispose(),A.traverse(ge=>{ge.geometry?.dispose?.(),Array.isArray(ge.material)?ge.material.forEach($=>$.dispose()):ge.material?.dispose?.()}),z.dispose(),z.domElement.remove(),p.current=null}},[n]),At.useEffect(()=>{p.current?.update(t,r)},[t,r,h]),At.useEffect(()=>{c?.node&&p.current?.focusNode(c.node)},[c]),se.jsx("div",{ref:d,className:"canvas-host"})}function PP(){return se.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:se.jsx("path",{d:"M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.39v-1.2h-2.5v8.37h2.5v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.5M6.88 8.56a1.68 1.68 0 1 1 0-3.36 1.68 1.68 0 0 1 0 3.36m-1.2 10.12h2.5V9.9h-2.5v8.78z"})})}function LP(){return se.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:se.jsx("path",{d:"M12 2C6.477 2 2 6.477 2 12c0 4.42 2.865 8.17 6.839 9.49.5.092.682-.217.682-.482 0-.237-.008-.868-.013-1.703-2.782.603-3.369-1.343-3.369-1.343-.454-1.156-1.11-1.463-1.11-1.463-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.891 1.529 2.341 1.544 2.914 1.182.092-.92.349-1.544.636-1.9-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.578 9.578 0 0 1 12 6.836c.85.004 1.705.114 2.504.336 1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48C19.139 20.167 22 16.418 22 12c0-5.523-4.477-10-10-10z"})})}function DP({data:n,options:e,setOptions:t,query:r,setQuery:o,selected:l,selectNode:u,clearSelection:c,open:h}){const d=At.useMemo(()=>{const p=r.trim().toLowerCase();return p?n.nodes.filter(_=>`${_.id} ${_.name} ${_.city} ${_.country}`.toLowerCase().includes(p)).sort((_,g)=>g.degree-_.degree).slice(0,8):[]},[n,r]);return se.jsxs("aside",{id:"controls",className:`sidebar ${h?"open":""}`,"aria-label":"Network controls",children:[se.jsxs("section",{className:"section",children:[se.jsxs("div",{className:"section-title",children:[se.jsx("span",{children:"Find an airport"}),se.jsx("span",{className:"value-pill",children:sr.format(n.nodes.length)})]}),se.jsxs("div",{className:"search-wrap",children:[se.jsx("input",{id:"airport-search",className:"search",value:r,onInput:p=>o(p.target.value),placeholder:"Code, city, airport…","aria-label":"Search airports",autoComplete:"off"}),se.jsx("span",{className:"search-icon",children:"⌕"})]}),d.length>0&&se.jsx("div",{className:"results",role:"listbox",children:d.map(p=>se.jsxs("button",{className:"result-btn",role:"option",onClick:()=>{u(p),o("")},children:[se.jsx("span",{className:"result-name",children:p.name}),se.jsx("span",{className:"result-code",children:p.iata||p.icao})]},p.id))}),l&&se.jsxs("div",{className:"selected-chip",children:[se.jsxs("div",{children:[se.jsx("strong",{children:l.name}),se.jsxs("span",{children:[l.city,", ",l.country]})]}),se.jsx("button",{className:"clear-btn",onClick:c,"aria-label":"Clear selected airport",children:"×"})]})]}),se.jsxs("section",{className:"section",children:[se.jsx("div",{className:"section-title",children:se.jsx("span",{children:"View"})}),se.jsxs("div",{className:"segmented",role:"group","aria-label":"Visualization mode",children:[se.jsx("button",{className:`seg-btn ${e.view==="globe"?"active":""}`,"aria-pressed":e.view==="globe",onClick:()=>t(p=>({...p,view:"globe"})),children:"3D globe"}),se.jsx("button",{className:`seg-btn ${e.view==="topology"?"active":""}`,"aria-pressed":e.view==="topology",onClick:()=>t(p=>({...p,view:"topology"})),children:"Topology"})]}),se.jsxs("div",{className:"segmented",role:"group","aria-label":"Colour theme",style:{marginTop:"8px"},children:[se.jsx("button",{className:`seg-btn ${e.theme==="dark"?"active":""}`,"aria-pressed":e.theme==="dark",onClick:()=>t(p=>({...p,theme:"dark"})),children:"Dark"}),se.jsx("button",{className:`seg-btn ${e.theme==="light"?"active":""}`,"aria-pressed":e.theme==="light",onClick:()=>t(p=>({...p,theme:"light"})),children:"Light map"})]}),se.jsxs("label",{className:"check-row",children:[se.jsx("input",{type:"checkbox",checked:e.autoRotate,onChange:p=>t(_=>({..._,autoRotate:p.target.checked}))}),"Auto-rotate globe"]})]}),se.jsxs("section",{className:"section",children:[se.jsxs("div",{className:"section-title",children:[se.jsx("span",{children:"Route filters"}),se.jsxs("span",{className:"value-pill",children:[e.density,"%"]})]}),se.jsxs("div",{className:"control-row",children:[se.jsxs("div",{className:"control-label",children:[se.jsx("span",{children:"Route density"}),se.jsxs("span",{children:[e.density,"%"]})]}),se.jsx("input",{type:"range",min:"5",max:"100",step:"5",value:e.density,"aria-label":"Route density: adjust from 5% to 100%",onInput:p=>t(_=>({..._,density:+p.target.value}))})]}),se.jsxs("div",{className:"control-row",children:[se.jsxs("div",{className:"control-label",children:[se.jsx("span",{children:"Minimum hub degree"}),se.jsx("span",{children:e.minDegree})]}),se.jsx("input",{type:"range",min:"0",max:"80",step:"1",value:e.minDegree,"aria-label":"Minimum hub degree: adjust from 0 to 80 connections",onInput:p=>t(_=>({..._,minDegree:+p.target.value}))})]}),se.jsxs("div",{className:"control-row",children:[se.jsx("label",{className:"control-label",htmlFor:"scope",children:se.jsx("span",{children:"Route scope"})}),se.jsxs("select",{id:"scope",value:e.scope,onChange:p=>t(_=>({..._,scope:p.target.value})),children:[se.jsx("option",{value:"all",children:"All routes"}),se.jsx("option",{value:"international",children:"International only"}),se.jsx("option",{value:"domestic",children:"Domestic only"})]})]}),se.jsxs("div",{className:"control-row",children:[se.jsx("label",{className:"control-label",htmlFor:"country",children:se.jsx("span",{children:"Country focus"})}),se.jsxs("select",{id:"country",value:e.country,onChange:p=>t(_=>({..._,country:p.target.value})),children:[se.jsx("option",{value:"",children:"All countries"}),n.countries.map(([p,_])=>se.jsxs("option",{value:p,children:[p," (",_,")"]},p))]})]})]}),se.jsxs("section",{className:"section",children:[se.jsx("div",{className:"section-title",children:se.jsx("span",{children:"Legend"})}),se.jsxs("div",{className:"legend",children:[se.jsxs("div",{className:"legend-row",children:[se.jsx("span",{className:"swatch",style:{background:"#56b4e9"}}),se.jsx("span",{children:"International connection"})]}),se.jsxs("div",{className:"legend-row",children:[se.jsx("span",{className:"swatch",style:{background:"#009e73"}}),se.jsx("span",{children:"Domestic connection"})]}),se.jsxs("div",{className:"legend-row",children:[se.jsx("span",{className:"swatch",style:{background:"#e69f00"}}),se.jsx("span",{children:"Selected-airport connection"})]})]})]}),se.jsxs("section",{className:"section help",children:["Drag to orbit · scroll to zoom · click an airport to pin.",se.jsx("br",{}),se.jsx("br",{}),se.jsx("kbd",{children:"/"})," Search   ",se.jsx("kbd",{children:"Esc"})," Clear selection  ",se.jsx("kbd",{children:"R"})," Reset camera"]}),se.jsxs("footer",{className:"sidebar-footer",children:[se.jsxs("div",{className:"social-links",children:[se.jsx("a",{href:"https://www.linkedin.com/in/jeremiahjking/",className:"social-btn",target:"_blank",rel:"noreferrer","aria-label":"LinkedIn",children:se.jsx(PP,{})}),se.jsx("a",{href:"https://github.com/unguisdraconis",className:"social-btn",target:"_blank",rel:"noreferrer","aria-label":"GitHub",children:se.jsx(LP,{})})]}),se.jsx("p",{className:"data-source",children:"© 2026 Jeremiah King"}),se.jsxs("p",{className:"data-source",children:["Data from","",se.jsx("a",{href:"https://openflights.org",target:"_blank",rel:"noreferrer",children:"OpenFlights.org"})]})]})]})}function NP({node:n,pinned:e,point:t}){if(!n||!t)return null;const r=295,o=18,l=t.x+o,c=l+r<=innerWidth?l:Math.max(0,t.x-r-o),h=Math.max(12,Math.min(t.y-20,innerHeight-190));return se.jsxs("div",{className:`tooltip ${e?"pinned":""}`,style:{left:c,top:h},role:e?"dialog":"status","aria-label":`${n.name} airport details`,children:[se.jsxs("div",{className:"tooltip-top",children:[se.jsx("div",{className:"airport-code",children:n.iata||n.icao||"—"}),se.jsxs("div",{children:[se.jsx("h2",{children:n.name}),se.jsxs("div",{className:"tooltip-sub",children:[n.city,", ",n.country]})]})]}),se.jsxs("div",{className:"tooltip-grid",children:[se.jsxs("div",{className:"tooltip-metric",children:[se.jsx("b",{children:sr.format(n.degree)}),se.jsx("span",{children:"Connections"})]}),se.jsxs("div",{className:"tooltip-metric",children:[se.jsx("b",{children:sr.format(n.routeCount)}),se.jsx("span",{children:"Route records"})]}),se.jsxs("div",{className:"tooltip-metric",children:[se.jsxs("b",{children:[n.lat.toFixed(1),"°, ",n.lon.toFixed(1),"°"]}),se.jsx("span",{children:"Coordinates"})]})]}),se.jsx("div",{className:"tooltip-note",children:e?"Pinned — click empty space or press Escape to close.":"Click to pin this airport."})]})}function IP({onLoaded:n,loading:e,error:t}){const r=At.useRef(),o=async l=>{const u=[...l],c=u.find(d=>/airport/i.test(d.name)),h=u.find(d=>/route/i.test(d.name));if(!c||!h)return n(null,null,"Select both airports.dat and routes.dat.");n(await c.text(),await h.text())};return se.jsx("div",{className:"load-screen",onDragOver:l=>l.preventDefault(),onDrop:l=>{l.preventDefault(),o(l.dataTransfer.files)},children:se.jsxs("div",{className:"load-card",children:[se.jsx("div",{className:"eyebrow",children:"OpenFlights data loader"}),se.jsx("h2",{children:e?"Loading the global aviation network…":"Load the global aviation network"}),e?se.jsx("p",{role:"status","aria-live":"polite",children:"Fetching and parsing the airport and route data. This usually takes a few seconds."}):se.jsxs("p",{children:["The dashboard first looks for ",se.jsx("b",{children:"airports.dat"})," and"," ",se.jsx("b",{children:"routes.dat"})," beside this HTML file. If your browser blocks local file requests, select or drop both supplied files here."]}),se.jsx("div",{className:"drop-zone",children:se.jsxs("div",{children:[se.jsx("button",{className:"primary-btn",onClick:()=>r.current.click(),disabled:e,children:e?"Building network…":"Choose both data files"}),se.jsx("input",{ref:r,className:"sr-only",type:"file",multiple:!0,accept:".txt,.dat,text/plain",onChange:l=>o(l.target.files)}),se.jsx("div",{className:"file-note",children:"You can also drag and drop both files onto this panel."})]})}),e&&se.jsx("div",{className:"loading-bar","aria-hidden":"true"}),t&&se.jsx("div",{className:"error",role:"alert",children:t})]})})}function Fu({value:n,label:e}){return se.jsxs("div",{className:"stat",children:[se.jsx("div",{className:"stat-value",children:n}),se.jsx("div",{className:"stat-label",children:e})]})}const UP=()=>{if(typeof window>"u")return"dark";try{const n=localStorage.getItem("openflights-theme");if(n==="light"||n==="dark")return n}catch{}return window.matchMedia?.("(prefers-color-scheme: light)").matches?"light":"dark"};function FP(){const[n,e]=At.useState(null),[t,r]=At.useState(!0),[o,l]=At.useState(""),[u,c]=At.useState({view:"globe",density:55,minDegree:0,scope:"all",country:"",autoRotate:!1,theme:UP()}),[h,d]=At.useState(""),[p,_]=At.useState(null),[g,S]=At.useState(null),[E,M]=At.useState(null),[v,x]=At.useState(null),[T,A]=At.useState(!1),[R,z]=At.useState(0),D=At.useCallback(()=>z(V=>V+1),[]),I=At.useMemo(()=>n?G2(n.nodes):null,[n]);Z2(n,I,D);const X=At.useCallback((V,Z,te)=>{if(te){l(te),r(!1);return}r(!0),l(""),setTimeout(()=>{try{const ee=H2(V,Z);if(!ee.nodes.length||!ee.links.length)throw new Error("No usable airport-route pairs were found.");e(ee)}catch(ee){l(`Could not parse the files: ${ee.message}`)}finally{r(!1)}},30)},[]);At.useEffect(()=>{let V=!1;const Z=new AbortController;return K2({signal:Z.signal}).then(({airports:te,routes:ee,source:le})=>{V||(le!=="local"&&console.info(`OpenFlights data loaded from ${le}.`),X(te,ee))}).catch(te=>{V||Z.signal.aborted||X(null,null,`Could not load the flight data (${te.message}). Select or drop airports.dat and routes.dat below.`)}),()=>{V=!0,Z.abort()}},[X]),At.useEffect(()=>{const V=document.documentElement;V.dataset.themeSwitching="",V.dataset.theme=u.theme;let Z=!1;const te=()=>{Z||(Z=!0,delete V.dataset.themeSwitching)},ee=requestAnimationFrame(()=>requestAnimationFrame(te)),le=setTimeout(te,300);try{localStorage.setItem("openflights-theme",u.theme)}catch{}return()=>{cancelAnimationFrame(ee),clearTimeout(le),te()}},[u.theme]),At.useEffect(()=>{const V=window.matchMedia?.("(prefers-color-scheme: light)");if(!V)return;const Z=te=>{let ee=null;try{ee=localStorage.getItem("openflights-theme")}catch{ee=null}ee||c(le=>({...le,theme:te.matches?"light":"dark"}))};return V.addEventListener("change",Z),()=>V.removeEventListener("change",Z)},[]),At.useEffect(()=>{const V=Z=>{Z.key==="/"&&document.activeElement?.tagName!=="INPUT"&&(Z.preventDefault(),document.getElementById("airport-search")?.focus()),Z.key==="Escape"&&(_(null),S(null),M(null))};return window.addEventListener("keydown",V),()=>window.removeEventListener("keydown",V)},[]);const L=(V,Z)=>{_(V),S(null),M(Z||{x:innerWidth*.56,y:innerHeight*.3}),x({node:V,id:performance.now()}),A(!1)},C=()=>{_(null),S(null),M(null)},U=p||g,W=At.useMemo(()=>n?n.links.filter(V=>(u.scope==="all"||u.scope==="international"===V.international)&&(!u.country||V.source.country===u.country||V.target.country===u.country)&&V.source.degree>=u.minDegree&&V.target.degree>=u.minDegree).length:0,[n,u.scope,u.country,u.minDegree]);return se.jsxs("div",{className:"app",children:[se.jsxs("header",{className:"topbar",children:[se.jsx("button",{className:"icon-btn mobile-menu-btn",onClick:()=>A(V=>!V),"aria-label":"Toggle controls","aria-expanded":T,children:"☰"}),se.jsxs("div",{className:"brand",children:[se.jsx("div",{className:"eyebrow",children:"Global aviation intelligence"}),se.jsx("h1",{children:"OpenFlights Network"})]}),n&&se.jsxs("div",{className:"stats","aria-label":"Network summary",children:[se.jsx(Fu,{value:sr.format(n.nodes.length),label:"Airports"}),se.jsx(Fu,{value:sr.format(n.links.length),label:"Connections"}),se.jsx(Fu,{value:sr.format(W),label:"Visible pool"}),se.jsx(Fu,{value:sr.format(n.countries.length),label:"Countries"})]}),se.jsx("div",{className:"top-actions",children:se.jsx("button",{className:"icon-btn desktop-only",onClick:()=>c(V=>({...V,autoRotate:!V.autoRotate})),"aria-label":"Toggle automatic rotation","aria-pressed":u.autoRotate,children:"◌"})})]}),se.jsxs("main",{className:"main",children:[n&&se.jsx(DP,{data:n,options:u,setOptions:c,query:h,setQuery:d,selected:p,selectNode:L,clearSelection:C,open:T}),se.jsxs("section",{className:"stage","aria-label":"3D flight visualization",children:[n&&se.jsx(bP,{data:n,positions:I,options:u,selected:p,topologyVersion:R,focusRequest:v,onHover:(V,Z)=>{S(V),M(Z)},onSelect:L,onClear:C}),n&&se.jsxs("div",{className:"stage-badge",children:[se.jsx("span",{className:"dot"}),se.jsxs("span",{children:[u.view==="globe"?"GEOGRAPHIC GLOBE":"FORCE-DIRECTED TOPOLOGY"," ","· ",u.density,"% ROUTES"]})]}),se.jsx(NP,{node:U,pinned:!!p,point:E}),!n&&se.jsx(IP,{onLoaded:X,loading:t,error:o}),se.jsx("div",{className:"sr-only","aria-live":"polite",children:U?`${U.name}, ${U.city}, ${U.country}. ${U.degree} direct connections.`:""})]})]})]})}IS.createRoot(document.getElementById("root")).render(se.jsx(RS.StrictMode,{children:se.jsx(FP,{})}));
