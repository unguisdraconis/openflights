(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const l of o)if(l.type==="childList")for(const u of l.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&r(u)}).observe(document,{childList:!0,subtree:!0});function t(o){const l={};return o.integrity&&(l.integrity=o.integrity),o.referrerPolicy&&(l.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?l.credentials="include":o.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function r(o){if(o.ep)return;o.ep=!0;const l=t(o);fetch(o.href,l)}})();function TS(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}var Dh={exports:{}},da={},Nh={exports:{}},dt={};var $g;function AS(){if($g)return dt;$g=1;var n=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),l=Symbol.for("react.provider"),u=Symbol.for("react.context"),c=Symbol.for("react.forward_ref"),h=Symbol.for("react.suspense"),d=Symbol.for("react.memo"),p=Symbol.for("react.lazy"),_=Symbol.iterator;function g(O){return O===null||typeof O!="object"?null:(O=_&&O[_]||O["@@iterator"],typeof O=="function"?O:null)}var x={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,M={};function v(O,re,be){this.props=O,this.context=re,this.refs=M,this.updater=be||x}v.prototype.isReactComponent={},v.prototype.setState=function(O,re){if(typeof O!="object"&&typeof O!="function"&&O!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,O,re,"setState")},v.prototype.forceUpdate=function(O){this.updater.enqueueForceUpdate(this,O,"forceUpdate")};function y(){}y.prototype=v.prototype;function C(O,re,be){this.props=O,this.context=re,this.refs=M,this.updater=be||x}var T=C.prototype=new y;T.constructor=C,E(T,v.prototype),T.isPureReactComponent=!0;var A=Array.isArray,z=Object.prototype.hasOwnProperty,D={current:null},N={key:!0,ref:!0,__self:!0,__source:!0};function W(O,re,be){var j,le={},_e=null,ye=null;if(re!=null)for(j in re.ref!==void 0&&(ye=re.ref),re.key!==void 0&&(_e=""+re.key),re)z.call(re,j)&&!N.hasOwnProperty(j)&&(le[j]=re[j]);var Ce=arguments.length-2;if(Ce===1)le.children=be;else if(1<Ce){for(var De=Array(Ce),Ne=0;Ne<Ce;Ne++)De[Ne]=arguments[Ne+2];le.children=De}if(O&&O.defaultProps)for(j in Ce=O.defaultProps,Ce)le[j]===void 0&&(le[j]=Ce[j]);return{$$typeof:n,type:O,key:_e,ref:ye,props:le,_owner:D.current}}function L(O,re){return{$$typeof:n,type:O.type,key:re,ref:O.ref,props:O.props,_owner:O._owner}}function R(O){return typeof O=="object"&&O!==null&&O.$$typeof===n}function U(O){var re={"=":"=0",":":"=2"};return"$"+O.replace(/[=:]/g,function(be){return re[be]})}var X=/\/+/g;function H(O,re){return typeof O=="object"&&O!==null&&O.key!=null?U(""+O.key):re.toString(36)}function q(O,re,be,j,le){var _e=typeof O;(_e==="undefined"||_e==="boolean")&&(O=null);var ye=!1;if(O===null)ye=!0;else switch(_e){case"string":case"number":ye=!0;break;case"object":switch(O.$$typeof){case n:case e:ye=!0}}if(ye)return ye=O,le=le(ye),O=j===""?"."+H(ye,0):j,A(le)?(be="",O!=null&&(be=O.replace(X,"$&/")+"/"),q(le,re,be,"",function(Ne){return Ne})):le!=null&&(R(le)&&(le=L(le,be+(!le.key||ye&&ye.key===le.key?"":(""+le.key).replace(X,"$&/")+"/")+O)),re.push(le)),1;if(ye=0,j=j===""?".":j+":",A(O))for(var Ce=0;Ce<O.length;Ce++){_e=O[Ce];var De=j+H(_e,Ce);ye+=q(_e,re,be,De,le)}else if(De=g(O),typeof De=="function")for(O=De.call(O),Ce=0;!(_e=O.next()).done;)_e=_e.value,De=j+H(_e,Ce++),ye+=q(_e,re,be,De,le);else if(_e==="object")throw re=String(O),Error("Objects are not valid as a React child (found: "+(re==="[object Object]"?"object with keys {"+Object.keys(O).join(", ")+"}":re)+"). If you meant to render a collection of children, use an array instead.");return ye}function te(O,re,be){if(O==null)return O;var j=[],le=0;return q(O,j,"","",function(_e){return re.call(be,_e,le++)}),j}function J(O){if(O._status===-1){var re=O._result;re=re(),re.then(function(be){(O._status===0||O._status===-1)&&(O._status=1,O._result=be)},function(be){(O._status===0||O._status===-1)&&(O._status=2,O._result=be)}),O._status===-1&&(O._status=0,O._result=re)}if(O._status===1)return O._result.default;throw O._result}var ue={current:null},V={transition:null},fe={ReactCurrentDispatcher:ue,ReactCurrentBatchConfig:V,ReactCurrentOwner:D};function ne(){throw Error("act(...) is not supported in production builds of React.")}return dt.Children={map:te,forEach:function(O,re,be){te(O,function(){re.apply(this,arguments)},be)},count:function(O){var re=0;return te(O,function(){re++}),re},toArray:function(O){return te(O,function(re){return re})||[]},only:function(O){if(!R(O))throw Error("React.Children.only expected to receive a single React element child.");return O}},dt.Component=v,dt.Fragment=t,dt.Profiler=o,dt.PureComponent=C,dt.StrictMode=r,dt.Suspense=h,dt.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=fe,dt.act=ne,dt.cloneElement=function(O,re,be){if(O==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+O+".");var j=E({},O.props),le=O.key,_e=O.ref,ye=O._owner;if(re!=null){if(re.ref!==void 0&&(_e=re.ref,ye=D.current),re.key!==void 0&&(le=""+re.key),O.type&&O.type.defaultProps)var Ce=O.type.defaultProps;for(De in re)z.call(re,De)&&!N.hasOwnProperty(De)&&(j[De]=re[De]===void 0&&Ce!==void 0?Ce[De]:re[De])}var De=arguments.length-2;if(De===1)j.children=be;else if(1<De){Ce=Array(De);for(var Ne=0;Ne<De;Ne++)Ce[Ne]=arguments[Ne+2];j.children=Ce}return{$$typeof:n,type:O.type,key:le,ref:_e,props:j,_owner:ye}},dt.createContext=function(O){return O={$$typeof:u,_currentValue:O,_currentValue2:O,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},O.Provider={$$typeof:l,_context:O},O.Consumer=O},dt.createElement=W,dt.createFactory=function(O){var re=W.bind(null,O);return re.type=O,re},dt.createRef=function(){return{current:null}},dt.forwardRef=function(O){return{$$typeof:c,render:O}},dt.isValidElement=R,dt.lazy=function(O){return{$$typeof:p,_payload:{_status:-1,_result:O},_init:J}},dt.memo=function(O,re){return{$$typeof:d,type:O,compare:re===void 0?null:re}},dt.startTransition=function(O){var re=V.transition;V.transition={};try{O()}finally{V.transition=re}},dt.unstable_act=ne,dt.useCallback=function(O,re){return ue.current.useCallback(O,re)},dt.useContext=function(O){return ue.current.useContext(O)},dt.useDebugValue=function(){},dt.useDeferredValue=function(O){return ue.current.useDeferredValue(O)},dt.useEffect=function(O,re){return ue.current.useEffect(O,re)},dt.useId=function(){return ue.current.useId()},dt.useImperativeHandle=function(O,re,be){return ue.current.useImperativeHandle(O,re,be)},dt.useInsertionEffect=function(O,re){return ue.current.useInsertionEffect(O,re)},dt.useLayoutEffect=function(O,re){return ue.current.useLayoutEffect(O,re)},dt.useMemo=function(O,re){return ue.current.useMemo(O,re)},dt.useReducer=function(O,re,be){return ue.current.useReducer(O,re,be)},dt.useRef=function(O){return ue.current.useRef(O)},dt.useState=function(O){return ue.current.useState(O)},dt.useSyncExternalStore=function(O,re,be){return ue.current.useSyncExternalStore(O,re,be)},dt.useTransition=function(){return ue.current.useTransition()},dt.version="18.3.1",dt}var qg;function kd(){return qg||(qg=1,Nh.exports=AS()),Nh.exports}var Kg;function CS(){if(Kg)return da;Kg=1;var n=kd(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),r=Object.prototype.hasOwnProperty,o=n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function u(c,h,d){var p,_={},g=null,x=null;d!==void 0&&(g=""+d),h.key!==void 0&&(g=""+h.key),h.ref!==void 0&&(x=h.ref);for(p in h)r.call(h,p)&&!l.hasOwnProperty(p)&&(_[p]=h[p]);if(c&&c.defaultProps)for(p in h=c.defaultProps,h)_[p]===void 0&&(_[p]=h[p]);return{$$typeof:e,type:c,key:g,ref:x,props:_,_owner:o.current}}return da.Fragment=t,da.jsx=u,da.jsxs=u,da}var Zg;function RS(){return Zg||(Zg=1,Dh.exports=CS()),Dh.exports}var se=RS(),wt=kd();const bS=TS(wt);var ru={},Ih={exports:{}},In={},Uh={exports:{}},Fh={};var Qg;function PS(){return Qg||(Qg=1,(function(n){function e(V,fe){var ne=V.length;V.push(fe);e:for(;0<ne;){var O=ne-1>>>1,re=V[O];if(0<o(re,fe))V[O]=fe,V[ne]=re,ne=O;else break e}}function t(V){return V.length===0?null:V[0]}function r(V){if(V.length===0)return null;var fe=V[0],ne=V.pop();if(ne!==fe){V[0]=ne;e:for(var O=0,re=V.length,be=re>>>1;O<be;){var j=2*(O+1)-1,le=V[j],_e=j+1,ye=V[_e];if(0>o(le,ne))_e<re&&0>o(ye,le)?(V[O]=ye,V[_e]=ne,O=_e):(V[O]=le,V[j]=ne,O=j);else if(_e<re&&0>o(ye,ne))V[O]=ye,V[_e]=ne,O=_e;else break e}}return fe}function o(V,fe){var ne=V.sortIndex-fe.sortIndex;return ne!==0?ne:V.id-fe.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;n.unstable_now=function(){return l.now()}}else{var u=Date,c=u.now();n.unstable_now=function(){return u.now()-c}}var h=[],d=[],p=1,_=null,g=3,x=!1,E=!1,M=!1,v=typeof setTimeout=="function"?setTimeout:null,y=typeof clearTimeout=="function"?clearTimeout:null,C=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function T(V){for(var fe=t(d);fe!==null;){if(fe.callback===null)r(d);else if(fe.startTime<=V)r(d),fe.sortIndex=fe.expirationTime,e(h,fe);else break;fe=t(d)}}function A(V){if(M=!1,T(V),!E)if(t(h)!==null)E=!0,J(z);else{var fe=t(d);fe!==null&&ue(A,fe.startTime-V)}}function z(V,fe){E=!1,M&&(M=!1,y(W),W=-1),x=!0;var ne=g;try{for(T(fe),_=t(h);_!==null&&(!(_.expirationTime>fe)||V&&!U());){var O=_.callback;if(typeof O=="function"){_.callback=null,g=_.priorityLevel;var re=O(_.expirationTime<=fe);fe=n.unstable_now(),typeof re=="function"?_.callback=re:_===t(h)&&r(h),T(fe)}else r(h);_=t(h)}if(_!==null)var be=!0;else{var j=t(d);j!==null&&ue(A,j.startTime-fe),be=!1}return be}finally{_=null,g=ne,x=!1}}var D=!1,N=null,W=-1,L=5,R=-1;function U(){return!(n.unstable_now()-R<L)}function X(){if(N!==null){var V=n.unstable_now();R=V;var fe=!0;try{fe=N(!0,V)}finally{fe?H():(D=!1,N=null)}}else D=!1}var H;if(typeof C=="function")H=function(){C(X)};else if(typeof MessageChannel<"u"){var q=new MessageChannel,te=q.port2;q.port1.onmessage=X,H=function(){te.postMessage(null)}}else H=function(){v(X,0)};function J(V){N=V,D||(D=!0,H())}function ue(V,fe){W=v(function(){V(n.unstable_now())},fe)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(V){V.callback=null},n.unstable_continueExecution=function(){E||x||(E=!0,J(z))},n.unstable_forceFrameRate=function(V){0>V||125<V?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):L=0<V?Math.floor(1e3/V):5},n.unstable_getCurrentPriorityLevel=function(){return g},n.unstable_getFirstCallbackNode=function(){return t(h)},n.unstable_next=function(V){switch(g){case 1:case 2:case 3:var fe=3;break;default:fe=g}var ne=g;g=fe;try{return V()}finally{g=ne}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(V,fe){switch(V){case 1:case 2:case 3:case 4:case 5:break;default:V=3}var ne=g;g=V;try{return fe()}finally{g=ne}},n.unstable_scheduleCallback=function(V,fe,ne){var O=n.unstable_now();switch(typeof ne=="object"&&ne!==null?(ne=ne.delay,ne=typeof ne=="number"&&0<ne?O+ne:O):ne=O,V){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=ne+re,V={id:p++,callback:fe,priorityLevel:V,startTime:ne,expirationTime:re,sortIndex:-1},ne>O?(V.sortIndex=ne,e(d,V),t(h)===null&&V===t(d)&&(M?(y(W),W=-1):M=!0,ue(A,ne-O))):(V.sortIndex=re,e(h,V),E||x||(E=!0,J(z))),V},n.unstable_shouldYield=U,n.unstable_wrapCallback=function(V){var fe=g;return function(){var ne=g;g=fe;try{return V.apply(this,arguments)}finally{g=ne}}}})(Fh)),Fh}var Jg;function LS(){return Jg||(Jg=1,Uh.exports=PS()),Uh.exports}var e_;function DS(){if(e_)return In;e_=1;var n=kd(),e=LS();function t(i){for(var s="https://reactjs.org/docs/error-decoder.html?invariant="+i,a=1;a<arguments.length;a++)s+="&args[]="+encodeURIComponent(arguments[a]);return"Minified React error #"+i+"; visit "+s+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var r=new Set,o={};function l(i,s){u(i,s),u(i+"Capture",s)}function u(i,s){for(o[i]=s,i=0;i<s.length;i++)r.add(s[i])}var c=!(typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"),h=Object.prototype.hasOwnProperty,d=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,p={},_={};function g(i){return h.call(_,i)?!0:h.call(p,i)?!1:d.test(i)?_[i]=!0:(p[i]=!0,!1)}function x(i,s,a,f){if(a!==null&&a.type===0)return!1;switch(typeof s){case"function":case"symbol":return!0;case"boolean":return f?!1:a!==null?!a.acceptsBooleans:(i=i.toLowerCase().slice(0,5),i!=="data-"&&i!=="aria-");default:return!1}}function E(i,s,a,f){if(s===null||typeof s>"u"||x(i,s,a,f))return!0;if(f)return!1;if(a!==null)switch(a.type){case 3:return!s;case 4:return s===!1;case 5:return isNaN(s);case 6:return isNaN(s)||1>s}return!1}function M(i,s,a,f,m,S,w){this.acceptsBooleans=s===2||s===3||s===4,this.attributeName=f,this.attributeNamespace=m,this.mustUseProperty=a,this.propertyName=i,this.type=s,this.sanitizeURL=S,this.removeEmptyString=w}var v={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(i){v[i]=new M(i,0,!1,i,null,!1,!1)}),[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(i){var s=i[0];v[s]=new M(s,1,!1,i[1],null,!1,!1)}),["contentEditable","draggable","spellCheck","value"].forEach(function(i){v[i]=new M(i,2,!1,i.toLowerCase(),null,!1,!1)}),["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(i){v[i]=new M(i,2,!1,i,null,!1,!1)}),"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(i){v[i]=new M(i,3,!1,i.toLowerCase(),null,!1,!1)}),["checked","multiple","muted","selected"].forEach(function(i){v[i]=new M(i,3,!0,i,null,!1,!1)}),["capture","download"].forEach(function(i){v[i]=new M(i,4,!1,i,null,!1,!1)}),["cols","rows","size","span"].forEach(function(i){v[i]=new M(i,6,!1,i,null,!1,!1)}),["rowSpan","start"].forEach(function(i){v[i]=new M(i,5,!1,i.toLowerCase(),null,!1,!1)});var y=/[\-:]([a-z])/g;function C(i){return i[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(i){var s=i.replace(y,C);v[s]=new M(s,1,!1,i,null,!1,!1)}),"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(i){var s=i.replace(y,C);v[s]=new M(s,1,!1,i,"http://www.w3.org/1999/xlink",!1,!1)}),["xml:base","xml:lang","xml:space"].forEach(function(i){var s=i.replace(y,C);v[s]=new M(s,1,!1,i,"http://www.w3.org/XML/1998/namespace",!1,!1)}),["tabIndex","crossOrigin"].forEach(function(i){v[i]=new M(i,1,!1,i.toLowerCase(),null,!1,!1)}),v.xlinkHref=new M("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1),["src","href","action","formAction"].forEach(function(i){v[i]=new M(i,1,!1,i.toLowerCase(),null,!0,!0)});function T(i,s,a,f){var m=v.hasOwnProperty(s)?v[s]:null;(m!==null?m.type!==0:f||!(2<s.length)||s[0]!=="o"&&s[0]!=="O"||s[1]!=="n"&&s[1]!=="N")&&(E(s,a,m,f)&&(a=null),f||m===null?g(s)&&(a===null?i.removeAttribute(s):i.setAttribute(s,""+a)):m.mustUseProperty?i[m.propertyName]=a===null?m.type===3?!1:"":a:(s=m.attributeName,f=m.attributeNamespace,a===null?i.removeAttribute(s):(m=m.type,a=m===3||m===4&&a===!0?"":""+a,f?i.setAttributeNS(f,s,a):i.setAttribute(s,a))))}var A=n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,z=Symbol.for("react.element"),D=Symbol.for("react.portal"),N=Symbol.for("react.fragment"),W=Symbol.for("react.strict_mode"),L=Symbol.for("react.profiler"),R=Symbol.for("react.provider"),U=Symbol.for("react.context"),X=Symbol.for("react.forward_ref"),H=Symbol.for("react.suspense"),q=Symbol.for("react.suspense_list"),te=Symbol.for("react.memo"),J=Symbol.for("react.lazy"),ue=Symbol.for("react.offscreen"),V=Symbol.iterator;function fe(i){return i===null||typeof i!="object"?null:(i=V&&i[V]||i["@@iterator"],typeof i=="function"?i:null)}var ne=Object.assign,O;function re(i){if(O===void 0)try{throw Error()}catch(a){var s=a.stack.trim().match(/\n( *(at )?)/);O=s&&s[1]||""}return`
...
`)+`
`+v,y=["#define varying in",t.glslVersion===Sd?"":"layout(location = 0) out highp vec4 pc_fragColor;",t.glslVersion===Sd?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+y);const T=C+v+u,A=C+y+c,z=F_(o,o.VERTEX_SHADER,T),D=F_(o,o.FRAGMENT_SHADER,A);o.attachShader(M,z),o.attachShader(M,D),t.index0AttributeName!==void 0?o.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&o.bindAttribLocation(M,0,"position"),o.linkProgram(M);function N(U){if(n.debug.checkShaderErrors){const X=o.getProgramInfoLog(M).trim(),H=o.getShaderInfoLog(z).trim(),q=o.getShaderInfoLog(D).trim();let te=!0,J=!0;if(o.getProgramParameter(M,o.LINK_STATUS)===!1)if(te=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(o,M,z,D);else{const ue=O_(o,z,"vertex"),V=O_(o,D,"fragment");console.error("THREE.WebGLProgram: Shader Error "+o.getError()+" - VALIDATE_STATUS "+o.getProgramParameter(M,o.VALIDATE_STATUS)+`
...
void main() {
  ...
  #include <colorspace_fragment>
      ...
      #include <colorspace_fragment>
    }`}),h=new Zn(new Ss(1.045,48,32),c);t.add(h);const d=new cn,p=new Float32Array(900*3);for(let C=0;C<900;C++){const T=7+Math.random()*8,A=Math.random()*2-1,z=Math.random()*Math.PI*2,D=Math.sqrt(1-A*A);p[C*3]=T*D*Math.cos(z),p[C*3+1]=T*A,p[C*3+2]=T*D*Math.sin(z)}d.setAttribute("position",new Wt(p,3));const _=new fp(d,new cp({color:8231863,size:.012,transparent:!0,opacity:.42,depthWrite:!1}));n.add(_);let g=null,x=null,E=!1,M=null;const v=(C,T)=>{g||E||!C.terrain||(E=!0,new fx().load("/openflights/geo/terrain-4096.png",A=>{E=!1,A.colorSpace=Ei,A.wrapS=Fa,A.wrapT=ir,A.minFilter=rr,A.magFilter=Kn,A.generateMipmaps=!0,A.anisotropy=8,x=A,g=mP(C.terrain,A,{x:A.image.width,y:A.image.height}),M&&M.terrain&&(o.material=g),T?.()},void 0,()=>{E=!1}))};return{globeGroup:t,globe:o,grid:u,atmosphere:h,starsObj:_,starsGeo:d,applyTheme:(C,T)=>{M=C,C.terrain?g?o.material=g:v(C,T):o.material=r,l.color.set(C.grid.color),l.opacity=C.grid.opacity,c.uniforms.uColor.value.copy(C.atmosphere.color),c.uniforms.uStrength.value=C.atmosphere.strength,_.visible=C.stars},dispose(){x?.dispose(),g?.dispose(),r.dispose()}}}function _P(n,e,t,r,o,l){const u=new Float32Array(e.nodes.length*3),c=new Float32Array(e.nodes.length*3),h=new Float32Array(e.nodes.length),d=new Float32Array(e.nodes.length),p=new Float32Array(e.nodes.length),_=new Float32Array(e.nodes.length);for(let R=0;R<p.length;R++)p[R]=R;u.set(t.geo),e.nodes.forEach((R,U)=>{h[U]=4.2+Math.min(8,Math.sqrt(R.degree)*.72),d[U]=.88});const g=new cn;g.setAttribute("position",new Wt(u,3)),g.setAttribute("color",new Wt(c,3)),g.setAttribute("aSize",new Wt(h,1)),g.setAttribute("aAlpha",new Wt(d,1)),g.setAttribute("aIndex",new Wt(p,1)),g.setAttribute("aPickable",new Wt(_,1));const x=new Jn({transparent:!0,depthWrite:!1,vertexColors:!0,uniforms:{uPixelRatio:{value:r.getPixelRatio()}},vertexShader:"attribute float aSize;attribute float aAlpha;varying vec3 vColor;varying float vAlpha;void main(){vColor=color;vAlpha=aAlpha;vec4 mv=modelViewMatrix*vec4(position,1.);gl_PointSize=clamp(aSize*(260.0/-mv.z),2.0,18.0);gl_Position=projectionMatrix*mv;}",fragmentShader:`varying vec3 vColor;varying float vAlpha;void main(){float d=length(gl_PointCoord-.5);float a=smoothstep(.5,.25,d)*vAlpha;if(a<.015)discard;gl_FragColor=vec4(vColor,a);
      #include <colorspace_fragment>
    }`}),E=new fp(g,x);n.add(E);const M=e.nodes.reduce((R,U)=>U.degree>R.degree?U:R,e.nodes[0]),v=new Ss(1,24,16),y=new ox({roughness:.32,metalness:.2}),C=new Zn(v,y);C.visible=!1,n.add(C);let T=0,A=3.55;const z=(R,U,X,H)=>{if(!X){C.visible=!1;return}const{color:q,pixelSize:te}=I0(X,U,H);t.read(R.view,X.index,C.position),W=X.index,y.color.copy(q),y.emissive.copy(q).multiplyScalar(.32),T=te,A=R.view==="globe"?3.55:4.2,C.scale.setScalar(U0(T,o,l(),A)),C.visible=!0};let D=e.nodes.map((R,U)=>U),N=t.geo,W=-1;const L=(R,U,X,H)=>{D=[];const q=t.table(R.view);q!==N&&(u.set(q),g.attributes.position.needsUpdate=!0,N=q),e.nodes.forEach((te,J)=>{const ue=!R.country||te.country===R.country,V=te.degree>=R.minDegree,fe=ue&&V,{color:ne,pixelSize:O,isSelected:re,connected:be}=I0(te,U,H);let j=re?1:fe?.9:be?.75:eA;const le=te===X;le&&(j=0),c[J*3]=ne.r,c[J*3+1]=ne.g,c[J*3+2]=ne.b,d[J]=j,h[J]=O;const _e=re||be||fe||le;_[J]=_e?1:0,_e&&D.push(J)}),g.attributes.color.needsUpdate=!0,g.attributes.aAlpha.needsUpdate=!0,g.attributes.aSize.needsUpdate=!0,g.attributes.aPickable.needsUpdate=!0};return{points:E,topHubNode:M,geometry:g,material:x,heroMesh:C,get heroIndex(){return C.visible?W:-1},positions:u,get visibleIndices(){return D},update(R,U,X,H){L(R,U,X,H),z(R,U,X,H)},resize(){C.visible&&C.scale.setScalar(U0(T,o,l(),A))},dispose(){g.dispose(),x.dispose(),v.dispose(),y.dispose()}}}function vP(n,e,t){let r=null,o=null;const l=new K,u=new K,c=(_,g)=>{t.read(_,g.source.index,l),t.read(_,g.target.index,u)},h=_=>{_&&(n.remove(_),_.geometry.dispose(),_.material.dispose())},d=(_,g,x,E,M,v,y)=>{if(!_.length)return null;let C=0;for(const W of _)C+=g.view==="globe"?(c("globe",W),l.angleTo(u)>1.25?11:7):1;const T=new Float32Array(C*2*3),A=new Float32Array(C*2*3);let z=0;for(const W of _){const R=E&&(W.source===E||W.target===E)?x.route.selected:W.international?x.route.intl:x.route.domestic;if(g.view==="globe"){c("globe",W);const U=l.angleTo(u),X=U>1.25?11:7,H=.025+Math.min(.34,U*.18)+M;let q=N0(l,u,0,H);for(let te=1;te<=X;te++){const J=N0(l,u,te/X,H);T.set(q.toArray(),z),A.set(R.toArray(),z),z+=3,T.set(J.toArray(),z),A.set(R.toArray(),z),z+=3,q=J}}else c("topology",W),T.set(l.toArray(),z),A.set(R.toArray(),z),z+=3,T.set(u.toArray(),z),A.set(R.toArray(),z),z+=3}const D=new cn;D.setAttribute("position",new Wt(T,3)),D.setAttribute("color",new Wt(A,3));const N=new $c(D,new Ka({vertexColors:!0,transparent:!0,opacity:v,depthWrite:!1,blending:x.routeBlending}));return N.renderOrder=y,n.add(N),N};return{get objects(){return[r,o].filter(Boolean)},get object(){return r},update:(_,g,x)=>{h(r),h(o),r=o=null;const E=Math.ceil(e.links.length*_.density/100),M=[],v=[];let y=0;for(const A of e.links){if(y>=E)break;_.scope==="international"&&!A.international||_.scope==="domestic"&&A.international||_.country&&A.source.country!==_.country&&A.target.country!==_.country||A.source.degree<_.minDegree||A.target.degree<_.minDegree||(y++,g&&(A.source===g||A.target===g)?v.push(A):M.push(A))}const C=_.view==="globe"?"globe":"topology",T=v.length?x.routeContextOpacity[C]:x.routeOpacity[C];r=d(M,_,x,g,0,T,1),o=d(v,_,x,g,_.view==="globe"?.02:0,x.routeFocusOpacity,2)},dispose(){h(r),h(o),r=o=null}}}const xP=8,yP=["attribute float aSize;","attribute float aIndex;","attribute float aPickable;","varying vec3 vId;","void main() {","  if (aPickable < 0.5) {","    gl_Position = vec4(2.0, 2.0, 2.0, 1.0);","    gl_PointSize = 0.0;","    return;","  }","  float id = aIndex + 1.0;","  vId = vec3(","    floor(id / 65536.0),","    floor(mod(id, 65536.0) / 256.0),","    mod(id, 256.0)","  ) / 255.0;","  vec4 mv = modelViewMatrix * vec4(position, 1.0);","  gl_PointSize = clamp(aSize * (260.0 / -mv.z), 2.0, 18.0);","  gl_Position = projectionMatrix * mv;","}"].join(`
`),SP=["varying vec3 vId;","void main() {","  if (length(gl_PointCoord - 0.5) > 0.5) discard;","  gl_FragColor = vec4(vId, 1.0);","}"].join(`
`),k0=n=>new n.ShaderMaterial({uniforms:{uId:{value:new n.Vector3}},vertexShader:"void main(){gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0);}",fragmentShader:"uniform vec3 uId;void main(){gl_FragColor=vec4(uId,1.0);}"}),MP=(n,e)=>e.set(Math.floor(n/65536)/255,Math.floor(n/256)%256/255,n%256/255);function EP({renderer:n,scene:e,camera:t,data:r,sprites:o,world:l,routes:u,selectedRef:c,onHover:h,onSelect:d,onClear:p}){let _=0,g=null,x=!1,E=0,M=null,v=null;const y=new Jn({vertexShader:yP,fragmentShader:SP,transparent:!1,depthTest:!0,depthWrite:!0}),C=k0(t0),T=k0(t0),A=U=>{const X=Math.max(1,Math.round(xP*2*U)+1);X===E&&M||(M?.dispose(),E=X,M=new ur(E,E,{minFilter:An,magFilter:An,depthBuffer:!0}),M.texture.colorSpace=Ei,M.texture.generateMipmaps=!1,v=new Uint8Array(E*E*4))},z=(U,X)=>{const H=n.domElement,q=H.getBoundingClientRect();if(U<q.left||X<q.top||U>q.right||X>q.bottom)return null;const te=n.getPixelRatio();A(te);const J=Math.round(q.width*te),ue=Math.round(q.height*te),V=(U-q.left)*te,fe=(X-q.top)*te,ne=o.heroIndex,O=[],re=Ne=>{Ne&&(O.push([Ne,"visible",Ne.visible]),Ne.visible=!1)},be=(Ne,ft)=>{O.push([Ne,"material",Ne.material]),Ne.material=ft};re(l.starsObj),re(l.grid),re(l.atmosphere),u.objects.forEach(re),be(l.globe,C),be(o.points,y),ne>=0?(MP(ne+1,T.uniforms.uId.value),be(o.heroMesh,T)):re(o.heroMesh);const j=n.getRenderTarget(),le=n.getClearColor(new Ge),_e=n.getClearAlpha();t.setViewOffset(J,ue,Math.round(V)-(E>>1),Math.round(fe)-(E>>1),E,E),n.setRenderTarget(M),n.setClearColor(0,1),n.clear(),n.render(e,t),n.readRenderTargetPixels(M,0,0,E,E,v),t.clearViewOffset(),n.setRenderTarget(j),n.setClearColor(le,_e);for(let Ne=O.length-1;Ne>=0;Ne--){const[ft,k,_t]=O[Ne];ft[k]=_t}const ye=E>>1;let Ce=null,De=1/0;for(let Ne=0;Ne<E;Ne++)for(let ft=0;ft<E;ft++){const k=((E-1-Ne)*E+ft)*4,_t=v[k]<<16|v[k+1]<<8|v[k+2];if(!_t)continue;const ht=(ft-ye)*(ft-ye)+(Ne-ye)*(Ne-ye);ht<De&&(De=ht,Ce=_t-1)}return Ce!==null&&Ce<r.nodes.length?Ce:null},D=U=>{_||(_=requestAnimationFrame(()=>{if(_=0,c.current)return;const X=z(U.clientX,U.clientY);n.domElement.style.cursor=X===null?"grab":"pointer",h(X===null?null:r.nodes[X],X===null?null:{x:U.clientX,y:U.clientY})}))},N=U=>{g={x:U.clientX,y:U.clientY},x=!1},W=U=>{if(!g)return;const X=U.clientX-g.x,H=U.clientY-g.y;if(x=X*X+H*H>36,g=null,x)return;const q=z(U.clientX,U.clientY);q===null?p():d(r.nodes[q],{x:U.clientX,y:U.clientY})},L=()=>{_&&(cancelAnimationFrame(_),_=0),c.current||h(null,null)},R=n.domElement;return R.addEventListener("pointermove",D,{passive:!0}),R.addEventListener("pointerdown",N),R.addEventListener("pointerup",W),R.addEventListener("pointerleave",L),{pickAt:z,dispose(){_&&cancelAnimationFrame(_),R.removeEventListener("pointermove",D),R.removeEventListener("pointerdown",N),R.removeEventListener("pointerup",W),R.removeEventListener("pointerleave",L),M?.dispose(),y.dispose(),C.dispose(),T.dispose()}}}const z0=1.0025,wP=4,TP=2.6;function AP(n){const{scale:e,translate:t}=n.transform;return n.arcs.map(r=>{let o=0,l=0;return r.map(([u,c])=>(o+=u,l+=c,[o*e[0]+t[0],l*e[1]+t[1]]))})}function CP(n,e){const t=n.objects.countries||n.objects.land,r=[],o=l=>{const u=[];for(const c of l){const h=c<0?e[~c].slice().reverse():e[c];u.length?u.push(...h.slice(1)):u.push(...h)}return u};for(const l of t.geometries){const u=l.type==="Polygon"?[l.arcs]:l.type==="MultiPolygon"?l.arcs:[];for(const c of u)for(const h of c)r.push(o(h))}return r}function RP(n){const e=[],t=new K,r=new K;for(const l of n)for(let u=0;u<l.length-1;u++){const[c,h]=l[u],[d,p]=l[u+1];if(Math.abs(d-c)>180)continue;const _=Math.max(Math.abs(d-c),Math.abs(p-h)),g=Math.max(1,Math.ceil(_/wP));t.copy(Od(h,c,z0));for(let x=1;x<=g;x++){const E=x/g;r.copy(Od(h+(p-h)*E,c+(d-c)*E,z0)),e.push(t.x,t.y,t.z,r.x,r.y,r.z),t.copy(r)}}const o=new cn;return o.setAttribute("position",new Wt(new Float32Array(e),3)),o}function bP(n){const e=new Ka({color:2830392,transparent:!0,opacity:.5,depthWrite:!1}),t=new $c(new cn,e);t.visible=!1,t.renderOrder=0,n.add(t);const r={"110m":null,"50m":null},o={};let l=!1,u=null;const c=d=>{!r[d]||u===d||(t.geometry=r[d],u=d)},h=(d,p)=>{r[d]||o[d]||(o[d]=!0,fetch(`/openflights/geo/countries-${d}.json`).then(_=>_.ok?_.json():Promise.reject(new Error(_.status))).then(_=>{const g=AP(_);r[d]=RP(CP(_,g)),o[d]=!1,l&&(d!=="110m"||!r["50m"])&&(c(d),p?.())}).catch(()=>{o[d]=!1}))};return{object:t,setTheme(d,p){l=!!d.borders,t.visible=l,l&&(e.color.set(d.borders.color),e.opacity=d.borders.opacity,r["110m"]?c(r["50m"]?"50m":"110m"):h("110m",p))},updateDetail(d,p){l&&(d<=TP?r["50m"]?c("50m"):h("50m",p):r["110m"]&&c("110m"))},dispose(){e.dispose();for(const d of Object.keys(r))r[d]?.dispose();n.remove(t)}}}const ai={orange:"#e69f00",sky:"#56b4e9",green:"#009e73",blue:"#0072b2",vermillion:"#d55e00",purple:"#cc79a7"},_n=n=>new Ge(n),B0={dark:{fog:724242,fogDensity:.055,node:{hub:_n("#e69f00"),mid:_n("#56b4e9"),low:_n("#f3f4f6")},nodeSelected:_n(ai.orange),nodeConnected:_n(ai.purple),route:{intl:_n(ai.sky),domestic:_n(ai.green),selected:_n(ai.orange)},routeBlending:Gu,routeOpacity:{globe:.29,topology:.2},routeContextOpacity:{globe:.08,topology:.07},routeFocusOpacity:.95,globe:{color:1055270,emissive:462874,specular:2704476,shininess:22},grid:{color:3493992,opacity:.13},atmosphere:{color:new Ge("#389eeb"),strength:.26},stars:!0,terrain:!1,borders:null,lights:{hemiSky:10145778,hemiGround:659488,hemi:1.15,sun:1.4}},light:{fog:15659508,fogDensity:.03,node:{hub:_n(ai.vermillion),mid:_n(ai.blue),low:_n("#1c1f26")},nodeSelected:_n(ai.vermillion),nodeConnected:_n(ai.purple),route:{intl:_n(ai.blue),domestic:_n(ai.green),selected:_n(ai.vermillion)},routeBlending:Wr,routeOpacity:{globe:.26,topology:.22},routeContextOpacity:{globe:.09,topology:.08},routeFocusOpacity:.9,globe:{color:14673644,emissive:0,specular:2241348,shininess:4},grid:{color:4937059,opacity:.12},atmosphere:{color:new Ge("#5c8cb8"),strength:.16},stars:!1,terrain:{ocean:new Ge("#a9d3ee"),oceanDeep:new Ge("#7fbde4"),shore:new Ge("#cfe8f7"),land:[{at:0,color:new Ge("#5fae8d")},{at:.18,color:new Ge("#9ac68a")},{at:.38,color:new Ge("#f0e442")},{at:.58,color:new Ge("#e69f00")},{at:.78,color:new Ge("#d55e00")},{at:1,color:new Ge("#f4f1ec")}],relief:.55},borders:{color:2830392,opacity:.5,coastOpacity:.75},lights:{hemiSky:16777215,hemiGround:13227230,hemi:1.35,sun:.85}}},H0=n=>B0[n]||B0.dark;function PP({data:n,positions:e,options:t,sidebarOpen:r,selected:o,onHover:l,onSelect:u,onClear:c,focusRequest:h,topologyVersion:d}){const p=wt.useRef(),_=wt.useRef(),g=wt.useRef(o);return g.current=o,wt.useEffect(()=>{const x=p.current;if(!x||!n)return;let E=!1,M=0,v=performance.now(),y=[],C="globe",T=H0(t.theme);const A=new ix;A.fog=new Yc(T.fog,T.fogDensity);const z=new qn(42,1,.01,100);z.position.set(0,.3,3.55);const D=new nx({antialias:!0,alpha:!0,powerPreference:"high-performance"});D.setPixelRatio(Math.min(devicePixelRatio,1.75)),D.setSize(x.clientWidth,x.clientHeight,!1),D.outputColorSpace=li,D.domElement.tabIndex=0,D.domElement.setAttribute("role","img"),D.domElement.setAttribute("aria-label",`Interactive 3D flight network with ${sr.format(n.nodes.length)} airports and ${sr.format(n.links.length)} connections`),x.appendChild(D.domElement);const N=new eP(z,D.domElement);N.enableDamping=!0,N.dampingFactor=.065,N.enablePan=!1,N.minDistance=1.55,N.maxDistance=8,N.autoRotateSpeed=.32;const W=new hx(10145778,659488,1.15);A.add(W);const L=new dx(16777215,1.4);L.position.set(3,2,4),A.add(L);const R=()=>x.clientHeight||800,U=gP(A),X=bP(A),H=_P(A,n,e,D,z,R),q=vP(A,n,e),te=EP({renderer:D,scene:A,camera:z,data:n,sprites:H,world:U,routes:q,selectedRef:g,onHover:l,onSelect:u,onClear:c}),J=(j=C)=>{N.target.set(0,0,0),z.position.set(0,.3,j==="globe"?3.55:4.2),N.update()},ue=j=>{const le=e.read(C,j.index,new K);if(C==="globe"){const _e=le.clone().normalize().multiplyScalar(2.35),ye=z.position.clone(),Ce=N.target.clone(),De=performance.now(),Ne=n0?1:650,ft=k=>{const _t=Math.min(1,(k-De)/Ne),ht=1-Math.pow(1-_t,3);z.position.lerpVectors(ye,_e,ht),N.target.lerpVectors(Ce,le.clone().multiplyScalar(.18),ht),N.update(),_t<1&&requestAnimationFrame(ft)};requestAnimationFrame(ft)}else N.target.copy(le),z.position.set(le.x,le.y,le.z+2.4),N.update()},V=()=>{A.fog.color.set(T.fog),A.fog.density=T.fogDensity,W.color.set(T.lights.hemiSky),W.groundColor.set(T.lights.hemiGround),W.intensity=T.lights.hemi,L.intensity=T.lights.sun,U.applyTheme(T),X.setTheme(T),X.object.visible=!!T.borders&&C==="globe"},fe=(j,le)=>{C=j.view,T=H0(j.theme),V(),N.autoRotate=j.autoRotate&&!n0&&j.view==="globe";const _e=le||H.topHubNode;H.update(j,le,_e,T),q.update(j,le,T),U.globeGroup.visible=j.view==="globe",N.enablePan=j.view==="topology",N.minDistance=j.view==="globe"?1.55:1.2,N.maxDistance=j.view==="globe"?8:10},ne=()=>{const j=x.clientWidth,le=x.clientHeight;!j||!le||(z.aspect=j/le,z.updateProjectionMatrix(),D.setSize(j,le,!1),H.resize())};_.current={update:fe,focusNode:ue,resetCamera:J,resize:ne},fe(t,o);const O=new ResizeObserver(ne);O.observe(x),ne();const re=j=>{if(E)return;const le=j-v;v=j,y.push(le),y.length>90&&y.shift(),y.length===90&&D.getPixelRatio()>1&&_A(y)>24&&(D.setPixelRatio(1),H.material.uniforms.uPixelRatio.value=1,ne(),y=[]),N.update(),X.updateDetail(z.position.length()),D.render(A,z),M=requestAnimationFrame(re)};M=requestAnimationFrame(re);const be=j=>{j.key.toLowerCase()==="r"&&document.activeElement?.tagName!=="INPUT"&&J()};return window.addEventListener("keydown",be),()=>{E=!0,cancelAnimationFrame(M),O.disconnect(),window.removeEventListener("keydown",be),te.dispose(),X.dispose(),U.dispose(),N.dispose(),A.traverse(j=>{j.geometry?.dispose?.(),Array.isArray(j.material)?j.material.forEach(le=>le.dispose()):j.material?.dispose?.()}),D.dispose(),D.domElement.remove(),_.current=null}},[n]),wt.useEffect(()=>{_.current?.update(t,o)},[t,o,d]),wt.useEffect(()=>{h?.node&&_.current?.focusNode(h.node)},[h]),wt.useEffect(()=>{_.current?.resize()},[r]),se.jsx("div",{ref:p,className:"canvas-host"})}function LP(){return se.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:se.jsx("path",{d:"M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.39v-1.2h-2.5v8.37h2.5v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.5M6.88 8.56a1.68 1.68 0 1 1 0-3.36 1.68 1.68 0 0 1 0 3.36m-1.2 10.12h2.5V9.9h-2.5v8.78z"})})}function DP(){return se.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:se.jsx("path",{d:"M12 2C6.477 2 2 6.477 2 12c0 4.42 2.865 8.17 6.839 9.49.5.092.682-.217.682-.482 0-.237-.008-.868-.013-1.703-2.782.603-3.369-1.343-3.369-1.343-.454-1.156-1.11-1.463-1.11-1.463-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.891 1.529 2.341 1.544 2.914 1.182.092-.92.349-1.544.636-1.9-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.578 9.578 0 0 1 12 6.836c.85.004 1.705.114 2.504.336 1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48C19.139 20.167 22 16.418 22 12c0-5.523-4.477-10-10-10z"})})}function NP({data:n,options:e,setOptions:t,query:r,setQuery:o,selected:l,selectNode:u,clearSelection:c,open:h}){const d=wt.useMemo(()=>{const p=r.trim().toLowerCase();return p?n.nodes.filter(_=>`${_.id} ${_.name} ${_.city} ${_.country}`.toLowerCase().includes(p)).sort((_,g)=>g.degree-_.degree).slice(0,8):[]},[n,r]);return se.jsxs("aside",{id:"controls",className:`sidebar ${h?"open":""}`,"aria-label":"Network controls",children:[se.jsxs("section",{className:"section",children:[se.jsxs("div",{className:"section-title",children:[se.jsx("span",{children:"Find an airport"}),se.jsx("span",{className:"value-pill",children:sr.format(n.nodes.length)})]}),se.jsxs("div",{className:"search-wrap",children:[se.jsx("input",{id:"airport-search",className:"search",value:r,onInput:p=>o(p.target.value),placeholder:"Code, city, airport…","aria-label":"Search airports",autoComplete:"off"}),se.jsx("span",{className:"search-icon",children:"⌕"})]}),d.length>0&&se.jsx("div",{className:"results",role:"listbox",children:d.map(p=>se.jsxs("button",{className:"result-btn",role:"option",onClick:()=>{u(p),o("")},children:[se.jsx("span",{className:"result-name",children:p.name}),se.jsx("span",{className:"result-code",children:p.iata||p.icao})]},p.id))}),l&&se.jsxs("div",{className:"selected-chip",children:[se.jsxs("div",{children:[se.jsx("strong",{children:l.name}),se.jsxs("span",{children:[l.city,", ",l.country]})]}),se.jsx("button",{className:"clear-btn",onClick:c,"aria-label":"Clear selected airport",children:"×"})]})]}),se.jsxs("section",{className:"section",children:[se.jsx("div",{className:"section-title",children:se.jsx("span",{children:"View"})}),se.jsxs("div",{className:"segmented",role:"group","aria-label":"Visualization mode",children:[se.jsx("button",{className:`seg-btn ${e.view==="globe"?"active":""}`,"aria-pressed":e.view==="globe",onClick:()=>t(p=>({...p,view:"globe"})),children:"3D globe"}),se.jsx("button",{className:`seg-btn ${e.view==="topology"?"active":""}`,"aria-pressed":e.view==="topology",onClick:()=>t(p=>({...p,view:"topology"})),children:"Topology"})]}),se.jsxs("div",{className:"segmented",role:"group","aria-label":"Colour theme",style:{marginTop:"8px"},children:[se.jsx("button",{className:`seg-btn ${e.theme==="dark"?"active":""}`,"aria-pressed":e.theme==="dark",onClick:()=>t(p=>({...p,theme:"dark"})),children:"Dark"}),se.jsx("button",{className:`seg-btn ${e.theme==="light"?"active":""}`,"aria-pressed":e.theme==="light",onClick:()=>t(p=>({...p,theme:"light"})),children:"Light map"})]}),se.jsxs("label",{className:"check-row",children:[se.jsx("input",{type:"checkbox",checked:e.autoRotate,onChange:p=>t(_=>({..._,autoRotate:p.target.checked}))}),"Auto-rotate globe"]})]}),se.jsxs("section",{className:"section",children:[se.jsxs("div",{className:"section-title",children:[se.jsx("span",{children:"Route filters"}),se.jsxs("span",{className:"value-pill",children:[e.density,"%"]})]}),se.jsxs("div",{className:"control-row",children:[se.jsxs("div",{className:"control-label",children:[se.jsx("span",{children:"Route density"}),se.jsxs("span",{children:[e.density,"%"]})]}),se.jsx("input",{type:"range",min:"5",max:"100",step:"5",value:e.density,"aria-label":"Route density: adjust from 5% to 100%",onInput:p=>t(_=>({..._,density:+p.target.value}))})]}),se.jsxs("div",{className:"control-row",children:[se.jsxs("div",{className:"control-label",children:[se.jsx("span",{children:"Minimum hub degree"}),se.jsx("span",{children:e.minDegree})]}),se.jsx("input",{type:"range",min:"0",max:"80",step:"1",value:e.minDegree,"aria-label":"Minimum hub degree: adjust from 0 to 80 connections",onInput:p=>t(_=>({..._,minDegree:+p.target.value}))})]}),se.jsxs("div",{className:"control-row",children:[se.jsx("label",{className:"control-label",htmlFor:"scope",children:se.jsx("span",{children:"Route scope"})}),se.jsxs("select",{id:"scope",value:e.scope,onChange:p=>t(_=>({..._,scope:p.target.value})),children:[se.jsx("option",{value:"all",children:"All routes"}),se.jsx("option",{value:"international",children:"International only"}),se.jsx("option",{value:"domestic",children:"Domestic only"})]})]}),se.jsxs("div",{className:"control-row",children:[se.jsx("label",{className:"control-label",htmlFor:"country",children:se.jsx("span",{children:"Country focus"})}),se.jsxs("select",{id:"country",value:e.country,onChange:p=>t(_=>({..._,country:p.target.value})),children:[se.jsx("option",{value:"",children:"All countries"}),n.countries.map(([p,_])=>se.jsxs("option",{value:p,children:[p," (",_,")"]},p))]})]})]}),se.jsxs("section",{className:"section",children:[se.jsx("div",{className:"section-title",children:se.jsx("span",{children:"Legend"})}),se.jsxs("div",{className:"legend",children:[se.jsxs("div",{className:"legend-row",children:[se.jsx("span",{className:"swatch",style:{background:"#56b4e9"}}),se.jsx("span",{children:"International connection"})]}),se.jsxs("div",{className:"legend-row",children:[se.jsx("span",{className:"swatch",style:{background:"#009e73"}}),se.jsx("span",{children:"Domestic connection"})]}),se.jsxs("div",{className:"legend-row",children:[se.jsx("span",{className:"swatch",style:{background:"#e69f00"}}),se.jsx("span",{children:"Selected-airport connection"})]})]})]}),se.jsxs("section",{className:"section help",children:["Drag to orbit · scroll to zoom · click an airport to pin.",se.jsx("br",{}),se.jsx("br",{}),se.jsx("kbd",{children:"/"})," Search   ",se.jsx("kbd",{children:"Esc"})," Clear selection  ",se.jsx("kbd",{children:"R"})," Reset camera"]}),se.jsxs("footer",{className:"sidebar-footer",children:[se.jsxs("div",{className:"social-links",children:[se.jsx("a",{href:"https://www.linkedin.com/in/jeremiahjking/",className:"social-btn",target:"_blank",rel:"noreferrer","aria-label":"LinkedIn",children:se.jsx(LP,{})}),se.jsx("a",{href:"https://github.com/unguisdraconis",className:"social-btn",target:"_blank",rel:"noreferrer","aria-label":"GitHub",children:se.jsx(DP,{})})]}),se.jsx("p",{className:"data-source",children:"© 2026 Jeremiah King"}),se.jsxs("p",{className:"data-source",children:["Data from","",se.jsx("a",{href:"https://openflights.org",target:"_blank",rel:"noreferrer",children:"OpenFlights.org"})]})]})]})}function IP({node:n,pinned:e,point:t}){if(!n||!t)return null;const r=295,o=18,l=t.x+o,c=l+r<=innerWidth?l:Math.max(0,t.x-r-o),h=Math.max(12,Math.min(t.y-20,innerHeight-190));return se.jsxs("div",{className:`tooltip ${e?"pinned":""}`,style:{left:c,top:h},role:e?"dialog":"status","aria-label":`${n.name} airport details`,children:[se.jsxs("div",{className:"tooltip-top",children:[se.jsx("div",{className:"airport-code",children:n.iata||n.icao||"—"}),se.jsxs("div",{children:[se.jsx("h2",{children:n.name}),se.jsxs("div",{className:"tooltip-sub",children:[n.city,", ",n.country]})]})]}),se.jsxs("div",{className:"tooltip-grid",children:[se.jsxs("div",{className:"tooltip-metric",children:[se.jsx("b",{children:sr.format(n.degree)}),se.jsx("span",{children:"Connections"})]}),se.jsxs("div",{className:"tooltip-metric",children:[se.jsx("b",{children:sr.format(n.routeCount)}),se.jsx("span",{children:"Route records"})]}),se.jsxs("div",{className:"tooltip-metric",children:[se.jsxs("b",{children:[n.lat.toFixed(1),"°, ",n.lon.toFixed(1),"°"]}),se.jsx("span",{children:"Coordinates"})]})]}),se.jsx("div",{className:"tooltip-note",children:e?"Pinned — click empty space or press Escape to close.":"Click to pin this airport."})]})}function UP({onLoaded:n,loading:e,error:t}){const r=wt.useRef(),o=async l=>{const u=[...l],c=u.find(d=>/airport/i.test(d.name)),h=u.find(d=>/route/i.test(d.name));if(!c||!h)return n(null,null,"Select both airports.dat and routes.dat.");n(await c.text(),await h.text())};return se.jsx("div",{className:"load-screen",onDragOver:l=>l.preventDefault(),onDrop:l=>{l.preventDefault(),o(l.dataTransfer.files)},children:se.jsxs("div",{className:"load-card",children:[se.jsx("div",{className:"eyebrow",children:"OpenFlights data loader"}),se.jsx("h2",{children:e?"Loading the global aviation network…":"Load the global aviation network"}),e?se.jsx("p",{role:"status","aria-live":"polite",children:"Fetching and parsing the airport and route data. This usually takes a few seconds."}):se.jsxs("p",{children:["The dashboard first looks for ",se.jsx("b",{children:"airports.dat"})," and"," ",se.jsx("b",{children:"routes.dat"})," beside this HTML file. If your browser blocks local file requests, select or drop both supplied files here."]}),se.jsx("div",{className:"drop-zone",children:se.jsxs("div",{children:[se.jsx("button",{className:"primary-btn",onClick:()=>r.current.click(),disabled:e,children:e?"Building network…":"Choose both data files"}),se.jsx("input",{ref:r,className:"sr-only",type:"file",multiple:!0,accept:".txt,.dat,text/plain",onChange:l=>o(l.target.files)}),se.jsx("div",{className:"file-note",children:"You can also drag and drop both files onto this panel."})]})}),e&&se.jsx("div",{className:"loading-bar","aria-hidden":"true"}),t&&se.jsx("div",{className:"error",role:"alert",children:t})]})})}function Fu({value:n,label:e}){return se.jsxs("div",{className:"stat",children:[se.jsx("div",{className:"stat-value",children:n}),se.jsx("div",{className:"stat-label",children:e})]})}const FP="(min-width: 681px)",V0=()=>typeof window>"u"||!window.matchMedia?!0:window.matchMedia(FP).matches,OP=()=>{if(typeof window>"u")return"dark";try{const n=localStorage.getItem("openflights-theme");if(n==="light"||n==="dark")return n}catch{}return window.matchMedia?.("(prefers-color-scheme: light)").matches?"light":"dark"};function kP(){const[n,e]=wt.useState(null),[t,r]=wt.useState(!0),[o,l]=wt.useState(""),[u,c]=wt.useState({view:"globe",density:55,minDegree:0,scope:"all",country:"",autoRotate:!1,theme:OP()}),[h,d]=wt.useState(""),[p,_]=wt.useState(null),[g,x]=wt.useState(null),[E,M]=wt.useState(null),[v,y]=wt.useState(null),[C,T]=wt.useState(V0),[A,z]=wt.useState(0),D=wt.useCallback(()=>z(H=>H+1),[]),N=wt.useMemo(()=>n?W2(n.nodes):null,[n]);Q2(n,N,D);const W=wt.useCallback((H,q,te)=>{if(te){l(te),r(!1);return}r(!0),l(""),setTimeout(()=>{try{const J=V2(H,q);if(!J.nodes.length||!J.links.length)throw new Error("No usable airport-route pairs were found.");e(J)}catch(J){l(`Could not parse the files: ${J.message}`)}finally{r(!1)}},30)},[]);wt.useEffect(()=>{let H=!1;const q=new AbortController;return Z2({signal:q.signal}).then(({airports:te,routes:J,source:ue})=>{H||(ue!=="local"&&console.info(`OpenFlights data loaded from ${ue}.`),W(te,J))}).catch(te=>{H||q.signal.aborted||W(null,null,`Could not load the flight data (${te.message}). Select or drop airports.dat and routes.dat below.`)}),()=>{H=!0,q.abort()}},[W]),wt.useEffect(()=>{const H=document.documentElement;H.dataset.themeSwitching="",H.dataset.theme=u.theme;let q=!1;const te=()=>{q||(q=!0,delete H.dataset.themeSwitching)},J=requestAnimationFrame(()=>requestAnimationFrame(te)),ue=setTimeout(te,300);try{localStorage.setItem("openflights-theme",u.theme)}catch{}return()=>{cancelAnimationFrame(J),clearTimeout(ue),te()}},[u.theme]),wt.useEffect(()=>{const H=window.matchMedia?.("(prefers-color-scheme: light)");if(!H)return;const q=te=>{let J=null;try{J=localStorage.getItem("openflights-theme")}catch{J=null}J||c(ue=>({...ue,theme:te.matches?"light":"dark"}))};return H.addEventListener("change",q),()=>H.removeEventListener("change",q)},[]),wt.useEffect(()=>{const H=q=>{q.key==="/"&&document.activeElement?.tagName!=="INPUT"&&(q.preventDefault(),document.getElementById("airport-search")?.focus()),q.key==="Escape"&&(_(null),x(null),M(null))};return window.addEventListener("keydown",H),()=>window.removeEventListener("keydown",H)},[]);const L=(H,q)=>{_(H),x(null),M(q||{x:innerWidth*.56,y:innerHeight*.3}),y({node:H,id:performance.now()}),V0()||T(!1)},R=()=>{_(null),x(null),M(null)},U=p||g,X=wt.useMemo(()=>n?n.links.filter(H=>(u.scope==="all"||u.scope==="international"===H.international)&&(!u.country||H.source.country===u.country||H.target.country===u.country)&&H.source.degree>=u.minDegree&&H.target.degree>=u.minDegree).length:0,[n,u.scope,u.country,u.minDegree]);return se.jsxs("div",{className:`app ${C?"":"sidebar-collapsed"}`,children:[se.jsxs("header",{className:"topbar",children:[se.jsx("button",{className:"icon-btn menu-btn",onClick:()=>T(H=>!H),"aria-label":C?"Hide controls":"Show controls","aria-expanded":C,"aria-controls":"controls",title:C?"Hide controls":"Show controls",children:"☰"}),se.jsxs("div",{className:"brand",children:[se.jsx("div",{className:"eyebrow",children:"Global aviation intelligence"}),se.jsx("h1",{children:"OpenFlights Network"})]}),n&&se.jsxs("div",{className:"stats","aria-label":"Network summary",children:[se.jsx(Fu,{value:sr.format(n.nodes.length),label:"Airports"}),se.jsx(Fu,{value:sr.format(n.links.length),label:"Connections"}),se.jsx(Fu,{value:sr.format(X),label:"Visible pool"}),se.jsx(Fu,{value:sr.format(n.countries.length),label:"Countries"})]}),se.jsx("div",{className:"top-actions",children:se.jsx("button",{className:"icon-btn desktop-only",onClick:()=>c(H=>({...H,autoRotate:!H.autoRotate})),"aria-label":"Toggle automatic rotation","aria-pressed":u.autoRotate,children:"◌"})})]}),se.jsxs("main",{className:"main",children:[n&&se.jsx(NP,{data:n,options:u,setOptions:c,query:h,setQuery:d,selected:p,selectNode:L,clearSelection:R,open:C}),se.jsxs("section",{className:"stage","aria-label":"3D flight visualization",children:[n&&se.jsx(PP,{data:n,positions:N,sidebarOpen:C,options:u,selected:p,topologyVersion:A,focusRequest:v,onHover:(H,q)=>{x(H),M(q)},onSelect:L,onClear:R}),n&&se.jsxs("div",{className:"stage-badge",children:[se.jsx("span",{className:"dot"}),se.jsxs("span",{children:[u.view==="globe"?"GEOGRAPHIC GLOBE":"FORCE-DIRECTED TOPOLOGY"," ","· ",u.density,"% ROUTES"]})]}),se.jsx(IP,{node:U,pinned:!!p,point:E}),!n&&se.jsx(UP,{onLoaded:W,loading:t,error:o}),se.jsx("div",{className:"sr-only","aria-live":"polite",children:U?`${U.name}, ${U.city}, ${U.country}. ${U.degree} direct connections.`:""})]})]})]})}US.createRoot(document.getElementById("root")).render(se.jsx(bS.StrictMode,{children:se.jsx(kP,{})}));
