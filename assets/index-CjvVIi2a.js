...
`)+`
`+v);const T=A+x+u,C=A+v+c,z=F_(o,o.VERTEX_SHADER,T),D=F_(o,o.FRAGMENT_SHADER,C);o.attachShader(M,z),o.attachShader(M,D),t.index0AttributeName!==void 0?o.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&o.bindAttribLocation(M,0,"position"),o.linkProgram(M);function N(U){if(n.debug.checkShaderErrors){const G=o.getProgramInfoLog(M).trim(),q=o.getShaderInfoLog(z).trim(),J=o.getShaderInfoLog(D).trim();let ce=!0,Y=!0;if(o.getProgramParameter(M,o.LINK_STATUS)===!1)if(ce=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(o,M,z,D);else{const ne=O_(o,z,"vertex"),B=O_(o,D,"fragment");console.error("THREE.WebGLProgram: Shader Error "+o.getError()+" - VALIDATE_STATUS "+o.getProgramParameter(M,o.VALIDATE_STATUS)+`
...
Program Info Log: `+G+`
`+ne+`
`+B)}else G!==""?console.warn("THREE.WebGLProgram: Program Info Log:",G):(q===""||J==="")&&(Y=!1);Y&&(U.diagnostics={runnable:ce,programLog:G,vertexShader:{log:q,prefix:x},fragmentShader:{log:J,prefix:v}})}o.deleteShader(z),o.deleteShader(D),W=new ku(o,M),L=hT(o,M)}let W;this.getUniforms=function(){return W===void 0&&N(this),W};let L;this.getAttributes=function(){return L===void 0&&N(this),L};let R=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return R===!1&&(R=o.getProgramParameter(M,iT)),R},this.destroy=function(){r.releaseStatesOfProgram(this),o.deleteProgram(M),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=rT++,this.cacheKey=e,this.usedTimes=1,this.program=M,this.vertexShader=z,this.fragmentShader=D,this}let wT=0;class TT{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,r=e.fragmentShader,o=this._getShaderStage(t),l=this._getShaderStage(r),u=this._getShaderCacheForMaterial(e);return u.has(o)===!1&&(u.add(o),o.usedTimes++),u.has(l)===!1&&(u.add(l),l.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const r of t)r.usedTimes--,r.usedTimes===0&&this.shaderCache.delete(r.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let r=t.get(e);return r===void 0&&(r=new Set,t.set(e,r)),r}_getShaderStage(e){const t=this.shaderCache;let r=t.get(e);return r===void 0&&(r=new AT(e),t.set(e,r)),r}}class AT{constructor(e){this.id=wT++,this.code=e,this.usedTimes=0}}function CT(n,e,t,r,o,l,u){const c=new tp,h=new TT,d=new Set,p=[],m=o.logarithmicDepthBuffer,_=o.vertexTextures;let y=o.precision;const E={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function M(L){return d.add(L),L===0?"uv":`uv${L}`}function x(L,R,U,G,q){const J=G.fog,ce=q.geometry,Y=L.isMeshStandardMaterial?G.environment:null,ne=(L.isMeshStandardMaterial?t:e).get(L.envMap||Y),B=ne&&ne.mapping===ja?ne.image.height:null,le=E[L.type];L.precision!==null&&(y=o.getMaxPrecision(L.precision),y!==L.precision&&console.warn("THREE.WebGLProgram.getParameters:",L.precision,"not supported, using",y,"instead."));const ee=ce.morphAttributes.position||ce.morphAttributes.normal||ce.morphAttributes.color,O=ee!==void 0?ee.length:0;let se=0;ce.morphAttributes.position!==void 0&&(se=1),ce.morphAttributes.normal!==void 0&&(se=2),ce.morphAttributes.color!==void 0&&(se=3);let be,X,ue,_e;if(le){const vt=Si[le];be=vt.vertexShader,X=vt.fragmentShader}else be=L.vertexShader,X=L.fragmentShader,h.update(L),ue=h.getVertexShaderID(L),_e=h.getFragmentShaderID(L);const ye=n.getRenderTarget(),Ce=q.isInstancedMesh===!0,De=q.isBatchedMesh===!0,Ne=!!L.map,ft=!!L.matcap,k=!!ne,_t=!!L.aoMap,ht=!!L.lightMap,Et=!!L.bumpMap,Ye=!!L.normalMap,Ut=!!L.displacementMap,tt=!!L.emissiveMap,rt=!!L.metalnessMap,F=!!L.roughnessMap,b=L.anisotropy>0,fe=L.clearcoat>0,pe=L.dispersion>0,ve=L.iridescence>0,me=L.sheen>0,$e=L.transmission>0,Pe=b&&!!L.anisotropyMap,Oe=fe&&!!L.clearcoatMap,ot=fe&&!!L.clearcoatNormalMap,Me=fe&&!!L.clearcoatRoughnessMap,Ie=ve&&!!L.iridescenceMap,pt=ve&&!!L.iridescenceThicknessMap,et=me&&!!L.sheenColorMap,ke=me&&!!L.sheenRoughnessMap,st=!!L.specularMap,at=!!L.specularColorMap,Rt=!!L.specularIntensityMap,j=$e&&!!L.transmissionMap,we=$e&&!!L.thicknessMap,he=!!L.gradientMap,de=!!L.alphaMap,Ae=L.alphaTest>0,Ze=!!L.alphaHash,mt=!!L.extensions;let zt=ar;L.toneMapped&&(ye===null||ye.isXRRenderTarget===!0)&&(zt=n.toneMapping);const Xt={shaderID:le,shaderType:L.type,shaderName:L.name,vertexShader:be,fragmentShader:X,defines:L.defines,customVertexShaderID:ue,customFragmentShaderID:_e,isRawShaderMaterial:L.isRawShaderMaterial===!0,glslVersion:L.glslVersion,precision:y,batching:De,batchingColor:De&&q._colorsTexture!==null,instancing:Ce,instancingColor:Ce&&q.instanceColor!==null,instancingMorph:Ce&&q.morphTexture!==null,supportsVertexTextures:_,outputColorSpace:ye===null?n.outputColorSpace:ye.isXRRenderTarget===!0?ye.texture.colorSpace:fr,alphaToCoverage:!!L.alphaToCoverage,map:Ne,matcap:ft,envMap:k,envMapMode:k&&ne.mapping,envMapCubeUVHeight:B,aoMap:_t,lightMap:ht,bumpMap:Et,normalMap:Ye,displacementMap:_&&Ut,emissiveMap:tt,normalMapObjectSpace:Ye&&L.normalMapType===bv,normalMapTangentSpace:Ye&&L.normalMapType===Vc,metalnessMap:rt,roughnessMap:F,anisotropy:b,anisotropyMap:Pe,clearcoat:fe,clearcoatMap:Oe,clearcoatNormalMap:ot,clearcoatRoughnessMap:Me,dispersion:pe,iridescence:ve,iridescenceMap:Ie,iridescenceThicknessMap:pt,sheen:me,sheenColorMap:et,sheenRoughnessMap:ke,specularMap:st,specularColorMap:at,specularIntensityMap:Rt,transmission:$e,transmissionMap:j,thicknessMap:we,gradientMap:he,opaque:L.transparent===!1&&L.blending===Wr&&L.alphaToCoverage===!1,alphaMap:de,alphaTest:Ae,alphaHash:Ze,combine:L.combine,mapUv:Ne&&M(L.map.channel),aoMapUv:_t&&M(L.aoMap.channel),lightMapUv:ht&&M(L.lightMap.channel),bumpMapUv:Et&&M(L.bumpMap.channel),normalMapUv:Ye&&M(L.normalMap.channel),displacementMapUv:Ut&&M(L.displacementMap.channel),emissiveMapUv:tt&&M(L.emissiveMap.channel),metalnessMapUv:rt&&M(L.metalnessMap.channel),roughnessMapUv:F&&M(L.roughnessMap.channel),anisotropyMapUv:Pe&&M(L.anisotropyMap.channel),clearcoatMapUv:Oe&&M(L.clearcoatMap.channel),clearcoatNormalMapUv:ot&&M(L.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Me&&M(L.clearcoatRoughnessMap.channel),iridescenceMapUv:Ie&&M(L.iridescenceMap.channel),iridescenceThicknessMapUv:pt&&M(L.iridescenceThicknessMap.channel),sheenColorMapUv:et&&M(L.sheenColorMap.channel),sheenRoughnessMapUv:ke&&M(L.sheenRoughnessMap.channel),specularMapUv:st&&M(L.specularMap.channel),specularColorMapUv:at&&M(L.specularColorMap.channel),specularIntensityMapUv:Rt&&M(L.specularIntensityMap.channel),transmissionMapUv:j&&M(L.transmissionMap.channel),thicknessMapUv:we&&M(L.thicknessMap.channel),alphaMapUv:de&&M(L.alphaMap.channel),vertexTangents:!!ce.attributes.tangent&&(Ye||b),vertexColors:L.vertexColors,vertexAlphas:L.vertexColors===!0&&!!ce.attributes.color&&ce.attributes.color.itemSize===4,pointsUvs:q.isPoints===!0&&!!ce.attributes.uv&&(Ne||de),fog:!!J,useFog:L.fog===!0,fogExp2:!!J&&J.isFogExp2,flatShading:L.flatShading===!0,sizeAttenuation:L.sizeAttenuation===!0,logarithmicDepthBuffer:m,skinning:q.isSkinnedMesh===!0,morphTargets:ce.morphAttributes.position!==void 0,morphNormals:ce.morphAttributes.normal!==void 0,morphColors:ce.morphAttributes.color!==void 0,morphTargetsCount:O,morphTextureStride:se,numDirLights:R.directional.length,numPointLights:R.point.length,numSpotLights:R.spot.length,numSpotLightMaps:R.spotLightMap.length,numRectAreaLights:R.rectArea.length,numHemiLights:R.hemi.length,numDirLightShadows:R.directionalShadowMap.length,numPointLightShadows:R.pointShadowMap.length,numSpotLightShadows:R.spotShadowMap.length,numSpotLightShadowsWithMaps:R.numSpotLightShadowsWithMaps,numLightProbes:R.numLightProbes,numClippingPlanes:u.numPlanes,numClipIntersection:u.numIntersection,dithering:L.dithering,shadowMapEnabled:n.shadowMap.enabled&&U.length>0,shadowMapType:n.shadowMap.type,toneMapping:zt,decodeVideoTexture:Ne&&L.map.isVideoTexture===!0&&wt.getTransfer(L.map.colorSpace)===Lt,premultipliedAlpha:L.premultipliedAlpha,doubleSided:L.side===Ni,flipSided:L.side===xn,useDepthPacking:L.depthPacking>=0,depthPacking:L.depthPacking||0,index0AttributeName:L.index0AttributeName,extensionClipCullDistance:mt&&L.extensions.clipCullDistance===!0&&r.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(mt&&L.extensions.multiDraw===!0||De)&&r.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:r.has("KHR_parallel_shader_compile"),customProgramCacheKey:L.customProgramCacheKey()};return Xt.vertexUv1s=d.has(1),Xt.vertexUv2s=d.has(2),Xt.vertexUv3s=d.has(3),d.clear(),Xt}function v(L){const R=[];if(L.shaderID?R.push(L.shaderID):(R.push(L.customVertexShaderID),R.push(L.customFragmentShaderID)),L.defines!==void 0)for(const U in L.defines)R.push(U),R.push(L.defines[U]);return L.isRawShaderMaterial===!1&&(A(R,L),T(R,L),R.push(n.outputColorSpace)),R.push(L.customProgramCacheKey),R.join()}function A(L,R){L.push(R.precision),L.push(R.outputColorSpace),L.push(R.envMapMode),L.push(R.envMapCubeUVHeight),L.push(R.mapUv),L.push(R.alphaMapUv),L.push(R.lightMapUv),L.push(R.aoMapUv),L.push(R.bumpMapUv),L.push(R.normalMapUv),L.push(R.displacementMapUv),L.push(R.emissiveMapUv),L.push(R.metalnessMapUv),L.push(R.roughnessMapUv),L.push(R.anisotropyMapUv),L.push(R.clearcoatMapUv),L.push(R.clearcoatNormalMapUv),L.push(R.clearcoatRoughnessMapUv),L.push(R.iridescenceMapUv),L.push(R.iridescenceThicknessMapUv),L.push(R.sheenColorMapUv),L.push(R.sheenRoughnessMapUv),L.push(R.specularMapUv),L.push(R.specularColorMapUv),L.push(R.specularIntensityMapUv),L.push(R.transmissionMapUv),L.push(R.thicknessMapUv),L.push(R.combine),L.push(R.fogExp2),L.push(R.sizeAttenuation),L.push(R.morphTargetsCount),L.push(R.morphAttributeCount),L.push(R.numDirLights),L.push(R.numPointLights),L.push(R.numSpotLights),L.push(R.numSpotLightMaps),L.push(R.numHemiLights),L.push(R.numRectAreaLights),L.push(R.numDirLightShadows),L.push(R.numPointLightShadows),L.push(R.numSpotLightShadows),L.push(R.numSpotLightShadowsWithMaps),L.push(R.numLightProbes),L.push(R.shadowMapType),L.push(R.toneMapping),L.push(R.numClippingPlanes),L.push(R.numClipIntersection),L.push(R.depthPacking)}function T(L,R){c.disableAll(),R.supportsVertexTextures&&c.enable(0),R.instancing&&c.enable(1),R.instancingColor&&c.enable(2),R.instancingMorph&&c.enable(3),R.matcap&&c.enable(4),R.envMap&&c.enable(5),R.normalMapObjectSpace&&c.enable(6),R.normalMapTangentSpace&&c.enable(7),R.clearcoat&&c.enable(8),R.iridescence&&c.enable(9),R.alphaTest&&c.enable(10),R.vertexColors&&c.enable(11),R.vertexAlphas&&c.enable(12),R.vertexUv1s&&c.enable(13),R.vertexUv2s&&c.enable(14),R.vertexUv3s&&c.enable(15),R.vertexTangents&&c.enable(16),R.anisotropy&&c.enable(17),R.alphaHash&&c.enable(18),R.batching&&c.enable(19),R.dispersion&&c.enable(20),R.batchingColor&&c.enable(21),L.push(c.mask),c.disableAll(),R.fog&&c.enable(0),R.useFog&&c.enable(1),R.flatShading&&c.enable(2),R.logarithmicDepthBuffer&&c.enable(3),R.skinning&&c.enable(4),R.morphTargets&&c.enable(5),R.morphNormals&&c.enable(6),R.morphColors&&c.enable(7),R.premultipliedAlpha&&c.enable(8),R.shadowMapEnabled&&c.enable(9),R.doubleSided&&c.enable(10),R.flipSided&&c.enable(11),R.useDepthPacking&&c.enable(12),R.dithering&&c.enable(13),R.transmission&&c.enable(14),R.sheen&&c.enable(15),R.opaque&&c.enable(16),R.pointsUvs&&c.enable(17),R.decodeVideoTexture&&c.enable(18),R.alphaToCoverage&&c.enable(19),L.push(c.mask)}function C(L){const R=E[L.type];let U;if(R){const G=Si[R];U=Wv.clone(G.uniforms)}else U=L.uniforms;return U}function z(L,R){let U;for(let G=0,q=p.length;G<q;G++){const J=p[G];if(J.cacheKey===R){U=J,++U.usedTimes;break}}return U===void 0&&(U=new ET(n,R,L,l),p.push(U)),U}function D(L){if(--L.usedTimes===0){const R=p.indexOf(L);p[R]=p[p.length-1],p.pop(),L.destroy()}}function N(L){h.remove(L)}function W(){h.dispose()}return{getParameters:x,getProgramCacheKey:v,getUniforms:C,acquireProgram:z,releaseProgram:D,releaseShaderCache:N,programs:p,dispose:W}}function RT(){let n=new WeakMap;function e(u){return n.has(u)}function t(u){let c=n.get(u);return c===void 0&&(c={},n.set(u,c)),c}function r(u){n.delete(u)}function o(u,c,h){n.get(u)[c]=h}function l(){n=new WeakMap}return{has:e,get:t,remove:r,update:o,dispose:l}}function bT(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.z!==e.z?n.z-e.z:n.id-e.id}function V_(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function G_(){const n=[];let e=0;const t=[],r=[],o=[];function l(){e=0,t.length=0,r.length=0,o.length=0}function u(m,_,y,E,M,x){let v=n[e];return v===void 0?(v={id:m.id,object:m,geometry:_,material:y,groupOrder:E,renderOrder:m.renderOrder,z:M,group:x},n[e]=v):(v.id=m.id,v.object=m,v.geometry=_,v.material=y,v.groupOrder=E,v.renderOrder=m.renderOrder,v.z=M,v.group=x),e++,v}function c(m,_,y,E,M,x){const v=u(m,_,y,E,M,x);y.transmission>0?r.push(v):y.transparent===!0?o.push(v):t.push(v)}function h(m,_,y,E,M,x){const v=u(m,_,y,E,M,x);y.transmission>0?r.unshift(v):y.transparent===!0?o.unshift(v):t.unshift(v)}function d(m,_){t.length>1&&t.sort(m||bT),r.length>1&&r.sort(_||V_),o.length>1&&o.sort(_||V_)}function p(){for(let m=e,_=n.length;m<_;m++){const y=n[m];if(y.id===null)break;y.id=null,y.object=null,y.geometry=null,y.material=null,y.group=null}}return{opaque:t,transmissive:r,transparent:o,init:l,push:c,unshift:h,finish:p,sort:d}}function PT(){let n=new WeakMap;function e(r,o){const l=n.get(r);let u;return l===void 0?(u=new G_,n.set(r,[u])):o>=l.length?(u=new G_,l.push(u)):u=l[o],u}function t(){n=new WeakMap}return{get:e,dispose:t}}function LT(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new K,color:new Ge};break;case"SpotLight":t={position:new K,direction:new K,color:new Ge,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new K,color:new Ge,distance:0,decay:0};break;case"HemisphereLight":t={direction:new K,skyColor:new Ge,groundColor:new Ge};break;case"RectAreaLight":t={color:new Ge,position:new K,halfWidth:new K,halfHeight:new K};break}return n[e.id]=t,t}}}function DT(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new it};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new it};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new it,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}let NT=0;function IT(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function UT(n){const e=new LT,t=DT(),r={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let d=0;d<9;d++)r.probe.push(new K);const o=new K,l=new kt,u=new kt;function c(d){let p=0,m=0,_=0;for(let L=0;L<9;L++)r.probe[L].set(0,0,0);let y=0,E=0,M=0,x=0,v=0,A=0,T=0,C=0,z=0,D=0,N=0;d.sort(IT);for(let L=0,R=d.length;L<R;L++){const U=d[L],G=U.color,q=U.intensity,J=U.distance,ce=U.shadow&&U.shadow.map?U.shadow.map.texture:null;if(U.isAmbientLight)p+=G.r*q,m+=G.g*q,_+=G.b*q;else if(U.isLightProbe){for(let Y=0;Y<9;Y++)r.probe[Y].addScaledVector(U.sh.coefficients[Y],q);N++}else if(U.isDirectionalLight){const Y=e.get(U);if(Y.color.copy(U.color).multiplyScalar(U.intensity),U.castShadow){const ne=U.shadow,B=t.get(U);B.shadowIntensity=ne.intensity,B.shadowBias=ne.bias,B.shadowNormalBias=ne.normalBias,B.shadowRadius=ne.radius,B.shadowMapSize=ne.mapSize,r.directionalShadow[y]=B,r.directionalShadowMap[y]=ce,r.directionalShadowMatrix[y]=U.shadow.matrix,A++}r.directional[y]=Y,y++}else if(U.isSpotLight){const Y=e.get(U);Y.position.setFromMatrixPosition(U.matrixWorld),Y.color.copy(G).multiplyScalar(q),Y.distance=J,Y.coneCos=Math.cos(U.angle),Y.penumbraCos=Math.cos(U.angle*(1-U.penumbra)),Y.decay=U.decay,r.spot[M]=Y;const ne=U.shadow;if(U.map&&(r.spotLightMap[z]=U.map,z++,ne.updateMatrices(U),U.castShadow&&D++),r.spotLightMatrix[M]=ne.matrix,U.castShadow){const B=t.get(U);B.shadowIntensity=ne.intensity,B.shadowBias=ne.bias,B.shadowNormalBias=ne.normalBias,B.shadowRadius=ne.radius,B.shadowMapSize=ne.mapSize,r.spotShadow[M]=B,r.spotShadowMap[M]=ce,C++}M++}else if(U.isRectAreaLight){const Y=e.get(U);Y.color.copy(G).multiplyScalar(q),Y.halfWidth.set(U.width*.5,0,0),Y.halfHeight.set(0,U.height*.5,0),r.rectArea[x]=Y,x++}else if(U.isPointLight){const Y=e.get(U);if(Y.color.copy(U.color).multiplyScalar(U.intensity),Y.distance=U.distance,Y.decay=U.decay,U.castShadow){const ne=U.shadow,B=t.get(U);B.shadowIntensity=ne.intensity,B.shadowBias=ne.bias,B.shadowNormalBias=ne.normalBias,B.shadowRadius=ne.radius,B.shadowMapSize=ne.mapSize,B.shadowCameraNear=ne.camera.near,B.shadowCameraFar=ne.camera.far,r.pointShadow[E]=B,r.pointShadowMap[E]=ce,r.pointShadowMatrix[E]=U.shadow.matrix,T++}r.point[E]=Y,E++}else if(U.isHemisphereLight){const Y=e.get(U);Y.skyColor.copy(U.color).multiplyScalar(q),Y.groundColor.copy(U.groundColor).multiplyScalar(q),r.hemi[v]=Y,v++}}x>0&&(n.has("OES_texture_float_linear")===!0?(r.rectAreaLTC1=Le.LTC_FLOAT_1,r.rectAreaLTC2=Le.LTC_FLOAT_2):(r.rectAreaLTC1=Le.LTC_HALF_1,r.rectAreaLTC2=Le.LTC_HALF_2)),r.ambient[0]=p,r.ambient[1]=m,r.ambient[2]=_;const W=r.hash;(W.directionalLength!==y||W.pointLength!==E||W.spotLength!==M||W.rectAreaLength!==x||W.hemiLength!==v||W.numDirectionalShadows!==A||W.numPointShadows!==T||W.numSpotShadows!==C||W.numSpotMaps!==z||W.numLightProbes!==N)&&(r.directional.length=y,r.spot.length=M,r.rectArea.length=x,r.point.length=E,r.hemi.length=v,r.directionalShadow.length=A,r.directionalShadowMap.length=A,r.pointShadow.length=T,r.pointShadowMap.length=T,r.spotShadow.length=C,r.spotShadowMap.length=C,r.directionalShadowMatrix.length=A,r.pointShadowMatrix.length=T,r.spotLightMatrix.length=C+z-D,r.spotLightMap.length=z,r.numSpotLightShadowsWithMaps=D,r.numLightProbes=N,W.directionalLength=y,W.pointLength=E,W.spotLength=M,W.rectAreaLength=x,W.hemiLength=v,W.numDirectionalShadows=A,W.numPointShadows=T,W.numSpotShadows=C,W.numSpotMaps=z,W.numLightProbes=N,r.version=NT++)}function h(d,p){let m=0,_=0,y=0,E=0,M=0;const x=p.matrixWorldInverse;for(let v=0,A=d.length;v<A;v++){const T=d[v];if(T.isDirectionalLight){const C=r.directional[m];C.direction.setFromMatrixPosition(T.matrixWorld),o.setFromMatrixPosition(T.target.matrixWorld),C.direction.sub(o),C.direction.transformDirection(x),m++}else if(T.isSpotLight){const C=r.spot[y];C.position.setFromMatrixPosition(T.matrixWorld),C.position.applyMatrix4(x),C.direction.setFromMatrixPosition(T.matrixWorld),o.setFromMatrixPosition(T.target.matrixWorld),C.direction.sub(o),C.direction.transformDirection(x),y++}else if(T.isRectAreaLight){const C=r.rectArea[E];C.position.setFromMatrixPosition(T.matrixWorld),C.position.applyMatrix4(x),u.identity(),l.copy(T.matrixWorld),l.premultiply(x),u.extractRotation(l),C.halfWidth.set(T.width*.5,0,0),C.halfHeight.set(0,T.height*.5,0),C.halfWidth.applyMatrix4(u),C.halfHeight.applyMatrix4(u),E++}else if(T.isPointLight){const C=r.point[_];C.position.setFromMatrixPosition(T.matrixWorld),C.position.applyMatrix4(x),_++}else if(T.isHemisphereLight){const C=r.hemi[M];C.direction.setFromMatrixPosition(T.matrixWorld),C.direction.transformDirection(x),M++}}}return{setup:c,setupView:h,state:r}}function W_(n){const e=new UT(n),t=[],r=[];function o(p){d.camera=p,t.length=0,r.length=0}function l(p){t.push(p)}function u(p){r.push(p)}function c(){e.setup(t)}function h(p){e.setupView(t,p)}const d={lightsArray:t,shadowsArray:r,camera:null,lights:e,transmissionRenderTarget:{}};return{init:o,state:d,setupLights:c,setupLightsView:h,pushLight:l,pushShadow:u}}function FT(n){let e=new WeakMap;function t(o,l=0){const u=e.get(o);let c;return u===void 0?(c=new W_(n),e.set(o,[c])):l>=u.length?(c=new W_(n),u.push(c)):c=u[l],c}function r(){e=new WeakMap}return{get:t,dispose:r}}class Qv extends hr{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=Cv,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class Jv extends hr{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const OT=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function zT(n,e,t){let r=new Xc;const o=new it,l=new it,u=new $t,c=new Qv({depthPacking:Rv}),h=new Jv,d={},p=t.maxTextureSize,m={[lr]:xn,[xn]:lr,[Ni]:Ni},_=new Jn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new it},radius:{value:4}},vertexShader:OT,fragmentShader:kT}),y=_.clone();y.defines.HORIZONTAL_PASS=1;const E=new cn;E.setAttribute("position",new Wt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new Zn(E,_),x=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=zd;let v=this.type;this.render=function(D,N,W){if(x.enabled===!1||x.autoUpdate===!1&&x.needsUpdate===!1||D.length===0)return;const L=n.getRenderTarget(),R=n.getActiveCubeFace(),U=n.getActiveMipmapLevel(),G=n.state;G.setBlending(or),G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);const q=v!==Di&&this.type===Di,J=v===Di&&this.type!==Di;for(let ce=0,Y=D.length;ce<Y;ce++){const ne=D[ce],B=ne.shadow;if(B===void 0){console.warn("THREE.WebGLShadowMap:",ne,"has no shadow.");continue}if(B.autoUpdate===!1&&B.needsUpdate===!1)continue;o.copy(B.mapSize);const le=B.getFrameExtents();if(o.multiply(le),l.copy(B.mapSize),(o.x>p||o.y>p)&&(o.x>p&&(l.x=Math.floor(p/le.x),o.x=l.x*le.x,B.mapSize.x=l.x),o.y>p&&(l.y=Math.floor(p/le.y),o.y=l.y*le.y,B.mapSize.y=l.y)),B.map===null||q===!0||J===!0){const O=this.type!==Di?{minFilter:An,magFilter:An}:{};B.map!==null&&B.map.dispose(),B.map=new ur(o.x,o.y,O),B.map.texture.name=ne.name+".shadowMap",B.camera.updateProjectionMatrix()}n.setRenderTarget(B.map),n.clear();const ee=B.getViewportCount();for(let O=0;O<ee;O++){const se=B.getViewport(O);u.set(l.x*se.x,l.y*se.y,l.x*se.z,l.y*se.w),G.viewport(u),B.updateMatrices(ne,O),r=B.getFrustum(),C(N,W,B.camera,ne,this.type)}B.isPointLightShadow!==!0&&this.type===Di&&A(B,W),B.needsUpdate=!1}v=this.type,x.needsUpdate=!1,n.setRenderTarget(L,R,U)};function A(D,N){const W=e.update(M);_.defines.VSM_SAMPLES!==D.blurSamples&&(_.defines.VSM_SAMPLES=D.blurSamples,y.defines.VSM_SAMPLES=D.blurSamples,_.needsUpdate=!0,y.needsUpdate=!0),D.mapPass===null&&(D.mapPass=new ur(o.x,o.y)),_.uniforms.shadow_pass.value=D.map.texture,_.uniforms.resolution.value=D.mapSize,_.uniforms.radius.value=D.radius,n.setRenderTarget(D.mapPass),n.clear(),n.renderBufferDirect(N,null,W,_,M,null),y.uniforms.shadow_pass.value=D.mapPass.texture,y.uniforms.resolution.value=D.mapSize,y.uniforms.radius.value=D.radius,n.setRenderTarget(D.map),n.clear(),n.renderBufferDirect(N,null,W,y,M,null)}function T(D,N,W,L){let R=null;const U=W.isPointLight===!0?D.customDistanceMaterial:D.customDepthMaterial;if(U!==void 0)R=U;else if(R=W.isPointLight===!0?h:c,n.localClippingEnabled&&N.clipShadows===!0&&Array.isArray(N.clippingPlanes)&&N.clippingPlanes.length!==0||N.displacementMap&&N.displacementScale!==0||N.alphaMap&&N.alphaTest>0||N.map&&N.alphaTest>0){const G=R.uuid,q=N.uuid;let J=d[G];J===void 0&&(J={},d[G]=J);let ce=J[q];ce===void 0&&(ce=R.clone(),J[q]=ce,N.addEventListener("dispose",z)),R=ce}if(R.visible=N.visible,R.wireframe=N.wireframe,L===Di?R.side=N.shadowSide!==null?N.shadowSide:N.side:R.side=N.shadowSide!==null?N.shadowSide:m[N.side],R.alphaMap=N.alphaMap,R.alphaTest=N.alphaTest,R.map=N.map,R.clipShadows=N.clipShadows,R.clippingPlanes=N.clippingPlanes,R.clipIntersection=N.clipIntersection,R.displacementMap=N.displacementMap,R.displacementScale=N.displacementScale,R.displacementBias=N.displacementBias,R.wireframeLinewidth=N.wireframeLinewidth,R.linewidth=N.linewidth,W.isPointLight===!0&&R.isMeshDistanceMaterial===!0){const G=n.properties.get(R);G.light=W}return R}function C(D,N,W,L,R){if(D.visible===!1)return;if(D.layers.test(N.layers)&&(D.isMesh||D.isLine||D.isPoints)&&(D.castShadow||D.receiveShadow&&R===Di)&&(!D.frustumCulled||r.intersectsObject(D))){D.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,D.matrixWorld);const q=e.update(D),J=D.material;if(Array.isArray(J)){const ce=q.groups;for(let Y=0,ne=ce.length;Y<ne;Y++){const B=ce[Y],le=J[B.materialIndex];if(le&&le.visible){const ee=T(D,le,L,R);D.onBeforeShadow(n,D,N,W,q,ee,B),n.renderBufferDirect(W,null,q,ee,D,B),D.onAfterShadow(n,D,N,W,q,ee,B)}}}else if(J.visible){const ce=T(D,J,L,R);D.onBeforeShadow(n,D,N,W,q,ce,null),n.renderBufferDirect(W,null,q,ce,D,null),D.onAfterShadow(n,D,N,W,q,ce,null)}}const G=D.children;for(let q=0,J=G.length;q<J;q++)C(G[q],N,W,L,R)}function z(D){D.target.removeEventListener("dispose",z);for(const W in d){const L=d[W],R=D.target.uuid;R in L&&(L[R].dispose(),delete L[R])}}}function BT(n){function e(){let j=!1;const we=new $t;let he=null;const de=new $t(0,0,0,0);return{setMask:function(Ae){he!==Ae&&!j&&(n.colorMask(Ae,Ae,Ae,Ae),he=Ae)},setLocked:function(Ae){j=Ae},setClear:function(Ae,Ze,mt,zt,Xt){Xt===!0&&(Ae*=zt,Ze*=zt,mt*=zt),we.set(Ae,Ze,mt,zt),de.equals(we)===!1&&(n.clearColor(Ae,Ze,mt,zt),de.copy(we))},reset:function(){j=!1,he=null,de.set(-1,0,0,0)}}}function t(){let j=!1,we=null,he=null,de=null;return{setTest:function(Ae){Ae?_e(n.DEPTH_TEST):ye(n.DEPTH_TEST)},setMask:function(Ae){we!==Ae&&!j&&(n.depthMask(Ae),we=Ae)},setFunc:function(Ae){if(he!==Ae){switch(Ae){case cv:n.depthFunc(n.NEVER);break;case fv:n.depthFunc(n.ALWAYS);break;case hv:n.depthFunc(n.LESS);break;case Ua:n.depthFunc(n.LEQUAL);break;case dv:n.depthFunc(n.EQUAL);break;case pv:n.depthFunc(n.GEQUAL);break;case mv:n.depthFunc(n.GREATER);break;case gv:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}he=Ae}},setLocked:function(Ae){j=Ae},setClear:function(Ae){de!==Ae&&(n.clearDepth(Ae),de=Ae)},reset:function(){j=!1,we=null,he=null,de=null}}}function r(){let j=!1,we=null,he=null,de=null,Ae=null,Ze=null,mt=null,zt=null,Xt=null;return{setTest:function(vt){j||(vt?_e(n.STENCIL_TEST):ye(n.STENCIL_TEST))},setMask:function(vt){we!==vt&&!j&&(n.stencilMask(vt),we=vt)},setFunc:function(vt,zn,Bn){(he!==vt||de!==zn||Ae!==Bn)&&(n.stencilFunc(vt,zn,Bn),he=vt,de=zn,Ae=Bn)},setOp:function(vt,zn,Bn){(Ze!==vt||mt!==zn||zt!==Bn)&&(n.stencilOp(vt,zn,Bn),Ze=vt,mt=zn,zt=Bn)},setLocked:function(vt){j=vt},setClear:function(vt){Xt!==vt&&(n.clearStencil(vt),Xt=vt)},reset:function(){j=!1,we=null,he=null,de=null,Ae=null,Ze=null,mt=null,zt=null,Xt=null}}}const o=new e,l=new t,u=new r,c=new WeakMap,h=new WeakMap;let d={},p={},m=new WeakMap,_=[],y=null,E=!1,M=null,x=null,v=null,A=null,T=null,C=null,z=null,D=new Ge(0,0,0),N=0,W=!1,L=null,R=null,U=null,G=null,q=null;const J=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let ce=!1,Y=0;const ne=n.getParameter(n.VERSION);ne.indexOf("WebGL")!==-1?(Y=parseFloat(/^WebGL (\d)/.exec(ne)[1]),ce=Y>=1):ne.indexOf("OpenGL ES")!==-1&&(Y=parseFloat(/^OpenGL ES (\d)/.exec(ne)[1]),ce=Y>=2);let B=null,le={};const ee=n.getParameter(n.SCISSOR_BOX),O=n.getParameter(n.VIEWPORT),se=new $t().fromArray(ee),be=new $t().fromArray(O);function X(j,we,he,de){const Ae=new Uint8Array(4),Ze=n.createTexture();n.bindTexture(j,Ze),n.texParameteri(j,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(j,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let mt=0;mt<he;mt++)j===n.TEXTURE_3D||j===n.TEXTURE_2D_ARRAY?n.texImage3D(we,0,n.RGBA,1,1,de,0,n.RGBA,n.UNSIGNED_BYTE,Ae):n.texImage2D(we+mt,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,Ae);return Ze}const ue={};ue[n.TEXTURE_2D]=X(n.TEXTURE_2D,n.TEXTURE_2D,1),ue[n.TEXTURE_CUBE_MAP]=X(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),ue[n.TEXTURE_2D_ARRAY]=X(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),ue[n.TEXTURE_3D]=X(n.TEXTURE_3D,n.TEXTURE_3D,1,1),o.setClear(0,0,0,1),l.setClear(1),u.setClear(0),_e(n.DEPTH_TEST),l.setFunc(Ua),Et(!1),Ye(gd),_e(n.CULL_FACE),_t(or);function _e(j){d[j]!==!0&&(n.enable(j),d[j]=!0)}function ye(j){d[j]!==!1&&(n.disable(j),d[j]=!1)}function Ce(j,we){return p[j]!==we?(n.bindFramebuffer(j,we),p[j]=we,j===n.DRAW_FRAMEBUFFER&&(p[n.FRAMEBUFFER]=we),j===n.FRAMEBUFFER&&(p[n.DRAW_FRAMEBUFFER]=we),!0):!1}function De(j,we){let he=_,de=!1;if(j){he=m.get(we),he===void 0&&(he=[],m.set(we,he));const Ae=j.textures;if(he.length!==Ae.length||he[0]!==n.COLOR_ATTACHMENT0){for(let Ze=0,mt=Ae.length;Ze<mt;Ze++)he[Ze]=n.COLOR_ATTACHMENT0+Ze;he.length=Ae.length,de=!0}}else he[0]!==n.BACK&&(he[0]=n.BACK,de=!0);de&&n.drawBuffers(he)}function Ne(j){return y!==j?(n.useProgram(j),y=j,!0):!1}const ft={[Gr]:n.FUNC_ADD,[Y0]:n.FUNC_SUBTRACT,[$0]:n.FUNC_REVERSE_SUBTRACT};ft[q0]=n.MIN,ft[K0]=n.MAX;const k={[Z0]:n.ZERO,[Q0]:n.ONE,[J0]:n.SRC_COLOR,[Wu]:n.SRC_ALPHA,[sv]:n.SRC_ALPHA_SATURATE,[iv]:n.DST_COLOR,[tv]:n.DST_ALPHA,[ev]:n.ONE_MINUS_SRC_COLOR,[Xu]:n.ONE_MINUS_SRC_ALPHA,[rv]:n.ONE_MINUS_DST_COLOR,[nv]:n.ONE_MINUS_DST_ALPHA,[ov]:n.CONSTANT_COLOR,[av]:n.ONE_MINUS_CONSTANT_COLOR,[lv]:n.CONSTANT_ALPHA,[uv]:n.ONE_MINUS_CONSTANT_ALPHA};function _t(j,we,he,de,Ae,Ze,mt,zt,Xt,vt){if(j===or){E===!0&&(ye(n.BLEND),E=!1);return}if(E===!1&&(_e(n.BLEND),E=!0),j!==j0){if(j!==M||vt!==W){if((x!==Gr||T!==Gr)&&(n.blendEquation(n.FUNC_ADD),x=Gr,T=Gr),vt)switch(j){case Wr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Gu:n.blendFunc(n.ONE,n.ONE);break;case _d:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case vd:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",j);break}else switch(j){case Wr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Gu:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case _d:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case vd:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",j);break}v=null,A=null,C=null,z=null,D.set(0,0,0),N=0,M=j,W=vt}return}Ae=Ae||we,Ze=Ze||he,mt=mt||de,(we!==x||Ae!==T)&&(n.blendEquationSeparate(ft[we],ft[Ae]),x=we,T=Ae),(he!==v||de!==A||Ze!==C||mt!==z)&&(n.blendFuncSeparate(k[he],k[de],k[Ze],k[mt]),v=he,A=de,C=Ze,z=mt),(zt.equals(D)===!1||Xt!==N)&&(n.blendColor(zt.r,zt.g,zt.b,Xt),D.copy(zt),N=Xt),M=j,W=!1}function ht(j,we){j.side===Ni?ye(n.CULL_FACE):_e(n.CULL_FACE);let he=j.side===xn;we&&(he=!he),Et(he),j.blending===Wr&&j.transparent===!1?_t(or):_t(j.blending,j.blendEquation,j.blendSrc,j.blendDst,j.blendEquationAlpha,j.blendSrcAlpha,j.blendDstAlpha,j.blendColor,j.blendAlpha,j.premultipliedAlpha),l.setFunc(j.depthFunc),l.setTest(j.depthTest),l.setMask(j.depthWrite),o.setMask(j.colorWrite);const de=j.stencilWrite;u.setTest(de),de&&(u.setMask(j.stencilWriteMask),u.setFunc(j.stencilFunc,j.stencilRef,j.stencilFuncMask),u.setOp(j.stencilFail,j.stencilZFail,j.stencilZPass)),tt(j.polygonOffset,j.polygonOffsetFactor,j.polygonOffsetUnits),j.alphaToCoverage===!0?_e(n.SAMPLE_ALPHA_TO_COVERAGE):ye(n.SAMPLE_ALPHA_TO_COVERAGE)}function Et(j){L!==j&&(j?n.frontFace(n.CW):n.frontFace(n.CCW),L=j)}function Ye(j){j!==G0?(_e(n.CULL_FACE),j!==R&&(j===gd?n.cullFace(n.BACK):j===W0?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):ye(n.CULL_FACE),R=j}function Ut(j){j!==U&&(ce&&n.lineWidth(j),U=j)}function tt(j,we,he){j?(_e(n.POLYGON_OFFSET_FILL),(G!==we||q!==he)&&(n.polygonOffset(we,he),G=we,q=he)):ye(n.POLYGON_OFFSET_FILL)}function rt(j){j?_e(n.SCISSOR_TEST):ye(n.SCISSOR_TEST)}function F(j){j===void 0&&(j=n.TEXTURE0+J-1),B!==j&&(n.activeTexture(j),B=j)}function b(j,we,he){he===void 0&&(B===null?he=n.TEXTURE0+J-1:he=B);let de=le[he];de===void 0&&(de={type:void 0,texture:void 0},le[he]=de),(de.type!==j||de.texture!==we)&&(B!==he&&(n.activeTexture(he),B=he),n.bindTexture(j,we||ue[j]),de.type=j,de.texture=we)}function fe(){const j=le[B];j!==void 0&&j.type!==void 0&&(n.bindTexture(j.type,null),j.type=void 0,j.texture=void 0)}function pe(){try{n.compressedTexImage2D.apply(n,arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function ve(){try{n.compressedTexImage3D.apply(n,arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function me(){try{n.texSubImage2D.apply(n,arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function $e(){try{n.texSubImage3D.apply(n,arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function Pe(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function Oe(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function ot(){try{n.texStorage2D.apply(n,arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function Me(){try{n.texStorage3D.apply(n,arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function Ie(){try{n.texImage2D.apply(n,arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function pt(){try{n.texImage3D.apply(n,arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function et(j){se.equals(j)===!1&&(n.scissor(j.x,j.y,j.z,j.w),se.copy(j))}function ke(j){be.equals(j)===!1&&(n.viewport(j.x,j.y,j.z,j.w),be.copy(j))}function st(j,we){let he=h.get(we);he===void 0&&(he=new WeakMap,h.set(we,he));let de=he.get(j);de===void 0&&(de=n.getUniformBlockIndex(we,j.name),he.set(j,de))}function at(j,we){const de=h.get(we).get(j);c.get(we)!==de&&(n.uniformBlockBinding(we,de,j.__bindingPointIndex),c.set(we,de))}function Rt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),d={},B=null,le={},p={},m=new WeakMap,_=[],y=null,E=!1,M=null,x=null,v=null,A=null,T=null,C=null,z=null,D=new Ge(0,0,0),N=0,W=!1,L=null,R=null,U=null,G=null,q=null,se.set(0,0,n.canvas.width,n.canvas.height),be.set(0,0,n.canvas.width,n.canvas.height),o.reset(),l.reset(),u.reset()}return{buffers:{color:o,depth:l,stencil:u},enable:_e,disable:ye,bindFramebuffer:Ce,drawBuffers:De,useProgram:Ne,setBlending:_t,setMaterial:ht,setFlipSided:Et,setCullFace:Ye,setLineWidth:Ut,setPolygonOffset:tt,setScissorTest:rt,activeTexture:F,bindTexture:b,unbindTexture:fe,compressedTexImage2D:pe,compressedTexImage3D:ve,texImage2D:Ie,texImage3D:pt,updateUBOMapping:st,uniformBlockBinding:at,texStorage2D:ot,texStorage3D:Me,texSubImage2D:me,texSubImage3D:$e,compressedTexSubImage2D:Pe,compressedTexSubImage3D:Oe,scissor:et,viewport:ke,reset:Rt}}function X_(n,e,t,r){const o=HT(r);switch(t){case Wd:return n*e;case jd:return n*e;case Yd:return n*e*2;case $d:return n*e/o.components*o.byteLength;case zc:return n*e/o.components*o.byteLength;case qd:return n*e*2/o.components*o.byteLength;case Bc:return n*e*2/o.components*o.byteLength;case Xd:return n*e*3/o.components*o.byteLength;case ui:return n*e*4/o.components*o.byteLength;case Hc:return n*e*4/o.components*o.byteLength;case Ca:case Ra:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*8;case ba:case Pa:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case Ku:case Qu:return Math.max(n,16)*Math.max(e,8)/4;case qu:case Zu:return Math.max(n,8)*Math.max(e,8)/2;case Ju:case ec:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*8;case tc:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case nc:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case ic:return Math.floor((n+4)/5)*Math.floor((e+3)/4)*16;case rc:return Math.floor((n+4)/5)*Math.floor((e+4)/5)*16;case sc:return Math.floor((n+5)/6)*Math.floor((e+4)/5)*16;case oc:return Math.floor((n+5)/6)*Math.floor((e+5)/6)*16;case ac:return Math.floor((n+7)/8)*Math.floor((e+4)/5)*16;case lc:return Math.floor((n+7)/8)*Math.floor((e+5)/6)*16;case uc:return Math.floor((n+7)/8)*Math.floor((e+7)/8)*16;case cc:return Math.floor((n+9)/10)*Math.floor((e+4)/5)*16;case fc:return Math.floor((n+9)/10)*Math.floor((e+5)/6)*16;case hc:return Math.floor((n+9)/10)*Math.floor((e+7)/8)*16;case dc:return Math.floor((n+9)/10)*Math.floor((e+9)/10)*16;case pc:return Math.floor((n+11)/12)*Math.floor((e+9)/10)*16;case mc:return Math.floor((n+11)/12)*Math.floor((e+11)/12)*16;case La:case gc:case _c:return Math.ceil(n/4)*Math.ceil(e/4)*16;case Kd:case vc:return Math.ceil(n/4)*Math.ceil(e/4)*8;case xc:case yc:return Math.ceil(n/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function HT(n){switch(n){case Oi:case Hd:return{byteLength:1,components:1};case Eo:case Vd:case Ro:return{byteLength:2,components:1};case Oc:case kc:return{byteLength:2,components:4};case Xr:case Fc:case Ii:return{byteLength:4,components:1};case Gd:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${n}.`)}function VT(n,e,t,r,o,l,u){const c=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,h=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),d=new it,p=new WeakMap;let m;const _=new WeakMap;let y=!1;try{y=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(F,b){return y?new OffscreenCanvas(F,b):Va("canvas")}function M(F,b,fe){let pe=1;const ve=rt(F);if((ve.width>fe||ve.height>fe)&&(pe=fe/Math.max(ve.width,ve.height)),pe<1)if(typeof HTMLImageElement<"u"&&F instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&F instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&F instanceof ImageBitmap||typeof VideoFrame<"u"&&F instanceof VideoFrame){const me=Math.floor(pe*ve.width),$e=Math.floor(pe*ve.height);m===void 0&&(m=E(me,$e));const Pe=b?E(me,$e):m;return Pe.width=me,Pe.height=$e,Pe.getContext("2d").drawImage(F,0,0,me,$e),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ve.width+"x"+ve.height+") to ("+me+"x"+$e+")."),Pe}else return"data"in F&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ve.width+"x"+ve.height+")."),F;return F}function x(F){return F.generateMipmaps&&F.minFilter!==An&&F.minFilter!==Kn}function v(F){n.generateMipmap(F)}function A(F,b,fe,pe,ve=!1){if(F!==null){if(n[F]!==void 0)return n[F];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+F+"'")}let me=b;if(b===n.RED&&(fe===n.FLOAT&&(me=n.R32F),fe===n.HALF_FLOAT&&(me=n.R16F),fe===n.UNSIGNED_BYTE&&(me=n.R8)),b===n.RED_INTEGER&&(fe===n.UNSIGNED_BYTE&&(me=n.R8UI),fe===n.UNSIGNED_SHORT&&(me=n.R16UI),fe===n.UNSIGNED_INT&&(me=n.R32UI),fe===n.BYTE&&(me=n.R8I),fe===n.SHORT&&(me=n.R16I),fe===n.INT&&(me=n.R32I)),b===n.RG&&(fe===n.FLOAT&&(me=n.RG32F),fe===n.HALF_FLOAT&&(me=n.RG16F),fe===n.UNSIGNED_BYTE&&(me=n.RG8)),b===n.RG_INTEGER&&(fe===n.UNSIGNED_BYTE&&(me=n.RG8UI),fe===n.UNSIGNED_SHORT&&(me=n.RG16UI),fe===n.UNSIGNED_INT&&(me=n.RG32UI),fe===n.BYTE&&(me=n.RG8I),fe===n.SHORT&&(me=n.RG16I),fe===n.INT&&(me=n.RG32I)),b===n.RGB&&fe===n.UNSIGNED_INT_5_9_9_9_REV&&(me=n.RGB9_E5),b===n.RGBA){const $e=ve?Oa:wt.getTransfer(pe);fe===n.FLOAT&&(me=n.RGBA32F),fe===n.HALF_FLOAT&&(me=n.RGBA16F),fe===n.UNSIGNED_BYTE&&(me=$e===Lt?n.SRGB8_ALPHA8:n.RGBA8),fe===n.UNSIGNED_SHORT_4_4_4_4&&(me=n.RGBA4),fe===n.UNSIGNED_SHORT_5_5_5_1&&(me=n.RGB5_A1)}return(me===n.R16F||me===n.R32F||me===n.RG16F||me===n.RG32F||me===n.RGBA16F||me===n.RGBA32F)&&e.get("EXT_color_buffer_float"),me}function T(F,b){let fe;return F?b===null||b===Xr||b===Ts?fe=n.DEPTH24_STENCIL8:b===Ii?fe=n.DEPTH32F_STENCIL8:b===Eo&&(fe=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===Xr||b===Ts?fe=n.DEPTH_COMPONENT24:b===Ii?fe=n.DEPTH_COMPONENT32F:b===Eo&&(fe=n.DEPTH_COMPONENT16),fe}function C(F,b){return x(F)===!0||F.isFramebufferTexture&&F.minFilter!==An&&F.minFilter!==Kn?Math.log2(Math.max(b.width,b.height))+1:F.mipmaps!==void 0&&F.mipmaps.length>0?F.mipmaps.length:F.isCompressedTexture&&Array.isArray(F.image)?b.mipmaps.length:1}function z(F){const b=F.target;b.removeEventListener("dispose",z),N(b),b.isVideoTexture&&p.delete(b)}function D(F){const b=F.target;b.removeEventListener("dispose",D),L(b)}function N(F){const b=r.get(F);if(b.__webglInit===void 0)return;const fe=F.source,pe=_.get(fe);if(pe){const ve=pe[b.__cacheKey];ve.usedTimes--,ve.usedTimes===0&&W(F),Object.keys(pe).length===0&&_.delete(fe)}r.remove(F)}function W(F){const b=r.get(F);n.deleteTexture(b.__webglTexture);const fe=F.source,pe=_.get(fe);delete pe[b.__cacheKey],u.memory.textures--}function L(F){const b=r.get(F);if(F.depthTexture&&F.depthTexture.dispose(),F.isWebGLCubeRenderTarget)for(let pe=0;pe<6;pe++){if(Array.isArray(b.__webglFramebuffer[pe]))for(let ve=0;ve<b.__webglFramebuffer[pe].length;ve++)n.deleteFramebuffer(b.__webglFramebuffer[pe][ve]);else n.deleteFramebuffer(b.__webglFramebuffer[pe]);b.__webglDepthbuffer&&n.deleteRenderbuffer(b.__webglDepthbuffer[pe])}else{if(Array.isArray(b.__webglFramebuffer))for(let pe=0;pe<b.__webglFramebuffer.length;pe++)n.deleteFramebuffer(b.__webglFramebuffer[pe]);else n.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&n.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&n.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let pe=0;pe<b.__webglColorRenderbuffer.length;pe++)b.__webglColorRenderbuffer[pe]&&n.deleteRenderbuffer(b.__webglColorRenderbuffer[pe]);b.__webglDepthRenderbuffer&&n.deleteRenderbuffer(b.__webglDepthRenderbuffer)}const fe=F.textures;for(let pe=0,ve=fe.length;pe<ve;pe++){const me=r.get(fe[pe]);me.__webglTexture&&(n.deleteTexture(me.__webglTexture),u.memory.textures--),r.remove(fe[pe])}r.remove(F)}let R=0;function U(){R=0}function G(){const F=R;return F>=o.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+F+" texture units while this GPU supports only "+o.maxTextures),R+=1,F}function q(F){const b=[];return b.push(F.wrapS),b.push(F.wrapT),b.push(F.wrapR||0),b.push(F.magFilter),b.push(F.minFilter),b.push(F.anisotropy),b.push(F.internalFormat),b.push(F.format),b.push(F.type),b.push(F.generateMipmaps),b.push(F.premultiplyAlpha),b.push(F.flipY),b.push(F.unpackAlignment),b.push(F.colorSpace),b.join()}function J(F,b){const fe=r.get(F);if(F.isVideoTexture&&Ut(F),F.isRenderTargetTexture===!1&&F.version>0&&fe.__version!==F.version){const pe=F.image;if(pe===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(pe.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{be(fe,F,b);return}}t.bindTexture(n.TEXTURE_2D,fe.__webglTexture,n.TEXTURE0+b)}function ce(F,b){const fe=r.get(F);if(F.version>0&&fe.__version!==F.version){be(fe,F,b);return}t.bindTexture(n.TEXTURE_2D_ARRAY,fe.__webglTexture,n.TEXTURE0+b)}function Y(F,b){const fe=r.get(F);if(F.version>0&&fe.__version!==F.version){be(fe,F,b);return}t.bindTexture(n.TEXTURE_3D,fe.__webglTexture,n.TEXTURE0+b)}function ne(F,b){const fe=r.get(F);if(F.version>0&&fe.__version!==F.version){X(fe,F,b);return}t.bindTexture(n.TEXTURE_CUBE_MAP,fe.__webglTexture,n.TEXTURE0+b)}const B={[Fa]:n.REPEAT,[ir]:n.CLAMP_TO_EDGE,[$u]:n.MIRRORED_REPEAT},le={[An]:n.NEAREST,[Av]:n.NEAREST_MIPMAP_NEAREST,[Ma]:n.NEAREST_MIPMAP_LINEAR,[Kn]:n.LINEAR,[Ou]:n.LINEAR_MIPMAP_NEAREST,[rr]:n.LINEAR_MIPMAP_LINEAR},ee={[Pv]:n.NEVER,[Fv]:n.ALWAYS,[Lv]:n.LESS,[Zd]:n.LEQUAL,[Dv]:n.EQUAL,[Uv]:n.GEQUAL,[Nv]:n.GREATER,[Iv]:n.NOTEQUAL};function O(F,b){if(b.type===Ii&&e.has("OES_texture_float_linear")===!1&&(b.magFilter===Kn||b.magFilter===Ou||b.magFilter===Ma||b.magFilter===rr||b.minFilter===Kn||b.minFilter===Ou||b.minFilter===Ma||b.minFilter===rr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(F,n.TEXTURE_WRAP_S,B[b.wrapS]),n.texParameteri(F,n.TEXTURE_WRAP_T,B[b.wrapT]),(F===n.TEXTURE_3D||F===n.TEXTURE_2D_ARRAY)&&n.texParameteri(F,n.TEXTURE_WRAP_R,B[b.wrapR]),n.texParameteri(F,n.TEXTURE_MAG_FILTER,le[b.magFilter]),n.texParameteri(F,n.TEXTURE_MIN_FILTER,le[b.minFilter]),b.compareFunction&&(n.texParameteri(F,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(F,n.TEXTURE_COMPARE_FUNC,ee[b.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===An||b.minFilter!==Ma&&b.minFilter!==rr||b.type===Ii&&e.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||r.get(b).__currentAnisotropy){const fe=e.get("EXT_texture_filter_anisotropic");n.texParameterf(F,fe.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,o.getMaxAnisotropy())),r.get(b).__currentAnisotropy=b.anisotropy}}}function se(F,b){let fe=!1;F.__webglInit===void 0&&(F.__webglInit=!0,b.addEventListener("dispose",z));const pe=b.source;let ve=_.get(pe);ve===void 0&&(ve={},_.set(pe,ve));const me=q(b);if(me!==F.__cacheKey){ve[me]===void 0&&(ve[me]={texture:n.createTexture(),usedTimes:0},u.memory.textures++,fe=!0),ve[me].usedTimes++;const $e=ve[F.__cacheKey];$e!==void 0&&(ve[F.__cacheKey].usedTimes--,$e.usedTimes===0&&W(b)),F.__cacheKey=me,F.__webglTexture=ve[me].texture}return fe}function be(F,b,fe){let pe=n.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(pe=n.TEXTURE_2D_ARRAY),b.isData3DTexture&&(pe=n.TEXTURE_3D);const ve=se(F,b),me=b.source;t.bindTexture(pe,F.__webglTexture,n.TEXTURE0+fe);const $e=r.get(me);if(me.version!==$e.__version||ve===!0){t.activeTexture(n.TEXTURE0+fe);const Pe=wt.getPrimaries(wt.workingColorSpace),Oe=b.colorSpace===Ei?null:wt.getPrimaries(b.colorSpace),ot=b.colorSpace===Ei||Pe===Oe?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,b.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,b.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,ot);let Me=M(b.image,!1,o.maxTextureSize);Me=tt(b,Me);const Ie=l.convert(b.format,b.colorSpace),pt=l.convert(b.type);let et=A(b.internalFormat,Ie,pt,b.colorSpace,b.isVideoTexture);O(pe,b);let ke;const st=b.mipmaps,at=b.isVideoTexture!==!0,Rt=$e.__version===void 0||ve===!0,j=me.dataReady,we=C(b,Me);if(b.isDepthTexture)et=T(b.format===As,b.type),Rt&&(at?t.texStorage2D(n.TEXTURE_2D,1,et,Me.width,Me.height):t.texImage2D(n.TEXTURE_2D,0,et,Me.width,Me.height,0,Ie,pt,null));else if(b.isDataTexture)if(st.length>0){at&&Rt&&t.texStorage2D(n.TEXTURE_2D,we,et,st[0].width,st[0].height);for(let he=0,de=st.length;he<de;he++)ke=st[he],at?j&&t.texSubImage2D(n.TEXTURE_2D,he,0,0,ke.width,ke.height,Ie,pt,ke.data):t.texImage2D(n.TEXTURE_2D,he,et,ke.width,ke.height,0,Ie,pt,ke.data);b.generateMipmaps=!1}else at?(Rt&&t.texStorage2D(n.TEXTURE_2D,we,et,Me.width,Me.height),j&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,Me.width,Me.height,Ie,pt,Me.data)):t.texImage2D(n.TEXTURE_2D,0,et,Me.width,Me.height,0,Ie,pt,Me.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){at&&Rt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,we,et,st[0].width,st[0].height,Me.depth);for(let he=0,de=st.length;he<de;he++)if(ke=st[he],b.format!==ui)if(Ie!==null)if(at){if(j)if(b.layerUpdates.size>0){const Ae=X_(ke.width,ke.height,b.format,b.type);for(const Ze of b.layerUpdates){const mt=ke.data.subarray(Ze*Ae/ke.data.BYTES_PER_ELEMENT,(Ze+1)*Ae/ke.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,he,0,0,Ze,ke.width,ke.height,1,Ie,mt,0,0)}b.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,he,0,0,0,ke.width,ke.height,Me.depth,Ie,ke.data,0,0)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,he,et,ke.width,ke.height,Me.depth,0,ke.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else at?j&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,he,0,0,0,ke.width,ke.height,Me.depth,Ie,pt,ke.data):t.texImage3D(n.TEXTURE_2D_ARRAY,he,et,ke.width,ke.height,Me.depth,0,Ie,pt,ke.data)}else{at&&Rt&&t.texStorage2D(n.TEXTURE_2D,we,et,st[0].width,st[0].height);for(let he=0,de=st.length;he<de;he++)ke=st[he],b.format!==ui?Ie!==null?at?j&&t.compressedTexSubImage2D(n.TEXTURE_2D,he,0,0,ke.width,ke.height,Ie,ke.data):t.compressedTexImage2D(n.TEXTURE_2D,he,et,ke.width,ke.height,0,ke.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):at?j&&t.texSubImage2D(n.TEXTURE_2D,he,0,0,ke.width,ke.height,Ie,pt,ke.data):t.texImage2D(n.TEXTURE_2D,he,et,ke.width,ke.height,0,Ie,pt,ke.data)}else if(b.isDataArrayTexture)if(at){if(Rt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,we,et,Me.width,Me.height,Me.depth),j)if(b.layerUpdates.size>0){const he=X_(Me.width,Me.height,b.format,b.type);for(const de of b.layerUpdates){const Ae=Me.data.subarray(de*he/Me.data.BYTES_PER_ELEMENT,(de+1)*he/Me.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,de,Me.width,Me.height,1,Ie,pt,Ae)}b.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,Me.width,Me.height,Me.depth,Ie,pt,Me.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,et,Me.width,Me.height,Me.depth,0,Ie,pt,Me.data);else if(b.isData3DTexture)at?(Rt&&t.texStorage3D(n.TEXTURE_3D,we,et,Me.width,Me.height,Me.depth),j&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,Me.width,Me.height,Me.depth,Ie,pt,Me.data)):t.texImage3D(n.TEXTURE_3D,0,et,Me.width,Me.height,Me.depth,0,Ie,pt,Me.data);else if(b.isFramebufferTexture){if(Rt)if(at)t.texStorage2D(n.TEXTURE_2D,we,et,Me.width,Me.height);else{let he=Me.width,de=Me.height;for(let Ae=0;Ae<we;Ae++)t.texImage2D(n.TEXTURE_2D,Ae,et,he,de,0,Ie,pt,null),he>>=1,de>>=1}}else if(st.length>0){if(at&&Rt){const he=rt(st[0]);t.texStorage2D(n.TEXTURE_2D,we,et,he.width,he.height)}for(let he=0,de=st.length;he<de;he++)ke=st[he],at?j&&t.texSubImage2D(n.TEXTURE_2D,he,0,0,Ie,pt,ke):t.texImage2D(n.TEXTURE_2D,he,et,Ie,pt,ke);b.generateMipmaps=!1}else if(at){if(Rt){const he=rt(Me);t.texStorage2D(n.TEXTURE_2D,we,et,he.width,he.height)}j&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,Ie,pt,Me)}else t.texImage2D(n.TEXTURE_2D,0,et,Ie,pt,Me);x(b)&&v(pe),$e.__version=me.version,b.onUpdate&&b.onUpdate(b)}F.__version=b.version}function X(F,b,fe){if(b.image.length!==6)return;const pe=se(F,b),ve=b.source;t.bindTexture(n.TEXTURE_CUBE_MAP,F.__webglTexture,n.TEXTURE0+fe);const me=r.get(ve);if(ve.version!==me.__version||pe===!0){t.activeTexture(n.TEXTURE0+fe);const $e=wt.getPrimaries(wt.workingColorSpace),Pe=b.colorSpace===Ei?null:wt.getPrimaries(b.colorSpace),Oe=b.colorSpace===Ei||$e===Pe?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,b.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,b.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Oe);const ot=b.isCompressedTexture||b.image[0].isCompressedTexture,Me=b.image[0]&&b.image[0].isDataTexture,Ie=[];for(let de=0;de<6;de++)!ot&&!Me?Ie[de]=M(b.image[de],!0,o.maxCubemapSize):Ie[de]=Me?b.image[de].image:b.image[de],Ie[de]=tt(b,Ie[de]);const pt=Ie[0],et=l.convert(b.format,b.colorSpace),ke=l.convert(b.type),st=A(b.internalFormat,et,ke,b.colorSpace),at=b.isVideoTexture!==!0,Rt=me.__version===void 0||pe===!0,j=ve.dataReady;let we=C(b,pt);O(n.TEXTURE_CUBE_MAP,b);let he;if(ot){at&&Rt&&t.texStorage2D(n.TEXTURE_CUBE_MAP,we,st,pt.width,pt.height);for(let de=0;de<6;de++){he=Ie[de].mipmaps;for(let Ae=0;Ae<he.length;Ae++){const Ze=he[Ae];b.format!==ui?et!==null?at?j&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ae,0,0,Ze.width,Ze.height,et,Ze.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ae,st,Ze.width,Ze.height,0,Ze.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):at?j&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ae,0,0,Ze.width,Ze.height,et,ke,Ze.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ae,st,Ze.width,Ze.height,0,et,ke,Ze.data)}}}else{if(he=b.mipmaps,at&&Rt){he.length>0&&we++;const de=rt(Ie[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,we,st,de.width,de.height)}for(let de=0;de<6;de++)if(Me){at?j&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,0,0,Ie[de].width,Ie[de].height,et,ke,Ie[de].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,st,Ie[de].width,Ie[de].height,0,et,ke,Ie[de].data);for(let Ae=0;Ae<he.length;Ae++){const mt=he[Ae].image[de].image;at?j&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ae+1,0,0,mt.width,mt.height,et,ke,mt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ae+1,st,mt.width,mt.height,0,et,ke,mt.data)}}else{at?j&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,0,0,et,ke,Ie[de]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,st,et,ke,Ie[de]);for(let Ae=0;Ae<he.length;Ae++){const Ze=he[Ae];at?j&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ae+1,0,0,et,ke,Ze.image[de]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ae+1,st,et,ke,Ze.image[de])}}}x(b)&&v(n.TEXTURE_CUBE_MAP),me.__version=ve.version,b.onUpdate&&b.onUpdate(b)}F.__version=b.version}function ue(F,b,fe,pe,ve,me){const $e=l.convert(fe.format,fe.colorSpace),Pe=l.convert(fe.type),Oe=A(fe.internalFormat,$e,Pe,fe.colorSpace);if(!r.get(b).__hasExternalTextures){const Me=Math.max(1,b.width>>me),Ie=Math.max(1,b.height>>me);ve===n.TEXTURE_3D||ve===n.TEXTURE_2D_ARRAY?t.texImage3D(ve,me,Oe,Me,Ie,b.depth,0,$e,Pe,null):t.texImage2D(ve,me,Oe,Me,Ie,0,$e,Pe,null)}t.bindFramebuffer(n.FRAMEBUFFER,F),Ye(b)?c.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,pe,ve,r.get(fe).__webglTexture,0,Et(b)):(ve===n.TEXTURE_2D||ve>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&ve<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,pe,ve,r.get(fe).__webglTexture,me),t.bindFramebuffer(n.FRAMEBUFFER,null)}function _e(F,b,fe){if(n.bindRenderbuffer(n.RENDERBUFFER,F),b.depthBuffer){const pe=b.depthTexture,ve=pe&&pe.isDepthTexture?pe.type:null,me=T(b.stencilBuffer,ve),$e=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Pe=Et(b);Ye(b)?c.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Pe,me,b.width,b.height):fe?n.renderbufferStorageMultisample(n.RENDERBUFFER,Pe,me,b.width,b.height):n.renderbufferStorage(n.RENDERBUFFER,me,b.width,b.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,$e,n.RENDERBUFFER,F)}else{const pe=b.textures;for(let ve=0;ve<pe.length;ve++){const me=pe[ve],$e=l.convert(me.format,me.colorSpace),Pe=l.convert(me.type),Oe=A(me.internalFormat,$e,Pe,me.colorSpace),ot=Et(b);fe&&Ye(b)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,ot,Oe,b.width,b.height):Ye(b)?c.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ot,Oe,b.width,b.height):n.renderbufferStorage(n.RENDERBUFFER,Oe,b.width,b.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function ye(F,b){if(b&&b.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,F),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!r.get(b.depthTexture).__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),J(b.depthTexture,0);const pe=r.get(b.depthTexture).__webglTexture,ve=Et(b);if(b.depthTexture.format===ys)Ye(b)?c.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,pe,0,ve):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,pe,0);else if(b.depthTexture.format===As)Ye(b)?c.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,pe,0,ve):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,pe,0);else throw new Error("Unknown depthTexture format")}function Ce(F){const b=r.get(F),fe=F.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==F.depthTexture){const pe=F.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),pe){const ve=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,pe.removeEventListener("dispose",ve)};pe.addEventListener("dispose",ve),b.__depthDisposeCallback=ve}b.__boundDepthTexture=pe}if(F.depthTexture&&!b.__autoAllocateDepthBuffer){if(fe)throw new Error("target.depthTexture not supported in Cube render targets");ye(b.__webglFramebuffer,F)}else if(fe){b.__webglDepthbuffer=[];for(let pe=0;pe<6;pe++)if(t.bindFramebuffer(n.FRAMEBUFFER,b.__webglFramebuffer[pe]),b.__webglDepthbuffer[pe]===void 0)b.__webglDepthbuffer[pe]=n.createRenderbuffer(),_e(b.__webglDepthbuffer[pe],F,!1);else{const ve=F.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,me=b.__webglDepthbuffer[pe];n.bindRenderbuffer(n.RENDERBUFFER,me),n.framebufferRenderbuffer(n.FRAMEBUFFER,ve,n.RENDERBUFFER,me)}}else if(t.bindFramebuffer(n.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=n.createRenderbuffer(),_e(b.__webglDepthbuffer,F,!1);else{const pe=F.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ve=b.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,ve),n.framebufferRenderbuffer(n.FRAMEBUFFER,pe,n.RENDERBUFFER,ve)}t.bindFramebuffer(n.FRAMEBUFFER,null)}function De(F,b,fe){const pe=r.get(F);b!==void 0&&ue(pe.__webglFramebuffer,F,F.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),fe!==void 0&&Ce(F)}function Ne(F){const b=F.texture,fe=r.get(F),pe=r.get(b);F.addEventListener("dispose",D);const ve=F.textures,me=F.isWebGLCubeRenderTarget===!0,$e=ve.length>1;if($e||(pe.__webglTexture===void 0&&(pe.__webglTexture=n.createTexture()),pe.__version=b.version,u.memory.textures++),me){fe.__webglFramebuffer=[];for(let Pe=0;Pe<6;Pe++)if(b.mipmaps&&b.mipmaps.length>0){fe.__webglFramebuffer[Pe]=[];for(let Oe=0;Oe<b.mipmaps.length;Oe++)fe.__webglFramebuffer[Pe][Oe]=n.createFramebuffer()}else fe.__webglFramebuffer[Pe]=n.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){fe.__webglFramebuffer=[];for(let Pe=0;Pe<b.mipmaps.length;Pe++)fe.__webglFramebuffer[Pe]=n.createFramebuffer()}else fe.__webglFramebuffer=n.createFramebuffer();if($e)for(let Pe=0,Oe=ve.length;Pe<Oe;Pe++){const ot=r.get(ve[Pe]);ot.__webglTexture===void 0&&(ot.__webglTexture=n.createTexture(),u.memory.textures++)}if(F.samples>0&&Ye(F)===!1){fe.__webglMultisampledFramebuffer=n.createFramebuffer(),fe.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,fe.__webglMultisampledFramebuffer);for(let Pe=0;Pe<ve.length;Pe++){const Oe=ve[Pe];fe.__webglColorRenderbuffer[Pe]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,fe.__webglColorRenderbuffer[Pe]);const ot=l.convert(Oe.format,Oe.colorSpace),Me=l.convert(Oe.type),Ie=A(Oe.internalFormat,ot,Me,Oe.colorSpace,F.isXRRenderTarget===!0),pt=Et(F);n.renderbufferStorageMultisample(n.RENDERBUFFER,pt,Ie,F.width,F.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Pe,n.RENDERBUFFER,fe.__webglColorRenderbuffer[Pe])}n.bindRenderbuffer(n.RENDERBUFFER,null),F.depthBuffer&&(fe.__webglDepthRenderbuffer=n.createRenderbuffer(),_e(fe.__webglDepthRenderbuffer,F,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(me){t.bindTexture(n.TEXTURE_CUBE_MAP,pe.__webglTexture),O(n.TEXTURE_CUBE_MAP,b);for(let Pe=0;Pe<6;Pe++)if(b.mipmaps&&b.mipmaps.length>0)for(let Oe=0;Oe<b.mipmaps.length;Oe++)ue(fe.__webglFramebuffer[Pe][Oe],F,b,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+Pe,Oe);else ue(fe.__webglFramebuffer[Pe],F,b,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+Pe,0);x(b)&&v(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if($e){for(let Pe=0,Oe=ve.length;Pe<Oe;Pe++){const ot=ve[Pe],Me=r.get(ot);t.bindTexture(n.TEXTURE_2D,Me.__webglTexture),O(n.TEXTURE_2D,ot),ue(fe.__webglFramebuffer,F,ot,n.COLOR_ATTACHMENT0+Pe,n.TEXTURE_2D,0),x(ot)&&v(n.TEXTURE_2D)}t.unbindTexture()}else{let Pe=n.TEXTURE_2D;if((F.isWebGL3DRenderTarget||F.isWebGLArrayRenderTarget)&&(Pe=F.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(Pe,pe.__webglTexture),O(Pe,b),b.mipmaps&&b.mipmaps.length>0)for(let Oe=0;Oe<b.mipmaps.length;Oe++)ue(fe.__webglFramebuffer[Oe],F,b,n.COLOR_ATTACHMENT0,Pe,Oe);else ue(fe.__webglFramebuffer,F,b,n.COLOR_ATTACHMENT0,Pe,0);x(b)&&v(Pe),t.unbindTexture()}F.depthBuffer&&Ce(F)}function ft(F){const b=F.textures;for(let fe=0,pe=b.length;fe<pe;fe++){const ve=b[fe];if(x(ve)){const me=F.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,$e=r.get(ve).__webglTexture;t.bindTexture(me,$e),v(me),t.unbindTexture()}}}const k=[],_t=[];function ht(F){if(F.samples>0){if(Ye(F)===!1){const b=F.textures,fe=F.width,pe=F.height;let ve=n.COLOR_BUFFER_BIT;const me=F.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,$e=r.get(F),Pe=b.length>1;if(Pe)for(let Oe=0;Oe<b.length;Oe++)t.bindFramebuffer(n.FRAMEBUFFER,$e.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Oe,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,$e.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Oe,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,$e.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,$e.__webglFramebuffer);for(let Oe=0;Oe<b.length;Oe++){if(F.resolveDepthBuffer&&(F.depthBuffer&&(ve|=n.DEPTH_BUFFER_BIT),F.stencilBuffer&&F.resolveStencilBuffer&&(ve|=n.STENCIL_BUFFER_BIT)),Pe){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,$e.__webglColorRenderbuffer[Oe]);const ot=r.get(b[Oe]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,ot,0)}n.blitFramebuffer(0,0,fe,pe,0,0,fe,pe,ve,n.NEAREST),h===!0&&(k.length=0,_t.length=0,k.push(n.COLOR_ATTACHMENT0+Oe),F.depthBuffer&&F.resolveDepthBuffer===!1&&(k.push(me),_t.push(me),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,_t)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,k))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),Pe)for(let Oe=0;Oe<b.length;Oe++){t.bindFramebuffer(n.FRAMEBUFFER,$e.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Oe,n.RENDERBUFFER,$e.__webglColorRenderbuffer[Oe]);const ot=r.get(b[Oe]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,$e.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Oe,n.TEXTURE_2D,ot,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,$e.__webglMultisampledFramebuffer)}else if(F.depthBuffer&&F.resolveDepthBuffer===!1&&h){const b=F.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[b])}}}function Et(F){return Math.min(o.maxSamples,F.samples)}function Ye(F){const b=r.get(F);return F.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function Ut(F){const b=u.render.frame;p.get(F)!==b&&(p.set(F,b),F.update())}function tt(F,b){const fe=F.colorSpace,pe=F.format,ve=F.type;return F.isCompressedTexture===!0||F.isVideoTexture===!0||fe!==fr&&fe!==Ei&&(wt.getTransfer(fe)===Lt?(pe!==ui||ve!==Oi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",fe)),b}function rt(F){return typeof HTMLImageElement<"u"&&F instanceof HTMLImageElement?(d.width=F.naturalWidth||F.width,d.height=F.naturalHeight||F.height):typeof VideoFrame<"u"&&F instanceof VideoFrame?(d.width=F.displayWidth,d.height=F.displayHeight):(d.width=F.width,d.height=F.height),d}this.allocateTextureUnit=G,this.resetTextureUnits=U,this.setTexture2D=J,this.setTexture2DArray=ce,this.setTexture3D=Y,this.setTextureCube=ne,this.rebindTextures=De,this.setupRenderTarget=Ne,this.updateRenderTargetMipmap=ft,this.updateMultisampleRenderTarget=ht,this.setupDepthRenderbuffer=Ce,this.setupFrameBufferTexture=ue,this.useMultisampledRTT=Ye}function ex(n,e){function t(r,o=Ei){let l;const u=wt.getTransfer(o);if(r===Oi)return n.UNSIGNED_BYTE;if(r===Oc)return n.UNSIGNED_SHORT_4_4_4_4;if(r===kc)return n.UNSIGNED_SHORT_5_5_5_1;if(r===Gd)return n.UNSIGNED_INT_5_9_9_9_REV;if(r===Hd)return n.BYTE;if(r===Vd)return n.SHORT;if(r===Eo)return n.UNSIGNED_SHORT;if(r===Fc)return n.INT;if(r===Xr)return n.UNSIGNED_INT;if(r===Ii)return n.FLOAT;if(r===Ro)return n.HALF_FLOAT;if(r===Wd)return n.ALPHA;if(r===Xd)return n.RGB;if(r===ui)return n.RGBA;if(r===jd)return n.LUMINANCE;if(r===Yd)return n.LUMINANCE_ALPHA;if(r===ys)return n.DEPTH_COMPONENT;if(r===As)return n.DEPTH_STENCIL;if(r===$d)return n.RED;if(r===zc)return n.RED_INTEGER;if(r===qd)return n.RG;if(r===Bc)return n.RG_INTEGER;if(r===Hc)return n.RGBA_INTEGER;if(r===Ca||r===Ra||r===ba||r===Pa)if(u===Lt)if(l=e.get("WEBGL_compressed_texture_s3tc_srgb"),l!==null){if(r===Ca)return l.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===Ra)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===ba)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===Pa)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(l=e.get("WEBGL_compressed_texture_s3tc"),l!==null){if(r===Ca)return l.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===Ra)return l.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===ba)return l.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===Pa)return l.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===qu||r===Ku||r===Zu||r===Qu)if(l=e.get("WEBGL_compressed_texture_pvrtc"),l!==null){if(r===qu)return l.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===Ku)return l.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===Zu)return l.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===Qu)return l.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===Ju||r===ec||r===tc)if(l=e.get("WEBGL_compressed_texture_etc"),l!==null){if(r===Ju||r===ec)return u===Lt?l.COMPRESSED_SRGB8_ETC2:l.COMPRESSED_RGB8_ETC2;if(r===tc)return u===Lt?l.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:l.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===nc||r===ic||r===rc||r===sc||r===oc||r===ac||r===lc||r===uc||r===cc||r===fc||r===hc||r===dc||r===pc||r===mc)if(l=e.get("WEBGL_compressed_texture_astc"),l!==null){if(r===nc)return u===Lt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:l.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===ic)return u===Lt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:l.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===rc)return u===Lt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:l.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===sc)return u===Lt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:l.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===oc)return u===Lt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:l.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===ac)return u===Lt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:l.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===lc)return u===Lt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:l.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===uc)return u===Lt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:l.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===cc)return u===Lt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:l.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===fc)return u===Lt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:l.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===hc)return u===Lt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:l.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===dc)return u===Lt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:l.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===pc)return u===Lt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:l.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===mc)return u===Lt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:l.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===La||r===gc||r===_c)if(l=e.get("EXT_texture_compression_bptc"),l!==null){if(r===La)return u===Lt?l.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:l.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===gc)return l.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===_c)return l.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===Kd||r===vc||r===xc||r===yc)if(l=e.get("EXT_texture_compression_rgtc"),l!==null){if(r===La)return l.COMPRESSED_RED_RGTC1_EXT;if(r===vc)return l.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===xc)return l.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===yc)return l.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Ts?n.UNSIGNED_INT_24_8:n[r]!==void 0?n[r]:null}return{convert:t}}class tx extends qn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class vo extends qt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const GT={type:"move"};class ad{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new vo,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new vo,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new K,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new K),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new vo,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new K,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new K),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const r of e.hand.values())this._getHandJoint(t,r)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,r){let o=null,l=null,u=null;const c=this._targetRay,h=this._grip,d=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(d&&e.hand){u=!0;for(const M of e.hand.values()){const x=t.getJointPose(M,r),v=this._getHandJoint(d,M);x!==null&&(v.matrix.fromArray(x.transform.matrix),v.matrix.decompose(v.position,v.rotation,v.scale),v.matrixWorldNeedsUpdate=!0,v.jointRadius=x.radius),v.visible=x!==null}const p=d.joints["index-finger-tip"],m=d.joints["thumb-tip"],_=p.position.distanceTo(m.position),y=.02,E=.005;d.inputState.pinching&&_>y+E?(d.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!d.inputState.pinching&&_<=y-E&&(d.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else h!==null&&e.gripSpace&&(l=t.getPose(e.gripSpace,r),l!==null&&(h.matrix.fromArray(l.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,l.linearVelocity?(h.hasLinearVelocity=!0,h.linearVelocity.copy(l.linearVelocity)):h.hasLinearVelocity=!1,l.angularVelocity?(h.hasAngularVelocity=!0,h.angularVelocity.copy(l.angularVelocity)):h.hasAngularVelocity=!1));c!==null&&(o=t.getPose(e.targetRaySpace,r),o===null&&l!==null&&(o=l),o!==null&&(c.matrix.fromArray(o.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,o.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(o.linearVelocity)):c.hasLinearVelocity=!1,o.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(o.angularVelocity)):c.hasAngularVelocity=!1,this.dispatchEvent(GT)))}return c!==null&&(c.visible=o!==null),h!==null&&(h.visible=l!==null),d!==null&&(d.visible=u!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const r=new vo;r.matrixAutoUpdate=!1,r.visible=!1,e.joints[t.jointName]=r,e.add(r)}return e.joints[t.jointName]}}const WT=`
void main() {
...
void main() {
  ...
  #include <colorspace_fragment>
      ...
      #include <colorspace_fragment>
    }`}),h=new Zn(new Ss(1.045,48,32),c);t.add(h);const d=new cn,p=new Float32Array(900*3);for(let A=0;A<900;A++){const T=7+Math.random()*8,C=Math.random()*2-1,z=Math.random()*Math.PI*2,D=Math.sqrt(1-C*C);p[A*3]=T*D*Math.cos(z),p[A*3+1]=T*C,p[A*3+2]=T*D*Math.sin(z)}d.setAttribute("position",new Wt(p,3));const m=new fp(d,new cp({color:8231863,size:.012,transparent:!0,opacity:.42,depthWrite:!1}));n.add(m);let _=null,y=null,E=!1,M=null;const x=(A,T)=>{_||E||!A.terrain||(E=!0,new fx().load("/openflights/geo/terrain-4096.png",C=>{E=!1,C.colorSpace=Ei,C.wrapS=Fa,C.wrapT=ir,C.minFilter=rr,C.magFilter=Kn,C.generateMipmaps=!0,C.anisotropy=8,y=C,_=mP(A.terrain,C,{x:C.image.width,y:C.image.height}),M&&M.terrain&&(o.material=_),T?.()},void 0,()=>{E=!1}))};return{globeGroup:t,globe:o,grid:u,atmosphere:h,starsObj:m,starsGeo:d,applyTheme:(A,T)=>{M=A,A.terrain?_?o.material=_:x(A,T):o.material=r,l.color.set(A.grid.color),l.opacity=A.grid.opacity,c.uniforms.uColor.value.copy(A.atmosphere.color),c.uniforms.uStrength.value=A.atmosphere.strength,m.visible=A.stars},dispose(){y?.dispose(),_?.dispose(),r.dispose()}}}function _P(n,e,t,r,o,l){const u=new Float32Array(e.nodes.length*3),c=new Float32Array(e.nodes.length*3),h=new Float32Array(e.nodes.length),d=new Float32Array(e.nodes.length),p=new Float32Array(e.nodes.length),m=new Float32Array(e.nodes.length);for(let R=0;R<p.length;R++)p[R]=R;u.set(t.geo),e.nodes.forEach((R,U)=>{h[U]=4.2+Math.min(8,Math.sqrt(R.degree)*.72),d[U]=.88});const _=new cn;_.setAttribute("position",new Wt(u,3)),_.setAttribute("color",new Wt(c,3)),_.setAttribute("aSize",new Wt(h,1)),_.setAttribute("aAlpha",new Wt(d,1)),_.setAttribute("aIndex",new Wt(p,1)),_.setAttribute("aPickable",new Wt(m,1));const y=new Jn({transparent:!0,depthWrite:!1,vertexColors:!0,uniforms:{uPixelRatio:{value:r.getPixelRatio()}},vertexShader:"attribute float aSize;attribute float aAlpha;varying vec3 vColor;varying float vAlpha;void main(){vColor=color;vAlpha=aAlpha;vec4 mv=modelViewMatrix*vec4(position,1.);gl_PointSize=clamp(aSize*(260.0/-mv.z),2.0,18.0);gl_Position=projectionMatrix*mv;}",fragmentShader:`varying vec3 vColor;varying float vAlpha;void main(){float d=length(gl_PointCoord-.5);float a=smoothstep(.5,.25,d)*vAlpha;if(a<.015)discard;gl_FragColor=vec4(vColor,a);
      #include <colorspace_fragment>
    }`}),E=new fp(_,y);n.add(E);const M=e.nodes.reduce((R,U)=>U.degree>R.degree?U:R,e.nodes[0]),x=new Ss(1,24,16),v=new ox({roughness:.32,metalness:.2}),A=new Zn(x,v);A.visible=!1,n.add(A);let T=0,C=3.55;const z=(R,U,G,q)=>{if(!G){A.visible=!1;return}const{color:J,pixelSize:ce}=I0(G,U,q);t.read(R.view,G.index,A.position),W=G.index,v.color.copy(J),v.emissive.copy(J).multiplyScalar(.32),T=ce,C=R.view==="globe"?3.55:4.2,A.scale.setScalar(U0(T,o,l(),C)),A.visible=!0};let D=e.nodes.map((R,U)=>U),N=t.geo,W=-1;const L=(R,U,G,q)=>{D=[];const J=t.table(R.view);J!==N&&(u.set(J),_.attributes.position.needsUpdate=!0,N=J),e.nodes.forEach((ce,Y)=>{const ne=!R.country||ce.country===R.country,B=ce.degree>=R.minDegree,le=ne&&B,{color:ee,pixelSize:O,isSelected:se,connected:be}=I0(ce,U,q);let X=se?1:le?.9:be?.75:eA;const ue=ce===G;ue&&(X=0),c[Y*3]=ee.r,c[Y*3+1]=ee.g,c[Y*3+2]=ee.b,d[Y]=X,h[Y]=O;const _e=se||be||le||ue;m[Y]=_e?1:0,_e&&D.push(Y)}),_.attributes.color.needsUpdate=!0,_.attributes.aAlpha.needsUpdate=!0,_.attributes.aSize.needsUpdate=!0,_.attributes.aPickable.needsUpdate=!0};return{points:E,topHubNode:M,geometry:_,material:y,heroMesh:A,get heroIndex(){return A.visible?W:-1},positions:u,get visibleIndices(){return D},update(R,U,G,q){L(R,U,G,q),z(R,U,G,q)},resize(){A.visible&&A.scale.setScalar(U0(T,o,l(),C))},dispose(){_.dispose(),y.dispose(),x.dispose(),v.dispose()}}}function vP(n,e,t){let r=null,o=null;const l=new K,u=new K,c=(m,_)=>{t.read(m,_.source.index,l),t.read(m,_.target.index,u)},h=m=>{m&&(n.remove(m),m.geometry.dispose(),m.material.dispose())},d=(m,_,y,E,M,x,v)=>{if(!m.length)return null;let A=0;for(const W of m)A+=_.view==="globe"?(c("globe",W),l.angleTo(u)>1.25?11:7):1;const T=new Float32Array(A*2*3),C=new Float32Array(A*2*3);let z=0;for(const W of m){const R=E&&(W.source===E||W.target===E)?y.route.selected:W.international?y.route.intl:y.route.domestic;if(_.view==="globe"){c("globe",W);const U=l.angleTo(u),G=U>1.25?11:7,q=.025+Math.min(.34,U*.18)+M;let J=N0(l,u,0,q);for(let ce=1;ce<=G;ce++){const Y=N0(l,u,ce/G,q);T.set(J.toArray(),z),C.set(R.toArray(),z),z+=3,T.set(Y.toArray(),z),C.set(R.toArray(),z),z+=3,J=Y}}else c("topology",W),T.set(l.toArray(),z),C.set(R.toArray(),z),z+=3,T.set(u.toArray(),z),C.set(R.toArray(),z),z+=3}const D=new cn;D.setAttribute("position",new Wt(T,3)),D.setAttribute("color",new Wt(C,3));const N=new $c(D,new Ka({vertexColors:!0,transparent:!0,opacity:x,depthWrite:!1,blending:y.routeBlending}));return N.renderOrder=v,n.add(N),N};return{get objects(){return[r,o].filter(Boolean)},get object(){return r},update:(m,_,y)=>{h(r),h(o),r=o=null;const E=Math.ceil(e.links.length*m.density/100),M=[],x=[];let v=0;for(const C of e.links){if(v>=E)break;m.scope==="international"&&!C.international||m.scope==="domestic"&&C.international||m.country&&C.source.country!==m.country&&C.target.country!==m.country||C.source.degree<m.minDegree||C.target.degree<m.minDegree||(v++,_&&(C.source===_||C.target===_)?x.push(C):M.push(C))}const A=m.view==="globe"?"globe":"topology",T=x.length?y.routeContextOpacity[A]:y.routeOpacity[A];r=d(M,m,y,_,0,T,1),o=d(x,m,y,_,m.view==="globe"?.02:0,y.routeFocusOpacity,2)},dispose(){h(r),h(o),r=o=null}}}const xP=8,yP=["attribute float aSize;","attribute float aIndex;","attribute float aPickable;","varying vec3 vId;","void main() {","  if (aPickable < 0.5) {","    gl_Position = vec4(2.0, 2.0, 2.0, 1.0);","    gl_PointSize = 0.0;","    return;","  }","  float id = aIndex + 1.0;","  vId = vec3(","    floor(id / 65536.0),","    floor(mod(id, 65536.0) / 256.0),","    mod(id, 256.0)","  ) / 255.0;","  vec4 mv = modelViewMatrix * vec4(position, 1.0);","  gl_PointSize = clamp(aSize * (260.0 / -mv.z), 2.0, 18.0);","  gl_Position = projectionMatrix * mv;","}"].join(`
`),SP=["varying vec3 vId;","void main() {","  if (length(gl_PointCoord - 0.5) > 0.5) discard;","  gl_FragColor = vec4(vId, 1.0);","}"].join(`
`),k0=n=>new n.ShaderMaterial({uniforms:{uId:{value:new n.Vector3}},vertexShader:"void main(){gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0);}",fragmentShader:"uniform vec3 uId;void main(){gl_FragColor=vec4(uId,1.0);}"}),MP=(n,e)=>e.set(Math.floor(n/65536)/255,Math.floor(n/256)%256/255,n%256/255);function EP({renderer:n,scene:e,camera:t,data:r,sprites:o,world:l,routes:u,selectedRef:c,onHover:h,onSelect:d,onClear:p}){let m=0,_=null,y=!1,E=0,M=null,x=null;const v=new Jn({vertexShader:yP,fragmentShader:SP,transparent:!1,depthTest:!0,depthWrite:!0}),A=k0(t0),T=k0(t0),C=U=>{const G=Math.max(1,Math.round(xP*2*U)+1);G===E&&M||(M?.dispose(),E=G,M=new ur(E,E,{minFilter:An,magFilter:An,depthBuffer:!0}),M.texture.colorSpace=Ei,M.texture.generateMipmaps=!1,x=new Uint8Array(E*E*4))},z=(U,G)=>{const q=n.domElement,J=q.getBoundingClientRect();if(U<J.left||G<J.top||U>J.right||G>J.bottom)return null;const ce=n.getPixelRatio();C(ce);const Y=Math.round(J.width*ce),ne=Math.round(J.height*ce),B=(U-J.left)*ce,le=(G-J.top)*ce,ee=o.heroIndex,O=[],se=Ne=>{Ne&&(O.push([Ne,"visible",Ne.visible]),Ne.visible=!1)},be=(Ne,ft)=>{O.push([Ne,"material",Ne.material]),Ne.material=ft};se(l.starsObj),se(l.grid),se(l.atmosphere),u.objects.forEach(se),be(l.globe,A),be(o.points,v),ee>=0?(MP(ee+1,T.uniforms.uId.value),be(o.heroMesh,T)):se(o.heroMesh);const X=n.getRenderTarget(),ue=n.getClearColor(new Ge),_e=n.getClearAlpha();t.setViewOffset(Y,ne,Math.round(B)-(E>>1),Math.round(le)-(E>>1),E,E),n.setRenderTarget(M),n.setClearColor(0,1),n.clear(),n.render(e,t),n.readRenderTargetPixels(M,0,0,E,E,x),t.clearViewOffset(),n.setRenderTarget(X),n.setClearColor(ue,_e);for(let Ne=O.length-1;Ne>=0;Ne--){const[ft,k,_t]=O[Ne];ft[k]=_t}const ye=E>>1;let Ce=null,De=1/0;for(let Ne=0;Ne<E;Ne++)for(let ft=0;ft<E;ft++){const k=((E-1-Ne)*E+ft)*4,_t=x[k]<<16|x[k+1]<<8|x[k+2];if(!_t)continue;const ht=(ft-ye)*(ft-ye)+(Ne-ye)*(Ne-ye);ht<De&&(De=ht,Ce=_t-1)}return Ce!==null&&Ce<r.nodes.length?Ce:null},D=U=>{m||(m=requestAnimationFrame(()=>{if(m=0,c.current)return;const G=z(U.clientX,U.clientY);n.domElement.style.cursor=G===null?"grab":"pointer",h(G===null?null:r.nodes[G],G===null?null:{x:U.clientX,y:U.clientY})}))},N=U=>{_={x:U.clientX,y:U.clientY},y=!1},W=U=>{if(!_)return;const G=U.clientX-_.x,q=U.clientY-_.y;if(y=G*G+q*q>36,_=null,y)return;const J=z(U.clientX,U.clientY);J===null?p():d(r.nodes[J],{x:U.clientX,y:U.clientY})},L=()=>{m&&(cancelAnimationFrame(m),m=0),c.current||h(null,null)},R=n.domElement;return R.addEventListener("pointermove",D,{passive:!0}),R.addEventListener("pointerdown",N),R.addEventListener("pointerup",W),R.addEventListener("pointerleave",L),{pickAt:z,dispose(){m&&cancelAnimationFrame(m),R.removeEventListener("pointermove",D),R.removeEventListener("pointerdown",N),R.removeEventListener("pointerup",W),R.removeEventListener("pointerleave",L),M?.dispose(),v.dispose(),A.dispose(),T.dispose()}}}const z0=1.0025,wP=4,TP=2.6;function AP(n){const{scale:e,translate:t}=n.transform;return n.arcs.map(r=>{let o=0,l=0;return r.map(([u,c])=>(o+=u,l+=c,[o*e[0]+t[0],l*e[1]+t[1]]))})}function CP(n,e){const t=n.objects.countries||n.objects.land,r=[],o=l=>{const u=[];for(const c of l){const h=c<0?e[~c].slice().reverse():e[c];u.length?u.push(...h.slice(1)):u.push(...h)}return u};for(const l of t.geometries){const u=l.type==="Polygon"?[l.arcs]:l.type==="MultiPolygon"?l.arcs:[];for(const c of u)for(const h of c)r.push(o(h))}return r}function RP(n){const e=[],t=new K,r=new K;for(const l of n)for(let u=0;u<l.length-1;u++){const[c,h]=l[u],[d,p]=l[u+1];if(Math.abs(d-c)>180)continue;const m=Math.max(Math.abs(d-c),Math.abs(p-h)),_=Math.max(1,Math.ceil(m/wP));t.copy(Od(h,c,z0));for(let y=1;y<=_;y++){const E=y/_;r.copy(Od(h+(p-h)*E,c+(d-c)*E,z0)),e.push(t.x,t.y,t.z,r.x,r.y,r.z),t.copy(r)}}const o=new cn;return o.setAttribute("position",new Wt(new Float32Array(e),3)),o}function bP(n){const e=new Ka({color:2830392,transparent:!0,opacity:.5,depthWrite:!1}),t=new $c(new cn,e);t.visible=!1,t.renderOrder=0,n.add(t);const r={"110m":null,"50m":null},o={};let l=!1,u=null;const c=d=>{!r[d]||u===d||(t.geometry=r[d],u=d)},h=(d,p)=>{r[d]||o[d]||(o[d]=!0,fetch(`/openflights/geo/countries-${d}.json`).then(m=>m.ok?m.json():Promise.reject(new Error(m.status))).then(m=>{const _=AP(m);r[d]=RP(CP(m,_)),o[d]=!1,l&&(d!=="110m"||!r["50m"])&&(c(d),p?.())}).catch(()=>{o[d]=!1}))};return{object:t,setTheme(d,p){l=!!d.borders,t.visible=l,l&&(e.color.set(d.borders.color),e.opacity=d.borders.opacity,r["110m"]?c(r["50m"]?"50m":"110m"):h("110m",p))},updateDetail(d,p){l&&(d<=TP?r["50m"]?c("50m"):h("50m",p):r["110m"]&&c("110m"))},dispose(){e.dispose();for(const d of Object.keys(r))r[d]?.dispose();n.remove(t)}}}const ai={orange:"#e69f00",sky:"#56b4e9",green:"#009e73",blue:"#0072b2",vermillion:"#d55e00",purple:"#cc79a7"},_n=n=>new Ge(n),B0={dark:{fog:724242,fogDensity:.055,node:{hub:_n("#e69f00"),mid:_n("#56b4e9"),low:_n("#f3f4f6")},nodeSelected:_n(ai.orange),nodeConnected:_n(ai.purple),route:{intl:_n(ai.sky),domestic:_n(ai.green),selected:_n(ai.orange)},routeBlending:Gu,routeOpacity:{globe:.29,topology:.2},routeContextOpacity:{globe:.08,topology:.07},routeFocusOpacity:.95,globe:{color:1055270,emissive:462874,specular:2704476,shininess:22},grid:{color:3493992,opacity:.13},atmosphere:{color:new Ge("#389eeb"),strength:.26},stars:!0,terrain:!1,borders:null,lights:{hemiSky:10145778,hemiGround:659488,hemi:1.15,sun:1.4}},light:{fog:15659508,fogDensity:.03,node:{hub:_n(ai.vermillion),mid:_n(ai.blue),low:_n("#1c1f26")},nodeSelected:_n(ai.vermillion),nodeConnected:_n(ai.purple),route:{intl:_n(ai.blue),domestic:_n(ai.green),selected:_n(ai.vermillion)},routeBlending:Wr,routeOpacity:{globe:.26,topology:.22},routeContextOpacity:{globe:.09,topology:.08},routeFocusOpacity:.9,globe:{color:14673644,emissive:0,specular:2241348,shininess:4},grid:{color:4937059,opacity:.12},atmosphere:{color:new Ge("#5c8cb8"),strength:.16},stars:!1,terrain:{ocean:new Ge("#a9d3ee"),oceanDeep:new Ge("#7fbde4"),shore:new Ge("#cfe8f7"),land:[{at:0,color:new Ge("#5fae8d")},{at:.18,color:new Ge("#9ac68a")},{at:.38,color:new Ge("#f0e442")},{at:.58,color:new Ge("#e69f00")},{at:.78,color:new Ge("#d55e00")},{at:1,color:new Ge("#f4f1ec")}],relief:.55},borders:{color:2830392,opacity:.5,coastOpacity:.75},lights:{hemiSky:16777215,hemiGround:13227230,hemi:1.35,sun:.85}}},H0=n=>B0[n]||B0.dark;function PP({data:n,positions:e,options:t,sidebarOpen:r,selected:o,onHover:l,onSelect:u,onClear:c,focusRequest:h,topologyVersion:d}){const p=Mt.useRef(),m=Mt.useRef(),_=Mt.useRef(o);return _.current=o,Mt.useEffect(()=>{const y=p.current;if(!y||!n)return;let E=!1,M=0,x=performance.now(),v=[],A="globe",T=H0(t.theme);const C=new ix;C.fog=new Yc(T.fog,T.fogDensity);const z=new qn(42,1,.01,100);z.position.set(0,.3,3.55);const D=new nx({antialias:!0,alpha:!0,powerPreference:"high-performance"});D.setPixelRatio(Math.min(devicePixelRatio,1.75)),D.setSize(y.clientWidth,y.clientHeight,!1),D.outputColorSpace=li,D.domElement.tabIndex=0,D.domElement.setAttribute("role","img"),D.domElement.setAttribute("aria-label",`Interactive 3D flight network with ${sr.format(n.nodes.length)} airports and ${sr.format(n.links.length)} connections`),y.appendChild(D.domElement);const N=new eP(z,D.domElement);N.enableDamping=!0,N.dampingFactor=.065,N.enablePan=!1,N.minDistance=1.55,N.maxDistance=8,N.autoRotateSpeed=.32;const W=new hx(10145778,659488,1.15);C.add(W);const L=new dx(16777215,1.4);L.position.set(3,2,4),C.add(L);const R=()=>y.clientHeight||800,U=gP(C),G=bP(C),q=_P(C,n,e,D,z,R),J=vP(C,n,e),ce=EP({renderer:D,scene:C,camera:z,data:n,sprites:q,world:U,routes:J,selectedRef:_,onHover:l,onSelect:u,onClear:c}),Y=(X=A)=>{N.target.set(0,0,0),z.position.set(0,.3,X==="globe"?3.55:4.2),N.update()},ne=X=>{const ue=e.read(A,X.index,new K);if(A==="globe"){const _e=ue.clone().normalize().multiplyScalar(2.35),ye=z.position.clone(),Ce=N.target.clone(),De=performance.now(),Ne=n0?1:650,ft=k=>{const _t=Math.min(1,(k-De)/Ne),ht=1-Math.pow(1-_t,3);z.position.lerpVectors(ye,_e,ht),N.target.lerpVectors(Ce,ue.clone().multiplyScalar(.18),ht),N.update(),_t<1&&requestAnimationFrame(ft)};requestAnimationFrame(ft)}else N.target.copy(ue),z.position.set(ue.x,ue.y,ue.z+2.4),N.update()},B=()=>{C.fog.color.set(T.fog),C.fog.density=T.fogDensity,W.color.set(T.lights.hemiSky),W.groundColor.set(T.lights.hemiGround),W.intensity=T.lights.hemi,L.intensity=T.lights.sun,U.applyTheme(T),G.setTheme(T),G.object.visible=!!T.borders&&A==="globe"},le=(X,ue)=>{A=X.view,T=H0(X.theme),B(),N.autoRotate=X.autoRotate&&!n0&&X.view==="globe";const _e=ue||q.topHubNode;q.update(X,ue,_e,T),J.update(X,ue,T),U.globeGroup.visible=X.view==="globe",N.enablePan=X.view==="topology",N.minDistance=X.view==="globe"?1.55:1.2,N.maxDistance=X.view==="globe"?8:10},ee=()=>{const X=y.clientWidth,ue=y.clientHeight;!X||!ue||(z.aspect=X/ue,z.updateProjectionMatrix(),D.setSize(X,ue,!1),q.resize())};m.current={update:le,focusNode:ne,resetCamera:Y,resize:ee},le(t,o);const O=new ResizeObserver(ee);O.observe(y),ee();const se=X=>{if(E)return;const ue=X-x;x=X,v.push(ue),v.length>90&&v.shift(),v.length===90&&D.getPixelRatio()>1&&_A(v)>24&&(D.setPixelRatio(1),q.material.uniforms.uPixelRatio.value=1,ee(),v=[]),N.update(),G.updateDetail(z.position.length()),D.render(C,z),M=requestAnimationFrame(se)};M=requestAnimationFrame(se);const be=X=>{X.key.toLowerCase()==="r"&&document.activeElement?.tagName!=="INPUT"&&Y()};return window.addEventListener("keydown",be),()=>{E=!0,cancelAnimationFrame(M),O.disconnect(),window.removeEventListener("keydown",be),ce.dispose(),G.dispose(),U.dispose(),N.dispose(),C.traverse(X=>{X.geometry?.dispose?.(),Array.isArray(X.material)?X.material.forEach(ue=>ue.dispose()):X.material?.dispose?.()}),D.dispose(),D.domElement.remove(),m.current=null}},[n]),Mt.useEffect(()=>{m.current?.update(t,o)},[t,o,d]),Mt.useEffect(()=>{h?.node&&m.current?.focusNode(h.node)},[h]),Mt.useEffect(()=>{m.current?.resize()},[r]),re.jsx("div",{ref:p,className:"canvas-host"})}function LP(){return re.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:re.jsx("path",{d:"M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.39v-1.2h-2.5v8.37h2.5v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.5M6.88 8.56a1.68 1.68 0 1 1 0-3.36 1.68 1.68 0 0 1 0 3.36m-1.2 10.12h2.5V9.9h-2.5v8.78z"})})}function DP(){return re.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:re.jsx("path",{d:"M12 2C6.477 2 2 6.477 2 12c0 4.42 2.865 8.17 6.839 9.49.5.092.682-.217.682-.482 0-.237-.008-.868-.013-1.703-2.782.603-3.369-1.343-3.369-1.343-.454-1.156-1.11-1.463-1.11-1.463-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.891 1.529 2.341 1.544 2.914 1.182.092-.92.349-1.544.636-1.9-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.578 9.578 0 0 1 12 6.836c.85.004 1.705.114 2.504.336 1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48C19.139 20.167 22 16.418 22 12c0-5.523-4.477-10-10-10z"})})}function NP({data:n,options:e,setOptions:t,query:r,setQuery:o,selected:l,selectNode:u,clearSelection:c,open:h}){const d=Mt.useMemo(()=>{const p=r.trim().toLowerCase();return p?n.nodes.filter(m=>`${m.id} ${m.name} ${m.city} ${m.country}`.toLowerCase().includes(p)).sort((m,_)=>_.degree-m.degree).slice(0,8):[]},[n,r]);return re.jsxs("aside",{id:"controls",className:`sidebar ${h?"open":""}`,"aria-label":"Network controls",children:[re.jsxs("section",{className:"section",children:[re.jsxs("div",{className:"section-title",children:[re.jsx("span",{children:"Find an airport"}),re.jsx("span",{className:"value-pill",children:sr.format(n.nodes.length)})]}),re.jsxs("div",{className:"search-wrap",children:[re.jsx("input",{id:"airport-search",className:"search",value:r,onInput:p=>o(p.target.value),placeholder:"Code, city, airport…","aria-label":"Search airports",autoComplete:"off"}),re.jsx("span",{className:"search-icon",children:"⌕"})]}),d.length>0&&re.jsx("div",{className:"results",role:"listbox",children:d.map(p=>re.jsxs("button",{className:"result-btn",role:"option",onClick:()=>{u(p),o("")},children:[re.jsx("span",{className:"result-name",children:p.name}),re.jsx("span",{className:"result-code",children:p.iata||p.icao})]},p.id))}),l&&re.jsxs("div",{className:"selected-chip",children:[re.jsxs("div",{children:[re.jsx("strong",{children:l.name}),re.jsxs("span",{children:[l.city,", ",l.country]})]}),re.jsx("button",{className:"clear-btn",onClick:c,"aria-label":"Clear selected airport",children:"×"})]})]}),re.jsxs("section",{className:"section",children:[re.jsx("div",{className:"section-title",children:re.jsx("span",{children:"View"})}),re.jsxs("div",{className:"segmented",role:"group","aria-label":"Visualization mode",children:[re.jsx("button",{className:`seg-btn ${e.view==="globe"?"active":""}`,"aria-pressed":e.view==="globe",onClick:()=>t(p=>({...p,view:"globe"})),children:"3D globe"}),re.jsx("button",{className:`seg-btn ${e.view==="topology"?"active":""}`,"aria-pressed":e.view==="topology",onClick:()=>t(p=>({...p,view:"topology"})),children:"Topology"})]}),re.jsxs("div",{className:"segmented",role:"group","aria-label":"Colour theme",style:{marginTop:"8px"},children:[re.jsx("button",{className:`seg-btn ${e.theme==="dark"?"active":""}`,"aria-pressed":e.theme==="dark",onClick:()=>t(p=>({...p,theme:"dark"})),children:"Dark"}),re.jsx("button",{className:`seg-btn ${e.theme==="light"?"active":""}`,"aria-pressed":e.theme==="light",onClick:()=>t(p=>({...p,theme:"light"})),children:"Light map"})]}),re.jsxs("label",{className:"check-row",children:[re.jsx("input",{type:"checkbox",checked:e.autoRotate,onChange:p=>t(m=>({...m,autoRotate:p.target.checked}))}),"Auto-rotate globe"]})]}),re.jsxs("section",{className:"section",children:[re.jsxs("div",{className:"section-title",children:[re.jsx("span",{children:"Route filters"}),re.jsxs("span",{className:"value-pill",children:[e.density,"%"]})]}),re.jsxs("div",{className:"control-row",children:[re.jsxs("div",{className:"control-label",children:[re.jsx("span",{children:"Route density"}),re.jsxs("span",{children:[e.density,"%"]})]}),re.jsx("input",{type:"range",min:"5",max:"100",step:"5",value:e.density,"aria-label":"Route density: adjust from 5% to 100%",onInput:p=>t(m=>({...m,density:+p.target.value}))})]}),re.jsxs("div",{className:"control-row",children:[re.jsxs("div",{className:"control-label",children:[re.jsx("span",{children:"Minimum hub degree"}),re.jsx("span",{children:e.minDegree})]}),re.jsx("input",{type:"range",min:"0",max:"80",step:"1",value:e.minDegree,"aria-label":"Minimum hub degree: adjust from 0 to 80 connections",onInput:p=>t(m=>({...m,minDegree:+p.target.value}))})]}),re.jsxs("div",{className:"control-row",children:[re.jsx("label",{className:"control-label",htmlFor:"scope",children:re.jsx("span",{children:"Route scope"})}),re.jsxs("select",{id:"scope",value:e.scope,onChange:p=>t(m=>({...m,scope:p.target.value})),children:[re.jsx("option",{value:"all",children:"All routes"}),re.jsx("option",{value:"international",children:"International only"}),re.jsx("option",{value:"domestic",children:"Domestic only"})]})]}),re.jsxs("div",{className:"control-row",children:[re.jsx("label",{className:"control-label",htmlFor:"country",children:re.jsx("span",{children:"Country focus"})}),re.jsxs("select",{id:"country",value:e.country,onChange:p=>t(m=>({...m,country:p.target.value})),children:[re.jsx("option",{value:"",children:"All countries"}),n.countries.map(([p,m])=>re.jsxs("option",{value:p,children:[p," (",m,")"]},p))]})]})]}),re.jsxs("section",{className:"section",children:[re.jsx("div",{className:"section-title",children:re.jsx("span",{children:"Legend"})}),re.jsxs("div",{className:"legend",children:[re.jsxs("div",{className:"legend-row",children:[re.jsx("span",{className:"swatch",style:{background:"#56b4e9"}}),re.jsx("span",{children:"International connection"})]}),re.jsxs("div",{className:"legend-row",children:[re.jsx("span",{className:"swatch",style:{background:"#009e73"}}),re.jsx("span",{children:"Domestic connection"})]}),re.jsxs("div",{className:"legend-row",children:[re.jsx("span",{className:"swatch",style:{background:"#e69f00"}}),re.jsx("span",{children:"Selected-airport connection"})]})]})]}),re.jsxs("section",{className:"section help",children:["Drag to orbit · scroll to zoom · click an airport to pin.",re.jsx("br",{}),re.jsx("br",{}),re.jsx("kbd",{children:"/"})," Search   ",re.jsx("kbd",{children:"Esc"})," Clear selection  ",re.jsx("kbd",{children:"R"})," Reset camera"]}),re.jsxs("footer",{className:"sidebar-footer",children:[re.jsxs("div",{className:"social-links",children:[re.jsx("a",{href:"https://www.linkedin.com/in/jeremiahjking/",className:"social-btn",target:"_blank",rel:"noreferrer","aria-label":"LinkedIn",children:re.jsx(LP,{})}),re.jsx("a",{href:"https://github.com/unguisdraconis",className:"social-btn",target:"_blank",rel:"noreferrer","aria-label":"GitHub",children:re.jsx(DP,{})})]}),re.jsx("p",{className:"data-source",children:"© 2026 Jeremiah King"}),re.jsxs("p",{className:"data-source",children:["Data from","",re.jsx("a",{href:"https://openflights.org",target:"_blank",rel:"noreferrer",children:"OpenFlights.org"})]})]})]})}function IP({node:n,pinned:e,point:t}){if(!n||!t)return null;const r=295,o=18,l=t.x+o,c=l+r<=innerWidth?l:Math.max(0,t.x-r-o),h=Math.max(12,Math.min(t.y-20,innerHeight-190));return re.jsxs("div",{className:`tooltip ${e?"pinned":""}`,style:{left:c,top:h},role:e?"dialog":"status","aria-label":`${n.name} airport details`,children:[re.jsxs("div",{className:"tooltip-top",children:[re.jsx("div",{className:"airport-code",children:n.iata||n.icao||"—"}),re.jsxs("div",{children:[re.jsx("h2",{children:n.name}),re.jsxs("div",{className:"tooltip-sub",children:[n.city,", ",n.country]})]})]}),re.jsxs("div",{className:"tooltip-grid",children:[re.jsxs("div",{className:"tooltip-metric",children:[re.jsx("b",{children:sr.format(n.degree)}),re.jsx("span",{children:"Connections"})]}),re.jsxs("div",{className:"tooltip-metric",children:[re.jsx("b",{children:sr.format(n.routeCount)}),re.jsx("span",{children:"Route records"})]}),re.jsxs("div",{className:"tooltip-metric",children:[re.jsxs("b",{children:[n.lat.toFixed(1),"°, ",n.lon.toFixed(1),"°"]}),re.jsx("span",{children:"Coordinates"})]})]}),re.jsx("div",{className:"tooltip-note",children:e?"Pinned — click empty space or press Escape to close.":"Click to pin this airport."})]})}function UP({onLoaded:n,loading:e,error:t}){const r=Mt.useRef(),o=async l=>{const u=[...l],c=u.find(d=>/airport/i.test(d.name)),h=u.find(d=>/route/i.test(d.name));if(!c||!h)return n(null,null,"Select both airports.dat and routes.dat.");n(await c.text(),await h.text())};return re.jsx("div",{className:"load-screen",onDragOver:l=>l.preventDefault(),onDrop:l=>{l.preventDefault(),o(l.dataTransfer.files)},children:re.jsxs("div",{className:"load-card",children:[re.jsx("div",{className:"eyebrow",children:"OpenFlights data loader"}),re.jsx("h2",{children:e?"Loading the global aviation network…":"Load the global aviation network"}),e?re.jsx("p",{role:"status","aria-live":"polite",children:"Fetching and parsing the airport and route data. This usually takes a few seconds."}):re.jsxs("p",{children:["The dashboard first looks for ",re.jsx("b",{children:"airports.dat"})," and"," ",re.jsx("b",{children:"routes.dat"})," beside this HTML file. If your browser blocks local file requests, select or drop both supplied files here."]}),re.jsx("div",{className:"drop-zone",children:re.jsxs("div",{children:[re.jsx("button",{className:"primary-btn",onClick:()=>r.current.click(),disabled:e,children:e?"Building network…":"Choose both data files"}),re.jsx("input",{ref:r,className:"sr-only",type:"file",multiple:!0,accept:".txt,.dat,text/plain",onChange:l=>o(l.target.files)}),re.jsx("div",{className:"file-note",children:"You can also drag and drop both files onto this panel."})]})}),e&&re.jsx("div",{className:"loading-bar","aria-hidden":"true"}),t&&re.jsx("div",{className:"error",role:"alert",children:t})]})})}function Fu({value:n,label:e}){return re.jsxs("div",{className:"stat",children:[re.jsx("div",{className:"stat-value",children:n}),re.jsx("div",{className:"stat-label",children:e})]})}const FP="(min-width: 681px)",V0=()=>typeof window>"u"||!window.matchMedia?!0:window.matchMedia(FP).matches,OP=()=>{if(typeof window>"u")return"dark";try{const n=localStorage.getItem("openflights-theme");if(n==="light"||n==="dark")return n}catch{}return window.matchMedia?.("(prefers-color-scheme: light)").matches?"light":"dark"};function kP(){const[n,e]=Mt.useState(null),[t,r]=Mt.useState(!0),[o,l]=Mt.useState(""),[u,c]=Mt.useState({view:"globe",density:55,minDegree:0,scope:"all",country:"",autoRotate:!1,theme:OP()}),[h,d]=Mt.useState(""),[p,m]=Mt.useState(null),[_,y]=Mt.useState(null),[E,M]=Mt.useState(null),[x,v]=Mt.useState(null),[A,T]=Mt.useState(V0),[C,z]=Mt.useState(0),[D,N]=Mt.useState(!1),W=Mt.useCallback(()=>z(Y=>Y+1),[]),L=Mt.useMemo(()=>n?W2(n.nodes):null,[n]);Q2(n,L,D,W),Mt.useEffect(()=>{u.view==="topology"&&N(!0)},[u.view]);const R=u.view==="topology"&&C===0,U=Mt.useCallback((Y,ne,B)=>{if(B){l(B),r(!1);return}r(!0),l(""),setTimeout(()=>{try{const le=V2(Y,ne);if(!le.nodes.length||!le.links.length)throw new Error("No usable airport-route pairs were found.");e(le)}catch(le){l(`Could not parse the files: ${le.message}`)}finally{r(!1)}},30)},[]);Mt.useEffect(()=>{let Y=!1;const ne=new AbortController;return Z2({signal:ne.signal}).then(({airports:B,routes:le,source:ee})=>{Y||(ee!=="local"&&console.info(`OpenFlights data loaded from ${ee}.`),U(B,le))}).catch(B=>{Y||ne.signal.aborted||U(null,null,`Could not load the flight data (${B.message}). Select or drop airports.dat and routes.dat below.`)}),()=>{Y=!0,ne.abort()}},[U]),Mt.useEffect(()=>{const Y=document.documentElement;Y.dataset.themeSwitching="",Y.dataset.theme=u.theme;let ne=!1;const B=()=>{ne||(ne=!0,delete Y.dataset.themeSwitching)},le=requestAnimationFrame(()=>requestAnimationFrame(B)),ee=setTimeout(B,300);try{localStorage.setItem("openflights-theme",u.theme)}catch{}return()=>{cancelAnimationFrame(le),clearTimeout(ee),B()}},[u.theme]),Mt.useEffect(()=>{const Y=window.matchMedia?.("(prefers-color-scheme: light)");if(!Y)return;const ne=B=>{let le=null;try{le=localStorage.getItem("openflights-theme")}catch{le=null}le||c(ee=>({...ee,theme:B.matches?"light":"dark"}))};return Y.addEventListener("change",ne),()=>Y.removeEventListener("change",ne)},[]),Mt.useEffect(()=>{const Y=ne=>{ne.key==="/"&&document.activeElement?.tagName!=="INPUT"&&(ne.preventDefault(),document.getElementById("airport-search")?.focus()),ne.key==="Escape"&&(m(null),y(null),M(null))};return window.addEventListener("keydown",Y),()=>window.removeEventListener("keydown",Y)},[]);const G=(Y,ne)=>{m(Y),y(null),M(ne||{x:innerWidth*.56,y:innerHeight*.3}),v({node:Y,id:performance.now()}),V0()||T(!1)},q=()=>{m(null),y(null),M(null)},J=p||_,ce=Mt.useMemo(()=>n?n.links.filter(Y=>(u.scope==="all"||u.scope==="international"===Y.international)&&(!u.country||Y.source.country===u.country||Y.target.country===u.country)&&Y.source.degree>=u.minDegree&&Y.target.degree>=u.minDegree).length:0,[n,u.scope,u.country,u.minDegree]);return re.jsxs("div",{className:`app ${A?"":"sidebar-collapsed"}`,children:[re.jsxs("header",{className:"topbar",children:[re.jsx("button",{className:"icon-btn menu-btn",onClick:()=>T(Y=>!Y),"aria-label":A?"Hide controls":"Show controls","aria-expanded":A,"aria-controls":"controls",title:A?"Hide controls":"Show controls",children:"☰"}),re.jsxs("div",{className:"brand",children:[re.jsx("div",{className:"eyebrow",children:"Global aviation intelligence"}),re.jsx("h1",{children:"OpenFlights Network"})]}),n&&re.jsxs("div",{className:"stats","aria-label":"Network summary",children:[re.jsx(Fu,{value:sr.format(n.nodes.length),label:"Airports"}),re.jsx(Fu,{value:sr.format(n.links.length),label:"Connections"}),re.jsx(Fu,{value:sr.format(ce),label:"Visible pool"}),re.jsx(Fu,{value:sr.format(n.countries.length),label:"Countries"})]}),re.jsx("div",{className:"top-actions",children:re.jsx("button",{className:"icon-btn desktop-only",onClick:()=>c(Y=>({...Y,autoRotate:!Y.autoRotate})),"aria-label":"Toggle automatic rotation","aria-pressed":u.autoRotate,children:"◌"})})]}),re.jsxs("main",{className:"main",children:[n&&re.jsx(NP,{data:n,options:u,setOptions:c,query:h,setQuery:d,selected:p,selectNode:G,clearSelection:q,open:A}),re.jsxs("section",{className:"stage","aria-label":"3D flight visualization",children:[n&&re.jsx(PP,{data:n,positions:L,sidebarOpen:A,options:u,selected:p,topologyVersion:C,focusRequest:x,onHover:(Y,ne)=>{y(Y),M(ne)},onSelect:G,onClear:q}),n&&re.jsxs("div",{className:"stage-badge",children:[re.jsx("span",{className:"dot"}),re.jsxs("span",{children:[u.view==="globe"?"GEOGRAPHIC GLOBE":"FORCE-DIRECTED TOPOLOGY"," ","· ",R?"COMPUTING LAYOUT…":`${u.density}% ROUTES`]})]}),re.jsx(IP,{node:J,pinned:!!p,point:E}),!n&&re.jsx(UP,{onLoaded:U,loading:t,error:o}),re.jsx("div",{className:"sr-only",role:"status","aria-live":"polite",children:R?"Computing force-directed layout.":""}),re.jsx("div",{className:"sr-only","aria-live":"polite",children:J?`${J.name}, ${J.city}, ${J.country}. ${J.degree} direct connections.`:""})]})]})]})}US.createRoot(document.getElementById("root")).render(re.jsx(bS.StrictMode,{children:re.jsx(kP,{})}));
