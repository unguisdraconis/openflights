...
Elevation: SRTM + RAMP II + GTOPO30, via NASA SRTM/RAMP2.
Mask: Natural Earth land via world-atlas, with separately sourced Natural Earth lakes GeoJSON subtracted.
Color: Generated at runtime by the custom shader; no sourced color imagery.

Land and country geometry: Natural Earth via world-atlas.
Lake subtraction mask: Natural Earth 1:50m Physical — Lakes + Reservoirs (ne_50m_lakes), v5.x, public domain.
Color: generated by the project’s shader.
